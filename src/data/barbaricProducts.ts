...
export const BARBARIC_PRODUCTS: BarbaricProduct[] = [
  /* ==================== STORAGE ==================== */
  {
    ...
    specs: { 'Lateral clearance': '100 mm (all directions)', 'Rotation unit': '90° (180° optional)', 'Payback period': '1–2 years' },
  ...
  },
  {
    ...
    specs: { 'Movement speed': 'up to 150 m/min', 'Cycle time': '< 1 min', 'Max. crane bridge': 'up to 25 m', 'Max. storage area': 'up to 25 × 70 m' },
  ...
  },
  {
    ...
    specs: { 'Lifting height (double-scissor)': '4.200 mm', 'Ground level height': '3.200 mm' },
  ...
  /* ==================== FEEDING ==================== */
  {
    ...
    specs: { 'Control': 'Operator terminal with 2D/3D', 'Interfaces': 'All major saw/CNC manufacturers', 'Panel request': 'Fully automatic from saw' },
    seoTitle: {
  ...
  /* ==================== NESTING ==================== */
  {
    ...
    specs: { 'Detection': 'Camera-based position + orientation', 'Sorting': 'Automatic', 'Offcut disposal': 'Collection bin' },
    seoTitle: {
  ...
  /* ==================== RETURN SYSTEMS ==================== */
  {
    ...
    specs: { 'Compatibility': 'Any edgebander brand', 'Speed': 'Continuously adjustable', 'Operation': 'Single operator' },
  ...
  },
  {
    ...
    specs: { 'Pickup mode': 'Dual (2 parts simultaneously)', 'Destacking': 'Optional', 'Installation': 'Pre-assembled components' },
  ...
  },
  {
    ...
    specs: { 'Max. load': '100 kg', 'Max. part length': '4.100 mm' },
  ...
  },
  {
    ...
    specs: { 'Batch size': '1 (individual parts)', 'Machine type': 'Throughfeed (edgebanders)', 'Handling': 'Individual sorting + forwarding' },
  ...
  /* ==================== BUFFER ==================== */
  {
    ...
    specs: { 'Storage area': '~120 m²', 'Cycle time': '~6 parts/min', 'Max. panel size': '2.8 × 1.95 m', 'Max. thickness': '25 mm (opt. 40 mm)' },
  ...
  /* ==================== DOOR HANDLING ==================== */
  {
    ...
    specs: { 'Type': 'Door storage system', 'Operation': 'Automatic storage + retrieval' },
  ...
  },
  {
    ...
    specs: { 'Type': 'Specialized door storage', 'Integration': 'ERP + production systems', 'Operation': 'Continuous industrial' },
  ...
  },
  {
    ...
    specs: { 'Function': 'CNC feeding + stacking', 'Design': 'Compact, space-efficient' },
  ...
  /* ==================== LABELING ==================== */
  {
    ...
    specs: { 'Function': 'Panel labeling before cutting', 'Traceability': 'Full production process' },
