...
export const OTT_PRODUCTS: OttProduct[] = [
  ...
  },
  {
    ...
    description: {
      de: 'Die FlexEdge bietet professionelle Kantenbearbeitung mit 7,1 m Baulänge und Vorschubgeschwindigkeiten von 20–25 m/min. Ausgestattet mit Beckhoff 18,5"-Steuerung für maximale Flexibilität und Industrie-4.0-Anbindung.',
      en: 'The FlexEdge offers professional edgebanding with 7.1 m length and feed speeds of 20–25 m/min. Equipped with a Beckhoff 18.5" control for maximum flexibility and Industry 4.0 connectivity.',
      cz: 'FlexEdge nabízí profesionální olepování hran s délkou 7,1 m a rychlostí posuvu 20–25 m/min. Vybavena řídicím systémem Beckhoff 18,5" pro maximální flexibilitu a připojení k Průmyslu 4.0.',
      sk: 'FlexEdge ponúka profesionálne olepovanie hrán s dĺžkou 7,1 m a rýchlosťou posuvu 20–25 m/min. Vybavená riadiacim systémom Beckhoff 18,5" pre maximálnu flexibilitu a pripojenie k Priemyslu 4.0.',
      hu: 'A FlexEdge professzionális élzárást kínál 7,1 m-es hosszával és 20–25 m/perc előtolási sebességgel. Beckhoff 18,5"-os vezérléssel van felszerelve a maximális rugalmasság és Ipar 4.0 csatlakoztathatóság érdekében.',
    },
    ...
    highlights: {
      de: ['Beckhoff 18,5" OPC-UA Steuerung serienmäßig', 'Schließt Lücke zwischen Tornado+ und Storm+', 'NEU: Vorschub 20–25 m/min'],
      en: ['Beckhoff 18.5" OPC-UA control as standard', 'Bridges gap between Tornado+ and Storm+', 'NEW: Feed speed 20–25 m/min'],
      cz: ['Beckhoff 18,5" OPC-UA řízení standardně', 'Překlenuje mezeru Tornado+ a Storm+', 'NOVÝ: posuv 20–25 m/min'],
      sk: ['Beckhoff 18,5" OPC-UA riadenie štandardne', 'Preklenuje medzeru Tornado+ a Storm+', 'NOVÝ: posuv 20–25 m/min'],
      hu: ['Beckhoff 18,5" OPC-UA vezérlés alapfelszerelés', 'Tornado+ és Storm+ közötti rés áthidalása', 'ÚJ: előtolás 20–25 m/perc'],
    },
    specs: {
      length: '7.1 m',
      edgeThickness: '0.3–15 mm',
      feedSpeed: '20–25 m/min',
      notes: {
    ...
    seoDescription: {
      de: 'FlexEdge – professionelle Kantenanleimmaschine mit Beckhoff-Steuerung. 7,1 m, 20–25 m/min Vorschub. Asamer: autorisierter OTT-Händler für CZ, SK & HU.',
      en: 'FlexEdge – professional edgebander with Beckhoff 18.5" control. 7.1 m, 20–25 m/min feed speed. Asamer: authorized OTT dealer for CZ, SK & HU.',
      cz: 'FlexEdge – profesionální olepovačka hran s řízením Beckhoff. 7,1 m, posuv 20–25 m/min. Asamer: autorizovaný prodejce OTT pro CZ, SK a HU.',
      sk: 'FlexEdge – profesionálna olepovačka hrán s riadením Beckhoff. 7,1 m, posuv 20–25 m/min. Asamer: autorizovaný predajca OTT pre CZ, SK a HU.',
      hu: 'FlexEdge – professzionális élzárógép Beckhoff vezérléssel. 7,1 m, 20–25 m/perc előtolás. Asamer: hivatalos OTT viszonteladó CZ, SK és HU.',
    },
  },
  {
    slug: 'storm-plus',
  ...
  },
  {
    ...
    description: {
      de: 'Die StrongEdge ist auf schwere Kanten bis 25 mm ausgelegt. Mit einer Baulänge von 8,6 m und Vorschubgeschwindigkeiten von 20–25 m/min eignet sie sich besonders für den professionellen Möbel- und Innenausbau.',
      en: 'The StrongEdge is designed for heavy edges up to 25 mm. With a length of 8.6 m and feed speeds of 20–25 m/min, it is particularly suited for professional furniture and interior construction.',
      cz: 'StrongEdge je navržena pro silné hrany až 25 mm. S délkou 8,6 m a rychlostí posuvu 20–25 m/min je obzvláště vhodná pro profesionální nábytkářství a interiérovou výstavbu.',
      sk: 'StrongEdge je navrhnutá pre silné hrany až 25 mm. S dĺžkou 8,6 m a rýchlosťou posuvu 20–25 m/min je obzvlášť vhodná pre profesionálne nábytkárstvo a interiérovú výstavbu.',
      hu: 'A StrongEdge akár 25 mm-es vastag élekhez lett tervezve. 8,6 m-es hosszával és 20–25 m/perc előtolási sebességgel különösen alkalmas professzionális bútor- és belsőépítészeti munkákhoz.',
    },
    ...
    recommended: ['translift', 'transedge'],
    highlights: {
      de: ['Einzige OTT-Maschine für Kanten bis 25 mm', 'Ideal für Massivholz und Türfronten', 'Vorschub 20–25 m/min'],
      en: ['Only OTT machine for edges up to 25 mm', 'Ideal for solid wood and door fronts', 'Feed speed 20–25 m/min'],
      cz: ['Jediný stroj OTT pro hrany do 25 mm', 'Ideální pro masiv a dveřní čela', 'Posuv 20–25 m/min'],
      sk: ['Jediný stroj OTT pre hrany do 25 mm', 'Ideálne pre masív a dverné čelá', 'Posuv 20–25 m/min'],
      hu: ['Az egyetlen OTT gép 25 mm-es élekhez', 'Ideális tömörfához és ajtófrontokhoz', 'Előtolás 20–25 m/perc'],
    },
    specs: {
      length: '8.6 m',
    ...
    seoDescription: {
      de: 'StrongEdge – Kantenanleimmaschine für schwere Kanten bis 25 mm. 8,6 m, 20–25 m/min Vorschub. Asamer: autorisierter OTT-Händler für CZ, SK & HU.',
      en: 'StrongEdge – edgebander for heavy edges up to 25 mm. 8.6 m, 20–25 m/min feed speed. Asamer: authorized OTT dealer for CZ, SK & HU.',
      cz: 'StrongEdge – olepovačka hran pro silné hrany do 25 mm. 8,6 m, posuv 20–25 m/min. Asamer: autorizovaný prodejce OTT pro CZ, SK a HU.',
      sk: 'StrongEdge – olepovačka hrán pre silné hrany do 25 mm. 8,6 m, posuv 20–25 m/min. Asamer: autorizovaný predajca OTT pre CZ, SK a HU.',
      hu: 'StrongEdge – élzárógép nehéz élekhez 25 mm-ig. 8,6 m, 20–25 m/perc előtolás. Asamer: hivatalos OTT viszonteladó CZ, SK és HU.',
    },
  },
  {
    slug: 'topedge',
  ...
  },
  {
    ...
    description: {
      de: 'bluEdge featuring HyFuse ist OTTs Nullfugentechnologie. Die Funktionsschicht der Kante wird von einer Wasserstoff-Sauerstoff-Flamme aktiviert – ohne Klebstoff, ohne sichtbare Fuge. Das Ergebnis: Premium-Möbeloptik, die höchsten ästhetischen Ansprüchen genügt. Nachrüstbar für alle OTT-Kantenanleimmaschinen.',
      en: 'bluEdge featuring HyFuse is OTT\'s zero glue line technology. The functional layer of the edge is activated by a hydrogen-oxygen flame – no adhesive, no visible joint. The result: premium furniture aesthetics meeting the highest standards. Retrofittable to all OTT edgebanders.',
      cz: 'bluEdge featuring HyFuse je technologie nulové spáry od OTT. Funkční vrstva hrany se aktivuje vodíko-kyslíkovým plamenem – bez lepidla, bez viditelné spáry. Výsledek: prémiový vzhled nábytku splňující nejvyšší estetické nároky. Dodatečně montovatelná na všechny olepovačky OTT.',
      sk: 'bluEdge featuring HyFuse je technológia nulovej škáry od OTT. Funkčná vrstva hrany sa aktivuje vodíko-kyslíkovým plameňom – bez lepidla, bez viditeľnej škáry. Výsledok: prémiový vzhľad nábytku spĺňajúci najvyššie estetické nároky. Dodatočne montovateľná na všetky olepovačky OTT.',
      hu: 'A bluEdge featuring HyFuse az OTT nulla ragasztóvonal technológiája. Az él funkcionális rétegét hidrogén-oxigén láng aktiválja – ragasztó nélkül, látható fuga nélkül. Az eredmény: prémium bútor-esztétika a legmagasabb igényeknek megfelelően. Minden OTT élzárógéphez utólagosan felszerelhető.',
    },
    specs: {
      notes: {
        de: 'bluEdge featuring HyFuse · Kantenaktivierung per Wasserstoff-Flamme · nachrüstbar für alle OTT-Modelle',
        en: 'bluEdge featuring HyFuse · hydrogen-flame edge activation · retrofittable to all OTT models',
        cz: 'bluEdge featuring HyFuse · aktivace hrany vodíkovým plamenem · montovatelná na všechny modely OTT',
        sk: 'bluEdge featuring HyFuse · aktivácia hrany vodíkovým plameňom · montovateľná na všetky modely OTT',
