...
export const OTT_PRODUCTS: OttProduct[] = [
  /* ======================== EDGEBANDING ======================== */
  {
    ...
    seoTitle: {
      de: 'OTT Pacific+ Kantenanleimmaschine kaufen – Asamer Händler CZ/SK/HU',
      en: 'OTT Pacific+ Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT Pacific+ olepovačka hran – koupit přes Asamer',
      sk: 'OTT Pacific+ olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT Pacific+ élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      ...
      en: 'OTT Tornado+ Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT Tornado+ olepovačka hran – koupit přes Asamer',
      sk: 'OTT Tornado+ olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT Tornado+ élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT FlexEdge Kantenanleimmaschine kaufen – Asamer Händler CZ/SK/HU',
      en: 'OTT FlexEdge Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT FlexEdge olepovačka hran – koupit přes Asamer',
      sk: 'OTT FlexEdge olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT FlexEdge élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      ...
      en: 'OTT Storm+ Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT Storm+ olepovačka hran – koupit přes Asamer',
      sk: 'OTT Storm+ olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT Storm+ élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT StrongEdge Kantenanleimmaschine kaufen – Asamer Händler CZ/SK/HU',
      en: 'OTT StrongEdge Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT StrongEdge olepovačka hran – koupit přes Asamer',
      sk: 'OTT StrongEdge olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT StrongEdge élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT TopEdge Kantenanleimmaschine kaufen – Asamer Händler CZ/SK/HU',
      en: 'OTT TopEdge Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT TopEdge olepovačka hran – koupit přes Asamer',
      sk: 'OTT TopEdge olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT TopEdge élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT DoorEdition Kantenanleimmaschine kaufen – Asamer Händler CZ/SK/HU',
      en: 'OTT DoorEdition Edgebander – Buy via Asamer, dealer for CZ/SK/HU',
      cz: 'OTT DoorEdition olepovačka hran – koupit přes Asamer',
      sk: 'OTT DoorEdition olepovačka hrán – kúpiť cez Asamer',
      hu: 'OTT DoorEdition élzárógép – vásárlás Asamer-en keresztül',
    },
    seoDescription: {
  ...
  /* ======================== GLUING TECHNOLOGY ======================== */
  {
    ...
    seoTitle: {
      de: 'OTT CombiMelt PUR-Leimsystem – Asamer Händler CZ/SK/HU',
      en: 'OTT CombiMelt PUR Glue System – Asamer dealer CZ/SK/HU',
      cz: 'OTT CombiMelt PUR lepicí systém – Asamer prodejce CZ/SK/HU',
      sk: 'OTT CombiMelt PUR lepiaci systém – Asamer predajca CZ/SK/HU',
      hu: 'OTT CombiMelt PUR ragasztórendszer – Asamer viszonteladó CZ/SK/HU',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT bluEdge Nullfuge HyFuse – Asamer Händler CZ/SK/HU',
      en: 'OTT bluEdge Zero Glue Line HyFuse – Asamer dealer CZ/SK/HU',
      cz: 'OTT bluEdge nulová spára HyFuse – Asamer prodejce CZ/SK/HU',
      sk: 'OTT bluEdge nulová škára HyFuse – Asamer predajca CZ/SK/HU',
      hu: 'OTT bluEdge nulla ragasztóvonal HyFuse – Asamer viszonteladó CZ/SK/HU',
    },
    seoDescription: {
  ...
  /* ======================== RETURN & HANDLING ======================== */
  {
    ...
    seoTitle: {
      de: 'OTT TRANScompact Rückführsystem – Asamer Händler CZ/SK/HU',
      en: 'OTT TRANScompact Return Conveyor – Asamer dealer CZ/SK/HU',
      cz: 'OTT TRANScompact vratný dopravník – Asamer prodejce CZ/SK/HU',
      sk: 'OTT TRANScompact vratný dopravník – Asamer predajca CZ/SK/HU',
      hu: 'OTT TRANScompact visszaszállító – Asamer viszonteladó CZ/SK/HU',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT TRANSlift Hebe-Rückführung – Asamer Händler CZ/SK/HU',
      en: 'OTT TRANSlift Lifting Return System – Asamer dealer CZ/SK/HU',
      cz: 'OTT TRANSlift zvedací vratný systém – Asamer prodejce CZ/SK/HU',
      sk: 'OTT TRANSlift zdvíhací vratný systém – Asamer predajca CZ/SK/HU',
      hu: 'OTT TRANSlift emelő visszaszállító – Asamer viszonteladó CZ/SK/HU',
    },
    seoDescription: {
  ...
  },
  {
    ...
    seoTitle: {
      de: 'OTT TRANSedge Rückführung für Kantenanleimlinien – Asamer Händler CZ/SK/HU',
      en: 'OTT TRANSedge Return System for Edgebanding – Asamer dealer CZ/SK/HU',
      cz: 'OTT TRANSedge vratný systém pro olepovačky – Asamer prodejce CZ/SK/HU',
      sk: 'OTT TRANSedge vratný systém pre olepovačky – Asamer predajca CZ/SK/HU',
      hu: 'OTT TRANSedge visszaszállító élzáró sorokhoz – Asamer viszonteladó CZ/SK/HU',
    },
    seoDescription: {
