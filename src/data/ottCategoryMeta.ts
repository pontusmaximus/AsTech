...
export const OTT_CATEGORY_META: Record<OttCategory, OttCategoryMeta> = {
  edgebanding: {
    ...
    lead: {
      de: 'Eine Kantenanleimmaschine beklebt und besäumt die Kanten von Möbel- und Plattenteilen – sie schützt die Platte vor Feuchtigkeit und vollendet das Möbeldesign. Die industriellen Kantenanleimmaschinen von OTT Paul verarbeiten Kanten von 0,3 bis 25 mm bei 12–22 m/min Vorschub, mit EVA, PUR und der Nullfugentechnologie bluEdge featuring HyFuse. Asamer ist autorisierter OTT-Händler für Tschechien, die Slowakei und Ungarn – mit Beratung, Montage, Service und Finanzierung.',
      en: 'An edgebanding machine applies and flush-trims edge material on furniture and board parts – it seals the board against moisture and completes the furniture design. Industrial OTT Paul edgebanders process edges from 0.3 to 25 mm at feed speeds of 12–22 m/min, with EVA, PUR and the bluEdge featuring HyFuse zero glue line technology. Asamer is the authorized OTT dealer for the Czech Republic, Slovakia and Hungary – with consulting, installation, service and financing.',
      cz: 'Olepovačka hran je stroj, který nalepí a začistí hranu na nábytkovém dílci – chrání desku před vlhkostí a dotváří design nábytku. Průmyslové olepovačky hran OTT Paul zpracují hrany 0,3 až 25 mm při posuvu 12–22 m/min, s lepidly EVA a PUR i s technologií nulové spáry bluEdge featuring HyFuse. Asamer je autorizovaný prodejce OTT pro Českou republiku, Slovensko a Maďarsko – zajišťuje poradenství, montáž, servis i financování.',
      sk: 'Olepovačka hrán je stroj, ktorý nalepí a začistí hranu na nábytkovom dielci – chráni dosku pred vlhkosťou a dotvára dizajn nábytku. Priemyselné olepovačky hrán OTT Paul spracujú hrany 0,3 až 25 mm pri posuve 12 – 22 m/min, s lepidlami EVA a PUR aj s technológiou nulovej škáry bluEdge featuring HyFuse. Asamer je autorizovaný predajca OTT pre Českú republiku, Slovensko a Maďarsko – zabezpečuje poradenstvo, montáž, servis aj financovanie.',
      hu: 'Az élzárógép a bútor- és lapelemek éleire ragasztja és dolgozza le az élanyagot – védi a lapot a nedvességtől, és teljessé teszi a bútor dizájnját. Az ipari OTT Paul élzárógépek 0,3–25 mm-es éleket dolgoznak fel 12–22 m/perc előtolással, EVA-, PUR-ragasztóval és a bluEdge featuring HyFuse fugamentes technológiával. Az Asamer az OTT hivatalos viszonteladója Csehországban, Szlovákiában és Magyarországon – tanácsadással, telepítéssel, szervizzel és finanszírozással.',
    },
  },
