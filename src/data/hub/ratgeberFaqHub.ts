...
const FAQ_EDGEBANDER_ENTRY: HubFaqItem = {
  question: {
    ...
    sk: 'Ktorá olepovačka hrán na začiatok?',
  },
  answer: {
    ...
    sk: 'Na začiatok odporúčame OTT Pacific+. Ponúka posuv 18 m/min vrátane opracovania rohov na púhych 5,7 m dĺžky. Stroj zvládne hrúbku hrán 0,3–15 mm a hrúbku dosiek do 60 mm. Vďaka CombiMelt je navyše dodatočne vybaviteľná PUR, takže investujete do budúcnosti.',
  },
};
...
const FAQ_WAREHOUSE_ROI: HubFaqItem = {
  question: {
    ...
    sk: 'Kedy sa vyplatí automatizácia skladu?',
  },
  answer: {
    ...
    sk: 'Automatizácia skladu sa vyplatí od denného priechodu približne 50 dosiek alebo keď časy hľadania a chyby pri kompletizácii brzdia produktivitu. Systémy BARBARIC znižujú skladové náklady až o 40 % a dosahujú 99,9% presnosť zásob. Typická návratnosť investície je 2–4 roky v závislosti od veľkosti prevádzky a objemu materiálu.',
  },
};
...
const FAQ_PUR_VS_EVA: HubFaqItem = {
  question: {
    ...
    sk: 'Aký je rozdiel medzi PUR a EVA technológiou lepenia?',
  },
  answer: {
    ...
    sk: 'EVA (etylénvinylacetát) je termoplastické tavné lepidlo, ktoré rýchlo tuhne a ľahko sa spracúva. PUR (polyuretánové reaktívne lepidlo) reaguje s vlhkosťou a vytvára vodotesný, tepelne odolný spoj. PUR poskytuje tenšie lepené škáry a vyššiu odolnosť voči teplu a vlhkosti. Pre kuchynský nábytok a vlhké prostredie je PUR lepšou voľbou; pre štandardný nábytok EVA plne postačuje.',
  },
};
...
const FAQ_ZERO_GAP: HubFaqItem = {
  question: {
    ...
    sk: 'Čo znamená Zero-Gap? Čo je bluEdge HyFuse?',
  },
  answer: {
    ...
    sk: 'Zero-Gap označuje olepenie hrany, kde je lepená škára opticky neviditeľná – hrana a doskový materiál splývajú bezšvíkovo. bluEdge featuring HyFuse je vlastná technológia nulovej škáry od OTT: vodíkovo-kyslíkový plameň aktivuje funkčnú vrstvu hrany, ktorá sa potom spojí s doskou bez samostatného lepidla. Výsledkom je bezšvíková, vodotesná hrana s najvyššou optickou kvalitou.',
  },
};
...
const FAQ_OPC_UA: HubFaqItem = {
  question: {
    ...
    sk: 'Čo je OPC-UA a prečo je dôležité pre integráciu ERP?',
  },
  answer: {
    ...
    sk: 'OPC-UA (Open Platform Communications – Unified Architecture) je otvorený priemyselný štandard pre bezpečnú výmenu dát medzi strojmi a IT systémami. Všetky stroje OTT s riadením Beckhoff využívajú OPC-UA, takže môžu priamo komunikovať s ERP a MES systémami. To umožňuje sledovanie výroby v reálnom čase, automatické riadenie zákaziek a prediktívnu údržbu – bez proprietárneho softvéru alebo vendor lock-in.',
  },
};
...
const FAQ_SOFTWARE_INTEGRATION: HubFaqItem = {
  question: {
    ...
    sk: 'Môže Asamer pomôcť s integráciou softvéru do nového stroja?',
  },
  answer: {
    ...
    sk: 'Áno, náš softvérový tím prepojí váš stroj cez otvorené rozhranie OPC-UA priamo s vaším ERP alebo MES systémom. Integrácia zahŕňa výrobné dáta v reálnom čase, automatické riadenie zákaziek a monitorovanie stavu. Nie je potrebný proprietárny softvér – máte plnú kontrolu nad svojimi dátami. Softvérová integrácia je navyše predpokladom pre mnohé dotačné programy ako OP TAK Digitální podnik.',
  },
};
...
const FAQ_SERVICE_RESPONSE: HubFaqItem = {
  question: {
    ...
    sk: 'Ako rýchlo príde technik pri poruche stroja?',
  },
  answer: {
    ...
    sk: 'V prípade poruchy náš servisný tím okamžite prioritizuje váš incident. Zvyčajne začneme telefonickú alebo vzdialenú diagnostiku do 2–4 hodín. Ak je nutný zásah na mieste, naplánujeme technika do 24–48 hodín. Zákazníci so servisnou zmluvou majú skrátené reakčné časy.',
  },
};
...
const FAQ_SERVICED_BRANDS: HubFaqItem = {
  question: {
    ...
    sk: 'Ktoré stroje Asamer servisuje?',
  },
  answer: {
    ...
    sk: 'Servisujeme všetky stroje z nášho aktuálneho portfólia: olepovačky hrán OTT, formátovacie píly Mayer, manipulačné a skladové systémy BARBARIC a vŕtacie a kolíkovacie stroje Gannomat. Navyše ponúkame servis pre existujúce stroje od IMA Schelling, Mühlböck a ďalších výrobcov, s ktorými máme 30 rokov skúseností.',
  },
};
...
const FAQ_DOTACE_2026: HubFaqItem = {
  question: {
    ...
    sk: 'Aké dotačné programy existujú v roku 2026 pre drevoobrábacie stroje v ČR?',
  },
  answer: {
    ...
    sk: 'V Českej republike je v roku 2026 k dispozícii niekoľko programov: OP TAK – Digitální podnik podporuje 25–45 % (max. 45 mil. Kč) pri integrácii strojov s ERP/MES. OP TAK – Inovace ponúka 15–60 % pre technológie založené na VaV. NRB Úvěr Expanze poskytuje bezúročný úver až do 50 % nákladov so splatnosťou 15 rokov. Asamer poradí zdarma s optimálnou kombináciou dotácie a lízingu.',
  },
};
...
const FAQ_LEASING: HubFaqItem = {
  question: {
    ...
    sk: 'Ako funguje lízing cez Raiffeisen pre stroje?',
  },
  answer: {
    ...
    sk: 'Raiffeisen Leasing financuje nové aj použité stroje s dobou trvania 36–72 mesiacov. Volíte medzi finančným lízingom (prechod vlastníctva po poslednej splátke) a operatívnym lízingom (vrátenie alebo predĺženie). Akontácia začína od 10 %, poistenie je priamo v splátke. Asamer zabezpečí kompletné vybavenie – od ponuky po podpis zmluvy.',
  },
};
...
const FAQ_USED_CHECKS: HubFaqItem = {
  question: {
    ...
    sk: 'Na čo si dať pozor pri nákupe použitých olepovačiek hrán?',
  },
  answer: {
    ...
    sk: 'Skontrolujte stav lepiacej jednotky, frézovacích agregátov a posuvnej reťaze – to sú kritické opotrebiteľné diely. Požiadajte o strojný pas s históriou údržby a prevádzkovými hodinami. Asamer každý použitý stroj technicky preverí, než ho ponúkne. Overte si dostupnosť náhradných dielov a či výrobca stále poskytuje podporu.',
  },
};
...
const FAQ_USED_WARRANTY: HubFaqItem = {
  question: {
    ...
    sk: 'Poskytuje Asamer záruku na použité stroje?',
  },
  answer: {
    ...
    sk: 'Áno, každý použitý stroj od Asamer je pred predajom technicky preverený a prípadne repasovaný. V závislosti od stavu a rozsahu repasu poskytujeme záruku na preverené komponenty. Navyše je k dispozícii náš servisný tím pre údržbu a dodávky náhradných dielov. Na financovanie použitých strojov spolupracujeme s Raiffeisen Leasing.',
  },
};
...
const FAQ_DELIVERY_HU_SK: HubFaqItem = {
  question: {
    ...
    sk: 'Dodáva Asamer aj do Maďarska a na Slovensko?',
  },
  answer: {
    ...
    sk: 'Áno, Asamer dodáva do celého regiónu CZ, SK a HU. Pre olepovačky hrán OTT sme exkluzívnym distribučným partnerom. Mayer, BARBARIC a Gannomat predávame ako autorizovaný predajca. Dodávame, inštalujeme a servisujeme stroje vo všetkých troch krajinách. Centrála sa nachádza v Brne, odkiaľ pokrývame celý región.',
  },
};
