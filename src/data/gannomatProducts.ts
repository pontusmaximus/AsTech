...
export const GANNOMAT_PRODUCTS: GannomatProduct[] = [
  ...
  /* ============ INSERTION (Platten / Massivholz) ============ */
  {
    ...
    highlights: ['Pistol-type simultaneous gluing and dowel insertion', 'Compact design, easy handling — best-selling Gannomat at Asamer', 'Austrian quality product since 1956', 'Ideal for daily furniture production in workshops'],
  ...
  },
  {
    ...
    highlights: ['CNC-controlled gluing and dowel insertion in one pass', 'Flexible programming for complex furniture joining patterns', 'Suitable for panel and solid wood processing', 'Integration with production management systems'],
  ...
  },
  {
    ...
    highlights: ['Combined dowel-hole boring and dowel driving in one machine', 'Multi-spindle head with adjustable dowel stations', 'High output for standard furniture production', 'Precise glue application for reliable joint strength'],
    seoTitle: seoT('Elite'),
  ...
  },
  {
    ...
    highlights: ['Feed-through double-sided drill, glue and dowel insertion', 'Simultaneous two-sided processing for maximum efficiency', 'Multi-spindle heads for complex patterns', 'Ideal for high-volume panel furniture production'],
  ...
  /* ============ INSERTION DOOR/WINDOW ============ */
  {
    ...
    highlights: ['Heavy-duty variant for door and window production', 'Robust construction for heavy workpieces', 'Based on the proven Selekta platform'],
  ...
  },
  {
    ...
    highlights: ['Heavy-duty glue injection for door and window elements', 'Larger dowel hole diameters and higher glue volumes', 'Optimized for the DW industry'],
  ...
  },
  {
    ...
    highlights: ['CNC-controlled for door and window production', 'Drilling, gluing and dowel insertion in a single operation', 'Optimized for DW industry requirements'],
  ...
  /* ============ MACHINING CENTERS ============ */
  {
    slug: 'protec-profit', name: 'ProTec Profit', category: 'machining', image: IMG_PROTEC,
    tagline: { de: 'CNC-Bearbeitungszentrum für Bohren, Fräsen und Dübeleintreiben', en: 'CNC machining center for drilling, routing and dowel insertion', cz: 'CNC obráběcí centrum pro vrtání, frézování a kolkování', sk: 'CNC obrábacie centrum pre vŕtanie, frézovanie a kolkovanie', hu: 'CNC megmunkáló központ fúráshoz, maráshoz és csapozáshoz' },
    description: { de: 'Das Gannomat ProTec Profit ist ein CNC-Bearbeitungszentrum für Bohren, Fräsen und Dübeleintreiben in einem Arbeitsgang. Flexible Fertigung mit hoher Präzision auf kompaktem Raum – ideal für anspruchsvolle Anwendungen in der Möbelproduktion.', en: 'The Gannomat ProTec Profit is a CNC machining center for drilling, routing and dowel insertion in a single pass. Flexible production with high precision in a compact footprint – ideal for demanding furniture manufacturing applications.', cz: 'Gannomat ProTec Profit je CNC obráběcí centrum pro vrtání, frézování a kolkování v jednom průchodu. Flexibilní výroba s vysokou přesností na kompaktním prostoru.', sk: 'Gannomat ProTec Profit je CNC obrábacie centrum pre vŕtanie, frézovanie a kolkovanie v jednom prechode. Flexibilná výroba s vysokou presnosťou na kompaktnom priestore.', hu: 'A Gannomat ProTec Profit CNC megmunkáló központ fúráshoz, maráshoz és csapozáshoz egyetlen menetben. Rugalmas gyártás nagy precizitással kompakt helyen.' },
    highlights: ['CNC machining center — drilling, grooving and milling in one pass', 'Workpiece range: 60–1,000 mm wide × 250–5,600 mm long × 6–60 mm high', 'Air cushion tables for scratch-free handling of sensitive surfaces', 'Dual-laser measurement for precise vertical positioning', '4th axis on drilling head for horizontal boring accuracy', 'Compact footprint of only 3.3 m²'],
    specs: { 'Workpiece width (X)': '60–1.000 mm (opt. 60–1.300 mm)', 'Workpiece length (Y)': '250–5.600 mm', 'Workpiece height (Z)': '6–60 mm', 'Max. workpiece weight': '75 kg', 'Floor space': '3,3 m²' },
    seoTitle: seoT('ProTec Profit'),
    seoDescription: seoD('ProTec Profit', 'CNC-Bearbeitungszentrum für Bohren, Fräsen und Dübeleintreiben.', 'CNC machining center for drilling, routing and dowel insertion.', 'CNC obráběcí centrum pro vrtání, frézování a kolkování.'),
  },
  ...
  /* ============ FITTING (Beschlägebohr- & Einpressmaschinen) ============ */
  {
    ...
    highlights: ['Pneumatic fitting insertion for fast, precise pressing', 'Ideal for cup hinges and connecting fittings'],
  ...
  },
  {
    ...
    highlights: ['Entry-level fitting boring — reliable, compact, easy to operate'],
  ...
  },
  {
    ...
    highlights: ['Flexible fitting boring for different fitting types and sizes', 'Adaptable to various production requirements'],
  ...
  },
  {
    ...
    highlights: ['High-speed hinge and fitting boring for cabinet doors', 'Simple setup for standard 32 mm system drilling'],
  ...
  },
  {
    ...
    highlights: ['Two spindles for higher productivity', 'Ideal for medium to high volumes'],
  ...
  },
  {
    ...
    highlights: ['Three spindles for multiple fitting types simultaneously', 'Optimized for series production'],
  ...
  },
  {
    ...
    highlights: ['Four spindles for maximum flexibility and throughput'],
  ...
  },
  {
    ...
    highlights: ['Five spindles — most powerful in the Express series', 'Designed for industrial high-volume production'],
  ...
  },
  {
    ...
    highlights: ['CNC-controlled for flexible fitting and hinge patterns', 'Programmable for varying door widths', 'Integrated control for batch-size-1 production'],
  ...
  },
  {
    ...
    highlights: ['Special fitting types beyond the standard Express portfolio'],
  ...
  },
  {
    ...
    highlights: ['CNC flagship — fully automatic fitting processing', 'Designed for the most demanding industrial requirements'],
  ...
  },
  {
    ...
    highlights: ['Optimized for RTA (Ready-to-Assemble) fittings', 'Dowels and connecting fittings for flat-pack furniture'],
  ...
  },
  {
    ...
    highlights: ['Two spindles with RTA specialization', 'Higher throughput for Ready-to-Assemble fittings'],
  ...
  /* ============ CARCASS (Korpuspressen) ============ */
  {
    ...
    highlights: ['Entry-level carcass press for craft workshops', 'Simple operation and compact design', 'Adjustable for various cabinet widths and heights'],
  ...
  },
  {
    ...
    highlights: ['Optimal price-performance ratio for carcass assembly', 'Solid build quality with economical operation'],
  ...
  },
  {
    ...
    highlights: ['Premium carcass press for industrial series production', 'Highest throughput and automation level'],
  ...
  },
  {
    ...
    highlights: ['Height-adjustable assembly station for ergonomic work', 'Stepless adjustment for different workpiece sizes'],
  ...
  /* ============ BORING (Universal-Dübelbohr) ============ */
  {
    ...
    highlights: ['Universal dowel boring with 21, 27 or 35 spindles', 'Robust steel construction for daily production use', 'Austrian quality product'],
  ...
  },
  {
    ...
    highlights: ['Workpiece stop for reproducible positioning', 'Same spindle options (21/27/35) with increased repeat accuracy'],
  ...
  /* ============ ROW BORING ============ */
  {
    ...
    highlights: ['Double-row drilling for simultaneous top and bottom', 'Fast, repeatable setup for standard furniture components', 'High throughput for industrial production'],
  ...
  },
  {
    ...
    highlights: ['Extended boring range 76–152 mm for larger workpieces', 'Greater flexibility in positioning', 'High positioning accuracy'],
  ...
  /* ============ GLUING ============ */
  {
    ...
    highlights: ['Pneumatic glue dispenser for dowel holes and slots', 'Compact and easy to operate for craft and industry'],
  ...
  },
  {
    ...
    highlights: ['Electronically controlled for highest dosing accuracy', 'Clean glue delivery for demanding production environments'],
  ...
  /* ============ FRAME (Rahmendübel/Langloch) ============ */
  {
    ...
    highlights: ['Frame dowel boring for frames and solid wood parts', 'Compact and reliable for daily use'],
  ...
  },
  {
    ...
    highlights: ['Professional frame dowel boring with extended features', 'Higher performance for demanding solid wood joinery'],
  ...
  },
  {
    ...
    highlights: ['Slot boring for solid wood, stairs and frame parts', 'Adjustable for various timber dimensions'],
  ...
  /* ============ CORNER HINGE ============ */
  {
    ...
    highlights: ['Precise boring of corner hinges in window and door frames', 'Specialized for the window industry'],
  ...
  },
  {
    ...
    highlights: ['Double-sided processing of both workpiece sides simultaneously', 'Maximum efficiency in window production'],
