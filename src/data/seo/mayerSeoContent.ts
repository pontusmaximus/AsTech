...
export const MAYER_PRODUCT_SEO: Record<string, ProductSeoContent> = {
  ...
  'kappa-automatic-80': {
    longDescription: {
      ...
      sk: `Mayer kappa automatic 80 je horizontálna formátovacia píla navrhnutá ako ideálny vstup do technológie automatizovaného rezania dosiek. S výškou rezu 80 mm a dĺžkou rezu 3 200 mm poskytuje táto píla na dosky kompaktné, ale výkonné riešenie pre remeselné dielne, stolárstva a stredne veľké drevospracujúce prevádzky. Ťažká oceľová konštrukcia zaisťuje prevádzku s minimálnymi vibráciami a garantuje najvyššiu opakovateľnú presnosť pri každom reze. Vďaka robustnému prítlačnému trámu a posuvu materiálu z ocele je obsluha jedným operátorom bezproblémová, čo optimalizuje nasadenie pracovníkov a znižuje prevádzkové náklady. Plynulo regulovateľná rýchlosť posuvu od 5 do 100 m/min umožňuje flexibilné prispôsobenie rôznym dreveným materiálom, ako sú drevotriesky, MDF, preglejky a masívne drevo. Nový pílový vozík so smerom rezu proti dorazu výrazne zlepšuje kvalitu rezu. Prostredníctvom ergonomického 24-palcového ovládacieho panela s Windows softvérom možno ľahko programovať a spravovať rezné plány. Dvojitý merací systém zaručuje maximálnu rozmerovú presnosť. Asamer je váš autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko a ponúka komplexné poradenstvo, uvedenie do prevádzky a servis pre kappa automatic 80.`,
      hu: `A Mayer kappa automatic 80 egy vízszintes lapfűrész, amelyet az automatizált lapvágási technológia ideális belépő gépeként terveztek. 80 mm vágási magassággal és 3 200 mm vágóhosszal ez a lapfűrész kompakt, mégis hatékony megoldást kínál kisipari műhelyek, asztalosüzemek és közepes méretű faipari vállalkozások számára. A nehéz acélszerkezet biztosítja a rezgésmentes működést és a legmagasabb ismétlési pontosságot minden egyes vágásnál. A robusztus acél nyomógerenda és az acél anyagtoló lehetővé teszi az egyszemélyes kezelést, optimalizálva a munkaerő-ráfordítást és csökkentve az üzemeltetési költségeket. A 5-től 100 m/min-ig fokozatmentesen állítható előtolási sebesség rugalmas alkalmazkodást tesz lehetővé a különböző faalapú anyagokhoz, mint a forgácslap, MDF, rétegelt lemez és tömör fa. Az új fűrészkocsi az ütköző ellenében vágó iránnyal jelentősen javítja a vágás minőségét. Az ergonomikus 24 hüvelykes vezérlőpanel Windows-alapú szoftverével a vágási minták kényelmesen programozhatók és kezelhetők. A kettős mérőrendszer garantálja a maximális méretpontosságot. Az Asamer az Ön hivatalos Mayer viszonteladója Csehország, Szlovákia és Magyarország területén, teljes körű tanácsadással, üzembe helyezéssel és szervizzel a kappa automatic 80 modellhez.`,
    },
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Na rezanie drevených dosiek v stolárskych dielňach',
        ...
        body: {
          ...
          sk: 'kappa automatic 80 je optimálna formátovacia píla pre stolárske a nábytkárske dielne, ktoré pravidelne režú drevotriesky, MDF dosky a preglejky na mieru. Kompaktná konštrukcia šetrí podlahovú plochu, zatiaľ čo automatický posuv materiálu a prítlačný trám umožňujú obsluhu jedným operátorom. Výška rezu 80 mm pokrýva bežné formáty dosiek používané vo výrobe nábytku a interiérových vstavbách.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Na sériovú výrobu v remeselných prevádzkach',
        ...
        body: {
          ...
          sk: 'Vďaka rýchlosti posuvu až 100 m/min a softvéru na optimalizáciu rezov je kappa automatic 80 ideálne vhodná na ekonomickú sériovú výrobu v remeselných prevádzkach. Odpad materiálu je minimalizovaný, časy prípravy skrátené a priechodnosť zvýšená. Riadiaci systém na báze Windows umožňuje jednoduchú správu rezov a digitálne spracovanie zákaziek.',
    ...
    buyingAdvice: {
      ...
      sk: 'kappa automatic 80 je správna voľba, ak hľadáte kompaktnú horizontálnu formátovaciu pílu na drevené materiály a prevažne spracúvate dosky do hrúbky 80 mm. Je ideálna ako vstupný stroj pre rastúce stolárske dielne, ktoré prechádzajú z manuálnych formátovacích kotúčových píl na automatizované formátovacie píly. Kontaktujte Asamer pre individuálnu ponuku.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Aké materiály dokáže kappa automatic 80 rezať?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 80 je navrhnutá pre drevené materiály ako drevotriesky, MDF, HDF, preglejky, stolárske dosky a masívne drevo. Výška rezu 80 mm umožňuje rezanie jednotlivých dosiek aj menších stohov dosiek.',
      ...
      },
      {
        question: {
          ...
          sk: 'Dá sa kappa automatic 80 obsluhovať jedným operátorom?',
        ...
        answer: {
          ...
          sk: 'Áno, ťažká oceľová konštrukcia s automatickým prítlačným trámom a posuvom materiálu umožňuje plnú obsluhu jedným operátorom. Obsluha naprogramuje rezy na dotykovom paneli a stroj samostatne vykoná posuv a rezný proces.',
      ...
      },
      {
        question: {
          ...
          sk: 'Akú rýchlosť posuvu ponúka kappa automatic 80?',
        ...
        answer: {
          ...
          sk: 'Rýchlosť posuvu je plynule regulovateľná od 5 do 100 m/min, čo umožňuje flexibilné prispôsobenie rôznym materiálom a požiadavkám.',
      ...
      },
      {
        question: {
          ...
          sk: 'Kde môžem kúpiť Mayer kappa automatic 80?',
        ...
        answer: {
          ...
          sk: 'Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko. Ponúkame osobné poradenstvo, predvedenie, dodanie, uvedenie do prevádzky a popredajný servis z jedného zdroja.',
  ...
  'kappa-automatic-100': {
    longDescription: {
      ...
      sk: 'Mayer kappa automatic 100 je horizontálna formátovacia píla s vyššou výbavou, ktorá ponúka viac sily, viac výkonu a viac komfortu oproti vstupnému modelu. S výškou rezu 100 mm a dĺžkou rezu 3 200 mm je táto píla na dosky ideálna pre profesionálnych drevospracovateľov, výrobcov nábytku a priemyselné prevádzky so stredným až vysokým priechodom. Ťažká oceľová konštrukcia tvorí základ pre prácu s minimálnymi vibráciami a garantuje vynikajúcu opakovateľnú presnosť. Nový pílový vozík so smerom rezu proti dorazu zaisťuje čisté rezné hrany na drevotrieske, MDF, multiplexe a masívnom dreve. Plynule regulovateľná rýchlosť posuvu od 5 do 100 m/min umožňuje optimálne prispôsobenie rôznym dreveným materiálom a hrúbkam dosiek. Modulárny optimalizátor rezov výrazne znižuje odpad a zvyšuje výťažnosť materiálu. Kompatibilita so softvérom Ardis na optimalizáciu rezov umožňuje digitálne spracovanie zákaziek, napojenie na ERP systémy a komplexné plánovanie výroby. Ergonomický koncept ovládania a riadiaci systém na báze Windows robia každodennú prácu efektívnou a používateľsky prívetivou. Asamer dodáva kappa automatic 100 do Českej republiky, na Slovensko a do Maďarska a podporuje vás odborným poradenstvom, inštaláciou a údržbou.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Profesionálne rezanie dosiek vo výrobe nábytku',
        ...
        body: {
          ...
          sk: 'kappa automatic 100 je navrhnutá pre výrobcov nábytku, ktorí režú vysoké objemy korpusových dielov, frontov a políc z drevených dosiek. Výška rezu 100 mm umožňuje rezanie hrubších stohov dosiek, takže možno rezať viac dosiek v jednom prechode. Softvér na optimalizáciu rezov minimalizuje odpad a znižuje náklady na materiál na obrobok.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Interiérové vstavby a výroba predajní',
        ...
        body: {
          ...
          sk: 'V interiérových vstavbách a výrobe predajní sú rozhodujúce presné rezy a krátke časy prípravy. kappa automatic 100 s pripojením k Ardis poskytuje bezšvíkové digitálne spracovanie zákaziek od návrhu po hotový diel. Ťažká oceľová konštrukcia garantuje najvyššiu kvalitu rezu a rozmerovú presnosť aj pri nepretržitej prevádzke.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte kappa automatic 100, ak prerastáte vstupný model a potrebujete vyššiu výšku rezu, viac komfortu a modulárnu optimalizáciu rezov. Je ideálna pre prevádzky spracúvajúce dosky s hrúbkou 100 mm, ktoré chcú napojenie na softvér Ardis. Asamer vám poskytne osobné poradenstvo na mieste.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Čím sa líši kappa automatic 100 od modelu 80?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 100 ponúka výšku rezu 100 mm namiesto 80 mm, modulárny optimalizátor rezov a vyššiu výbavu s viacerými komfortnými funkciami. Dĺžka rezu zostáva 3 200 mm.',
      ...
      },
      {
        question: {
          ...
          sk: 'Môže kappa automatic 100 pracovať so softvérom na optimalizáciu rezov?',
        ...
        answer: {
          ...
          sk: 'Áno, kappa automatic 100 je kompatibilná so softvérom Ardis na optimalizáciu rezov, ktorý umožňuje automatický výpočet optimálnych rezných plánov, zníženie odpadu materiálu a digitálne spracovanie zákaziek.',
      ...
      },
      {
        question: {
          ...
          sk: 'Pre aké veľkosti prevádzok je kappa automatic 100 vhodná?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 100 je vhodná pre stredne veľké až veľké remeselné prevádzky, výrobcov nábytku a interiérové firmy s pravidelným rezaním dosiek a stredným priechodom.',
  ...
  'kappa-automatic-120': {
    longDescription: {
      ...
      sk: 'Mayer kappa automatic 120 je výkonná horizontálna formátovacia píla na rýchle a rozmerovo presné rezanie jednotlivých dosiek aj balíkov dosiek. S výškou rezu 120 mm a dĺžkou rezu 3 800 mm ponúka výrazne rozšírenú kapacitu oproti menším modelom kappa a je tak optimálnou voľbou pre stredné objemy výroby. Ťažká oceľová konštrukcia s masívnym prítlačným trámom zaručuje najvyššiu opakovateľnú presnosť a kvalitu rezu aj pri spracovaní hrubých stohov dosiek z drevotriesky, MDF, multiplexu alebo masívneho dreva. Plynule regulovateľný posuv od 5 do 100 m/min umožňuje efektívne prispôsobenie rôznym materiálom a hrúbkam dosiek. Rozšírená dĺžka rezu 3 800 mm umožňuje spracovanie veľkých formátov, ktoré sa čoraz viac vyžadujú v modernej výrobe nábytku a interiérových vstavbách. Kompatibilita s optimalizáciou rezov Ardis umožňuje minimalizovať odpad a maximalizovať výťažnosť materiálu. Stroj je vybavený ergonomickým ovládacím panelom, ktorý umožňuje intuitívne programovanie rezných plánov a možno ho integrovať do existujúcich výrobných procesov. Asamer dodáva kappa automatic 120 ako autorizovaný predajca Mayer v Českej republike, na Slovensku a v Maďarsku a stojí vám po boku s poradenstvom, predvedením, dodaním a popredajným servisom.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Rezanie balíkov pre stredne veľké série',
        ...
        body: {
          ...
          sk: 'S výškou rezu 120 mm umožňuje kappa automatic 120 efektívne rezanie balíkov dosiek. Viac drevotrieskových alebo MDF dosiek sa spracúva súčasne, čo výrazne zvyšuje priechodnosť pri sériovej výrobe korpusových dielov, políc a frontov.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Veľkoformátové dosky v interiérových vstavbách',
        ...
        body: {
          ...
          sk: 'Rozšírená dĺžka rezu 3 800 mm robí z kappa automatic 120 ideálne riešenie na rezanie veľkoformátových dosiek používaných v kvalitných interiérových vstavbách, obchodných vstavbách a obkladoch stien. Dverné výplne a stolové dosky možno takisto rezať presne a ekonomicky.',
    ...
    buyingAdvice: {
      ...
      sk: 'kappa automatic 120 sa odporúča, ak pravidelne režete balíky dosiek do 120 mm a potrebujete rozšírenú dĺžku rezu 3 800 mm. Je strednou variantou medzi kompaktným dielenským strojom a priemyselnou vlajkovou loďou. Požiadajte Asamer o individuálnu ponuku.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Aká je maximálna dĺžka rezu kappa automatic 120?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 120 ponúka dĺžku rezu 3 800 mm a je tak vhodná aj pre veľkoformátové dosky.',
      ...
      },
      {
        question: {
          ...
          sk: 'Môže kappa automatic 120 rezať balíky dosiek?',
        ...
        answer: {
          ...
          sk: 'Áno, s výškou rezu 120 mm možno rezať viac dosiek súčasne v balíku. To výrazne zvyšuje priechodnosť a je to zvlášť vhodné pre sériovú výrobu.',
      ...
      },
      {
        question: {
          ...
          sk: 'Je kappa automatic 120 vhodná pre nábytkársky priemysel?',
        ...
        answer: {
          ...
          sk: 'Áno, stroj je ideálny pre nábytkársky priemysel a interiérové vstavby. Kombinácia výšky rezu 120 mm, dĺžky rezu 3 800 mm a optimalizácie rezov pokrýva požiadavky modernej výroby nábytku.',
  ...
  'kappa-automatic-140': {
    longDescription: {
      ...
      sk: 'Mayer kappa automatic 140 je vlajkovou loďou radu kappa a ponúka maximálny výkon pre priemyselnú sériovú výrobu. S impozantnou výškou rezu 140 mm a dĺžkou rezu 4 300 mm spája táto horizontálna formátovacia píla silu, rýchlosť a flexibilitu na najvyššej úrovni. Rýchlosť posuvu je plynule regulovateľná od 5 do 100 m/min, čo ju radí medzi najrýchlejšie vo svojej triede. Robustná oceľová konštrukcia s masívnym prítlačným trámom zaručuje najvyššiu opakovateľnú presnosť a kvalitu rezu aj pri spracovaní ťažkých stohov dosiek z drevotriesky, MDF, HDF, multiplexu a masívneho dreva. Veľkoryso dimenzovaná dĺžka rezu 4 300 mm umožňuje spracovanie nadrozmerných a dlhých obrobkov potrebných v priemyselnej výrobe nábytku a zákazkovej výrobe. Kompatibilita so softvérom Ardis na optimalizáciu rezov umožňuje automatický výpočet aj zložitých rezných plánov a minimalizáciu odpadu. Dotyková obrazovka na báze Windows umožňuje rýchle a intuitívne programovanie. kappa automatic 140 je prvou voľbou pre výrobné podniky, ktoré nerobia kompromisy vo výkone a presnosti. Asamer dodáva kappa automatic 140 ako autorizovaný predajca Mayer v Českej republike, na Slovensku a v Maďarsku s komplexným servisom od poradenstva po údržbu.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Priemyselná sériová výroba nábytkových dielov',
        ...
        body: {
          ...
          sk: 'kappa automatic 140 je navrhnutá pre priemyselnú veľkosériovú výrobu. S výškou rezu 140 mm možno efektívne rezať hrubé balíky dosiek, zatiaľ čo softvér Ardis minimalizuje odpad. Vysoká rýchlosť posuvu zaisťuje maximálnu priechodnosť pri trvale vysokej kvalite rezu.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Zákazková výroba a veľké projekty',
        ...
        body: {
          ...
          sk: 'Dĺžka rezu 4 300 mm a výška rezu 140 mm robia kappa automatic 140 ideálnou pre veľké zákazkové projekty, kde treba spracúvať nadrozmerné dosky a vysoké objemy. Obklady stien, priečky a veľkoplošné nábytkové prvky možno rezať ekonomicky a rozmerovo presne.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Obchod s drevom a veľkoobchod s doskami',
        ...
        body: {
          ...
          sk: 'V obchode s drevom a veľkoobchode s doskami je kappa automatic 140 ideálna pre služby rezania na mieru: objednávky zákazníkov sa prijímajú digitálne, optimalizátor rezov vypočíta najefektívnejšie rezné plány a stroj reže rýchlosťou posuvu až 100 m/min. To znižuje čakacie doby a zvyšuje spokojnosť zákazníkov.',
    ...
    buyingAdvice: {
      ...
      sk: 'kappa automatic 140 je správna voľba pre priemyselné prevádzky, ktoré potrebujú maximálnu výšku rezu, maximálnu dĺžku rezu a najvyššiu priechodnosť v rade kappa. Ako vlajková loď je navrhnutá pre nepretržitú prevádzku v sériovej výrobe. Kontaktujte Asamer pre predvedenie a ponuku na mieru.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Je kappa automatic 140 najrýchlejšou formátovacou pílou vo svojej triede?',
        ...
        answer: {
          ...
          sk: 'S rýchlosťou posuvu až 100 m/min patrí kappa automatic 140 k najrýchlejším formátovacím pílam v triede horizontálnych píl na drevené dosky.',
      ...
      },
      {
        question: {
          ...
          sk: 'Akú dĺžku rezu ponúka kappa automatic 140?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 140 ponúka dĺžku rezu 4 300 mm, čo umožňuje spracovanie nadrozmerných a obzvlášť dlhých obrobkov.',
      ...
      },
      {
        question: {
          ...
          sk: 'Pre aké odvetvie je kappa automatic 140 vhodná?',
        ...
        answer: {
          ...
          sk: 'kappa automatic 140 je vhodná pre nábytkársky priemysel, interiérové vstavby, zákazkovú výrobu, obchod s drevom a všetky prevádzky s priemyselným rezaním dosiek v sériovej výrobe.',
  ...
  'advanced-line-100': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 100 je osvedčená klasika medzi formátovacími pílami na spracovanie hliníka, neželezných kovov a plastov. S výkonom motora 18/24 kW a výškou rezu 100 mm dodáva táto píla na dosky precízne rezy bez vibrácií aj v náročných materiáloch, ako sú hliníkové kompozitné dosky, akrylátové sklo, polykarbonát a tvrdé PVC. Stabilná konštrukcia stroja a vynikajúce vedenie pílového vozíka zaisťujú trvale vysokú kvalitu rezu v nepretržitej prevádzke. Dĺžka rezu je konfigurovateľná medzi 3 200 a 4 200 mm, čo umožňuje flexibilné prispôsobenie rôznym formátom obrobkov. Rýchlosť posuvu od 0,2 do 60 m/min je plynule regulovateľná a prispôsobená špeciálnym požiadavkám spracovania kovov; najmä nízke rýchlosti posuvu umožňujú rezy bez otrepov v hliníkových doskách a plastových profiloch. Univerzálne valčekové stoly umožňujú obsluhu jedným operátorom a prepravu veľkých dosiek. advanced line 100 sa osvedčila v tisíckach inštalácií po celom svete a je spoľahlivým partnerom pre každodennú výrobnú prevádzku. Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko a poskytuje komplexné poradenstvo k advanced line 100 vrátane plánovania rozmiestnenia, uvedenia do prevádzky a školenia.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Rezanie hliníkových kompozitných dosiek',
        ...
        body: {
          ...
          sk: 'advanced line 100 je priamo predurčená na rezanie hliníkových kompozitných dosiek (Alucobond, Dibond a podobné). Nízka rýchlosť posuvu od 0,2 m/min a motor 18/24 kW vytvárajú čisté rezné hrany bez otrepov a bez nutnosti následného opracovania. Výrobcovia fasád a reklamní technici profitujú z vysokej rozmerovej presnosti.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Spracovanie plastových dosiek',
        ...
        body: {
          ...
          sk: 'Akrylátové sklo (PMMA), polykarbonát, tvrdé PVC a ďalšie technické plasty možno na advanced line 100 rezať bez otrepov a bez vytrhávania. Plynule regulovateľná rýchlosť posuvu umožňuje optimálne prispôsobenie rôznym typom plastov a hrúbkam materiálu.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Spracovanie neželezných kovov',
        ...
        body: {
          ...
          sk: 'Okrem hliníka spracúva advanced line 100 aj mosadz, meď a ďalšie neželezné kovy. Konštrukcia s nízkymi vibráciami a precízne vedenie pílového vozíka zaručujú presné výsledky aj pri citlivých materiáloch.',
    ...
    buyingAdvice: {
      ...
      sk: 'advanced line 100 je vaša voľba, ak hľadáte osvedčenú formátovaciu pílu na hliník a plasty v triede 100 mm. Presvedčí spoľahlivosťou a rezmi bez vibrácií a je ideálna pre výrobcov fasád, reklamných technikov a spracovateľov plastov. Asamer ponúka osobné poradenstvo.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Môže advanced line 100 rezať hliník?',
        ...
        answer: {
          ...
          sk: 'Áno, advanced line 100 je špeciálne navrhnutá na rezanie hliníka, hliníkových kompozitných dosiek a neželezných kovov. Motor 18/24 kW dodáva potrebný výkon pre čisté rezy bez otrepov.',
      ...
      },
      {
        question: {
          ...
          sk: 'Akú rýchlosť posuvu má advanced line 100?',
        ...
        answer: {
          ...
          sk: 'Rýchlosť posuvu je 0,2 až 60 m/min, plynule regulovateľná. Nízke rýchlosti sú kľúčové pre rezy bez otrepov v hliníku a plastoch.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aké plasty môže advanced line 100 spracúvať?',
        ...
        answer: {
          ...
          sk: 'advanced line 100 spracúva akrylátové sklo (PMMA), polykarbonát, tvrdé PVC, PE, PP a ďalšie technické plasty bez otrepov a bez vytrhávania.',
  ...
  'advanced-line-130': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 130 je všestranná formátovacia píla na hliník, neželezné kovy a plasty s výškou rezu 130 mm a integrovaným odsávaním. Stabilná konštrukcia v kombinácii s precíznymi ložiskami bez vibrácií zaisťuje presné výsledky pri každom reze. Systém Dual Servo Drive s dvoma nezávislými servomotormi dodáva absolútnu presnosť polohovania a umožňuje programovateľné korekčné krivky pre rôzne materiály. Motor 24 kW poháňa pílový kotúč 500 mm s presahom 142 mm a poskytuje tak výkonovú rezervu potrebnú na rezanie hrubých hliníkových kompozitných dosiek a masívnych plastových blokov. Dĺžka rezu je konfigurovateľná medzi 3 200 a 4 200 mm. Dvojitý prítlačný trám s laserovým meraním minimalizuje orezové rezy a optimalizuje spotrebu materiálu. Patentovaný rozovierací klin zabraňuje zaseknutiu pri doskách s vysokým vnútorným pnutím materiálu. Integrované odsávanie udržiava pracovný priestor čistý a spĺňa požiadavky na bezpečnosť práce. Voliteľný predný otočný stôl umožňuje 90° prepolohovanie pre úspornú flexibilitu. advanced line 130 je konfigurovateľná na mieru podľa potrieb zákazníka a spája výnimočné s užitočným. Asamer ako autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko ponúka komplexné poradenstvo a individuálne riešenia pre advanced line 130.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Stavba fasád z hliníkových kompozitných dosiek',
        ...
        body: {
          ...
          sk: 'advanced line 130 je ideálna pre staviteľov fasád režúcich hliníkové kompozitné dosky ako Alucobond alebo Dibond na mieru. Výška rezu 130 mm pojme aj hrubšie kompozitné materiály a sendvičové panely. Laserové meranie na prítlačnom tráme znižuje orezové rezy a náklady na materiál.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Spracovanie plastov v priemyselnom meradle',
        ...
        body: {
          ...
          sk: 'Pre spracovateľov plastov ponúka advanced line 130 kombináciu výkonu, presnosti a integrovaného odsávania. Masívne plastové bloky z polyetylénu, polyamidu alebo PTFE sa režú rovnako čisto ako tenké akrylátové dosky. Patentovaný rozovierací klin zabraňuje zaseknutiu pri materiáloch pod pnutím.',
    ...
    buyingAdvice: {
      ...
      sk: 'advanced line 130 je optimálna, ak potrebujete výšku rezu 130 mm, integrované odsávanie a Dual Servo Drive. Ponúka viac než model 100 a je kompaktnejšia než model 160. Ideálna pre staviteľov fasád, reklamných technikov a spracovateľov plastov hľadajúcich riešenie na mieru. Kontaktujte Asamer pre individuálnu konfiguráciu.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Čo je systém Dual Servo Drive pri advanced line 130?',
        ...
        answer: {
          ...
          sk: 'Systém Dual Servo Drive pozostáva z dvoch nezávislých servomotorov, ktoré poskytujú absolútnu presnosť polohovania a programovateľné korekčné krivky pre rôzne materiály.',
      ...
      },
      {
        question: {
          ...
          sk: 'Má advanced line 130 integrované odsávanie?',
        ...
        answer: {
          ...
          sk: 'Áno, advanced line 130 disponuje integrovaným odsávaním, ktoré udržiava pracovný priestor čistý a spĺňa požiadavky na bezpečnosť práce.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aký pílový kotúč používa advanced line 130?',
        ...
        answer: {
          ...
          sk: 'advanced line 130 používa pílový kotúč 500 mm s presahom 142 mm, poháňaný motorom 24 kW.',
  ...
  'advanced-line-160': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 160 je mnohonásobne ocenená vysokovýkonná formátovacia píla s PC riadením cez dotykový displej, ponúkajúca výšku rezu 160 mm na priemyselné spracovanie hliníka, neželezných kovov a plastov. Výkonný motor 35 kW poháňa pílový kotúč 600 mm s presahom 180 mm a dodáva rezný výkon potrebný pre hrubé hliníkové kompozitné dosky, masívne plastové bloky a obrobky z neželezných kovov. Dĺžka rezu je konfigurovateľná medzi 3 200 a 4 200 mm pri rýchlosti posuvu 0,2 až 60 m/min. advanced line 160 získala niekoľko ocenení za inovatívne riešenia a patenty a stanovuje meradlá vo svojej triede. Systém Dual Servo Drive s programovateľnými korekčnými krivkami zaisťuje najvyššiu presnosť polohovania nezávisle od materiálu. PC riadenie s intuitívnym dotykovým displejom umožňuje komfortnú správu zákaziek, ukladanie rezných plánov a integráciu do nadradených výrobných systémov. Lamelový screen zaisťuje optimálny výkon odsávania a udržiava pracovný priestor bez triesok a prachu. advanced line 160 je skutočný univerzál pre náročné priemyselné aplikácie, kde sa rovnako vyžaduje vysoká priechodnosť aj maximálna presnosť rezu. Asamer ako autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko poskytuje kompletnú podporu od poradenstva cez inštaláciu po popredajný servis.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Priemyselné spracovanie hliníkových dosiek',
        ...
        body: {
          ...
          sk: 'advanced line 160 je prvou voľbou pre priemyselných spracovateľov hliníka s vysokým priechodom. Motor 35 kW a pílový kotúč 600 mm režú aj hrubé hliníkové dosky a kompozitné materiály presne a bez otrepov. PC riadenie umožňuje ukladanie tisícok rezných plánov a bezšvíkovú integráciu do ERP.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Technické plasty a kompozity',
        ...
        body: {
          ...
          sk: 'Kombinácia variabilnej rýchlosti posuvu a programovateľných korekčných kriviek robí advanced line 160 ideálnou na spracovanie technických plastov ako PTFE, PEEK, POM a sklenenými vláknami vystužených kompozitov. Lamelový screen zaisťuje efektívne odsávanie plastových triesok.',
    ...
    buyingAdvice: {
      ...
      sk: 'advanced line 160 je vaša voľba pre priemyselné požiadavky na výšku rezu (160 mm), výkon motora (35 kW) a PC riadenie. Hodí sa pre prevádzky spracúvajúce hliník, plasty a neželezné kovy v nepretržitej veľkoobjemovej výrobe. Nechajte si od Asamer vypracovať ponuku na mieru.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Aký riadiaci systém má advanced line 160?',
        ...
        answer: {
          ...
          sk: 'advanced line 160 disponuje PC riadením s dotykovým displejom, ktoré umožňuje intuitívne plánovanie zákaziek, ukladanie rezných plánov a integráciu do ERP.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aký výkonný je motor advanced line 160?',
        ...
        answer: {
          ...
          sk: 'advanced line 160 je vybavená motorom 35 kW, ktorý poháňa pílový kotúč 600 mm s presahom 180 mm.',
      ...
      },
      {
        question: {
          ...
          sk: 'Za čo bola advanced line 160 ocenená?',
        ...
        answer: {
          ...
          sk: 'advanced line 160 získala mnohonásobné ocenenia za inovatívne riešenia a patenty vrátane systému Dual Servo Drive a PC riadenia cez dotykový displej.',
  ...
  'advanced-line-160-turn': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 160 turn rozširuje osvedčenú platformu 160 o automatickú 90° otočnú jednotku a umožňuje tak obojstranné spracovanie v jednom prechode. Táto formátovacia píla je špeciálne navrhnutá pre výrobné linky, kde treba vykonávať pozdĺžne aj priečne rezy bez manuálneho premiestňovania obrobkov. Výška rezu 160 mm, motor 35 kW a pílový kotúč 600 mm s presahom 180 mm ponúkajú rovnaký výkon ako štandardná verzia 160. Automatická otočná jednotka otáča dosky o 90° a polohuje ich na ďalší rez, čím zrýchľuje materiálový tok a minimalizuje zásahy obsluhy. To je zvlášť cenné pri spracovaní veľkoformátových hliníkových kompozitných dosiek a ťažkých plastových dosiek, s ktorými sa dá manuálne len ťažko manipulovať. Systém Dual Servo Drive zaručuje najvyššiu presnosť polohovania aj po otočení. Komfortné ovládanie umožňuje ľahkú manipuláciu s materiálom aj pri nadrozmerných doskách. Dĺžka rezu je konfigurovateľná medzi 3 200 a 4 200 mm. Dvojitý prítlačný trám s laserovým meraním zaisťuje, že oba smery rezu dosahujú rovnakú presnosť. advanced line 160 turn je logická voľba pre prevádzky, ktoré chcú posunúť produktivitu a automatizáciu v spracovaní hliníka a plastov na ďalšiu úroveň. Asamer je váš kontakt ako autorizovaný predajca Mayer pre CZ, SK a HU.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Automatizované pozdĺžne a priečne rezy v jednom prechode',
        ...
        body: {
          ...
          sk: 'Otočná jednotka 90° pri advanced line 160 turn umožňuje pozdĺžne a priečne rezy bez manuálneho premiestňovania. Dosky sa automaticky otočia a napolohujú na ďalší rez. To zvyšuje priechodnosť až o 40 % oproti strojom bez otočnej jednotky a znižuje potrebu personálu.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Spracovanie veľkých hliníkových formátov',
        ...
        body: {
          ...
          sk: 'Pri spracovaní veľkoformátových hliníkových dosiek a kompozitov je otočná jednotka obrovskou výhodou: ťažké dosky netreba ručne otáčať, čo zlepšuje ergonómiu, zabraňuje poškodeniu a optimalizuje materiálový tok.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte advanced line 160 turn, ak vo vašej výrobe pravidelne potrebujete pozdĺžne a priečne rezy na hliníkových alebo plastových doskách a chcete automatizovať otáčanie. Investícia sa vráti vďaka vyššej priechodnosti a nižšej potrebe personálu. Asamer vám poradí s optimálnou konfiguráciou.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Čo robí otočná jednotka advanced line 160 turn?',
        ...
        answer: {
          ...
          sk: 'Automatická 90° otočná jednotka otočí obrobky po pozdĺžnom reze o 90° a napolohuje ich na priečny rez. Oba smery rezu sa vykonajú v jednom prechode bez manuálneho zásahu.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aký nárast produktivity prináša otočná jednotka?',
        ...
        answer: {
          ...
          sk: 'Otočná jednotka môže zvýšiť priechodnosť až o 40 %, pretože odpadá manuálne otáčanie a prepolohovanie dosiek a materiálový tok prebieha nepretržite.',
      ...
      },
      {
        question: {
          ...
          sk: 'Pre aké materiály je advanced line 160 turn vhodná?',
        ...
        answer: {
          ...
          sk: 'advanced line 160 turn je vhodná pre hliník, hliníkové kompozitné dosky, neželezné kovy a plasty všetkého druhu, od akrylátového skla cez PVC po technické vysokovýkonné plasty.',
  ...
  'advanced-line-200': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 200 je vysokovýkonná formátovacia píla na veľkoformátové obrobky z hliníka, neželezných kovov a plastov. S impozantnou výškou rezu 200 mm, dĺžkou rezu až 5 600 mm a motorom 43 kW je to ťahúň pre náročné priemyselné prostredia. Pílový kotúč 670 mm s presahom 215 mm dodáva rezný výkon potrebný pre masívne hliníkové balíky a hrubé plastové bloky. Ťažký strojný rám je skonštruovaný na výnimočnú nosnosť a zostáva absolútne stabilný aj pri maximálnom zaťažení. Systém Dual Servo Drive so separátnymi meracími systémami zaručuje najvyššiu presnosť polohovania a dvojitý prítlačný trám s laserovým meraním zaisťuje rovnomerné upnutie po celej dĺžke obrobku. Rýchlosť posuvu od 0,2 do 60 m/min umožňuje pomalé rezy bez otrepov v hliníku aj rýchle prechody pri mäkších plastoch. Dĺžka rezu až 5 600 mm otvára možnosti v dopravnom, automobilovom a kontajnerovom priemysle, kde sa spracúvajú nadrozmerné dosky. advanced line 200 je stroj pre prevádzky, ktoré neprijímajú žiadne obmedzenie veľkosti obrobku a hrúbky materiálu. Asamer je váš partner ako autorizovaný predajca Mayer pre poradenstvo, dodávky a servis v Českej republike, na Slovensku a v Maďarsku.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Veľkoformátové rezy v dopravnom priemysle',
        ...
        body: {
          ...
          sk: 'V automobilovom, kontajnerovom a dopravnom priemysle sa spracúvajú hliníkové dosky a plastové panely v nadrozmerných formátoch. advanced line 200 s dĺžkou rezu 5 600 mm a výškou rezu 200 mm ponúka kapacitu potrebnú pre tieto aplikácie. Motor 43 kW a pílový kotúč 670 mm zaisťujú čisté rezy aj na hrubých stohoch materiálu.',
      ...
      },
      {
        ...
        body: {
          ...
          sk: 'Pre ťažkú priemyselnú výrobu, kde sa masívne hliníkové a plastové bloky režú na mieru, je advanced line 200 skonštruovaná so svojím motorom 43 kW a ťažkým strojným rámom. Dual Servo Drive so separátnymi meracími systémami zaručuje rozmerovú presnosť aj po tisíckach rezov v nepretržitej prevádzke.',
    ...
    buyingAdvice: {
      ...
      sk: 'advanced line 200 je správny stroj, ak potrebujete výšku rezu 200 mm, dĺžku rezu 5 600 mm a výkon motora 43 kW. Hodí sa pre priemyselnú výrobu s veľkoformátovými hliníkovými a plastovými obrobkami. Asamer vám vypracuje ponuku s individuálnou konfiguráciou.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Aká je maximálna dĺžka rezu advanced line 200?',
        ...
        answer: {
          ...
          sk: 'advanced line 200 ponúka dĺžku rezu až 5 600 mm, ideálnu pre nadrozmerné dosky v dopravnom a kontajnerovom priemysle.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aký motor má advanced line 200?',
        ...
        answer: {
          ...
          sk: 'advanced line 200 je vybavená výkonným motorom 43 kW, ktorý poháňa pílový kotúč 670 mm s presahom 215 mm.',
      ...
      },
      {
        question: {
          ...
          sk: 'Pre aké odvetvia je advanced line 200 vhodná?',
        ...
        answer: {
          ...
          sk: 'advanced line 200 je vhodná pre dopravný, automobilový a kontajnerový priemysel, stavbu fasád a všetky odvetvia spracúvajúce veľkoformátové hliníkové alebo plastové dosky.',
  ...
  'advanced-line-250': {
    longDescription: {
      ...
      sk: 'Mayer advanced line 250 je najsilnejšia formátovacia píla vo svojej triede a stanovuje nové meradlá v technológii priemyselného rezania dosiek s motorom 55/75 kW, priemerom pílového kotúča 860 mm a presahom 270 mm. Táto formátovacia píla bola navrhnutá pre nekompromisnú priemyselnú výrobu, kde rovnako záleží na maximálnom reznom výkone aj najvyššej kvalite rezu. Výška rezu 250 mm a konfigurovateľná dĺžka rezu od 3 200 do 4 200 mm umožňujú spracovanie masívnych obrobkov z hliníka, neželezných kovov a plastov, ktoré tlačia iné stroje na hranicu ich možností. Rýchlosť posuvu od 0,2 do 60 m/min je optimalizovaná na ťažké obrábanie: pomalé, vibráciami kontrolované rezy v hrubom hliníku a rýchlejšie prechody v plastoch. Dual Servo Drive so separátnymi meracími systémami a programovateľnými korekčnými krivkami zaručuje vynikajúcu presnosť rezu aj pri maximálnom zaťažení a po tisíckach rezov. Ťažký strojný rám pohlcuje enormné rezné sily a zabraňuje akýmkoľvek rezonančným vibráciám. advanced line 250 je stroj prvej voľby pre hlinikárne, centrá spracovania plastov a náročné priemyselné podniky. Asamer ako autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko ponúka komplexné poradenstvo, projektové plánovanie a servis pre advanced line 250.',
    ...
    applicationSections: [
      {
        ...
        body: {
          ...
          sk: 'advanced line 250 bola skonštruovaná na ťažké obrábanie hrubých hliníkových dosiek a blokov. Motor 55/75 kW a pílový kotúč 860 mm zvládajú hrúbky materiálu až 250 mm a pritom dodávajú rezy bez otrepov najvyššej kvality. To z nej robí prvú voľbu pre hlinikárne a veľkoobchody.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Spracovanie masívnych plastových blokov',
        ...
        body: {
          ...
          sk: 'Masívne plastové bloky z polyetylénu, polyamidu, PTFE a ďalších technických plastov vyžadujú stroj s výnimočným výkonom. advanced line 250 s výškou rezu 250 mm a enormným výkonom motora poskytuje potrebnú kapacitu pre tieto náročné materiály.',
    ...
    buyingAdvice: {
      ...
      sk: 'advanced line 250 je investícia pre prevádzky, ktoré potrebujú najsilnejšiu formátovaciu pílu vo svojej triede. S motorom 55/75 kW a výškou rezu 250 mm neexistujú limity. Hodí sa pre ťažkú priemyselnú výrobu v hlinikárňach, centrách spracovania plastov a veľkoprevádzkach. Asamer vám poradí s konfiguráciou.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Prečo je advanced line 250 najsilnejšia vo svojej triede?',
        ...
        answer: {
          ...
          sk: 'advanced line 250 kombinuje motor 55/75 kW s pílovým kotúčom 860 mm a presahom 270 mm, čo z nej robí najvýkonnejšiu formátovaciu pílu vo svojej triede.',
      ...
      },
      {
        question: {
          ...
          sk: 'Akú výšku rezu ponúka advanced line 250?',
        ...
        answer: {
          ...
          sk: 'advanced line 250 ponúka výšku rezu 250 mm, najvyššiu v rade Advanced Line a navrhnutú pre masívne hliníkové a plastové bloky.',
      ...
      },
      {
        question: {
          ...
          sk: 'Môže advanced line 250 rezať aj plasty?',
        ...
        answer: {
          ...
          sk: 'Áno, advanced line 250 okrem hliníka a neželezných kovov spracúva aj všetky bežné technické plasty ako PE, PA, PTFE, PEEK a sklolamináty.',
  ...
  winkelanlagen: {
    longDescription: {
      ...
      sk: 'Mayer Winkelanlagen (uhlové rezacie systémy) sú zákazkové priemyselné rezacie riešenia, ktoré kombinujú automatizované pozdĺžne a priečne rezy v jednom integrovanom systéme. Tieto uhlové rezacie inštalácie sa individuálne konfigurujú podľa špecifických požiadaviek zákazníka a predstavujú najvyšší stupeň automatizácie v technológii rezania dosiek. Systémy spracúvajú hliník, neželezné kovy, plasty a drevené materiály a sú navrhnuté na integráciu do existujúcich výrobných liniek a ERP systémov. Materiálový tok je plne automatizovaný: dosky sa privádzajú, pozdĺžne režú, automaticky otáčajú o 90° a potom priečne režú. To eliminuje manuálnu manipuláciu, znižuje potrebu personálu na minimum a maximalizuje priechodnosť. Konfigurácia zahŕňa dĺžku rezu, výšku rezu, výkon motora, posuvový systém, odsávanie a komponenty na manipuláciu s materiálom, presne prispôsobené spracúvaným materiálom, formátom a objemom výroby. Uhlové rezacie systémy Mayer nachádzajú uplatnenie v nábytkárskom priemysle, stavbe fasád, spracovaní hliníka a plastov a v automobilovom priemysle. Investícia do uhlového rezacieho systému sa vráti vďaka dramaticky zvýšenej produktivite, zníženému materiálovému vstupu a nižším personálnym nákladom. Asamer ako autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko je váš partner pre plánovanie, konfiguráciu a realizáciu vášho individuálneho uhlového rezacieho systému.',
    ...
    applicationSections: [
      {
        heading: {
          ...
          sk: 'Plne automatizované výrobné linky',
        ...
        body: {
          ...
          sk: 'Uhlové rezacie systémy Mayer sú srdcom plne automatizovaných výrobných liniek. Nepretržitý materiálový tok od prívodu dosiek cez pozdĺžne a priečne rezanie po výstup hotových narezaných dielov znižuje obsluhu na minimum a maximalizuje denný výstup.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Integrácia do ERP a Priemysel 4.0',
        ...
        body: {
          ...
          sk: 'Uhlové rezacie systémy možno bezšvíkovo integrovať do existujúcich ERP systémov, takže objednávky zákazníkov sa prijímajú digitálne, automaticky prevádzajú na optimalizované rezné plány a vyrábajú bez manuálneho zásahu. To je cesta k Priemyslu 4.0 v rezaní dosiek.',
    ...
    buyingAdvice: {
      ...
      sk: 'Uhlové rezacie systémy Mayer sú správna investícia, ak chcete plne automatizovať vašu výrobu dosiek a spojiť pozdĺžne aj priečne rezy v súvislom systéme. Každá inštalácia je individuálne konfigurovaná. Kontaktujte Asamer pre nezáväznú projektovú konzultáciu.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Čo sú uhlové rezacie systémy Mayer?',
        ...
        answer: {
          ...
          sk: 'Uhlové rezacie systémy Mayer sú zákazkové priemyselné rezacie inštalácie, ktoré kombinujú automatizované pozdĺžne a priečne rezy v jednom integrovanom systéme. Konfigurujú sa individuálne podľa požiadaviek zákazníka.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aké materiály spracúvajú uhlové rezacie systémy Mayer?',
        ...
        answer: {
          ...
          sk: 'Uhlové rezacie systémy Mayer spracúvajú hliník, neželezné kovy, plasty a drevené materiály, podľa individuálnej konfigurácie.',
      ...
      },
      {
        question: {
          ...
          sk: 'Možno uhlové rezacie systémy integrovať do ERP systémov?',
        ...
        answer: {
          ...
          sk: 'Áno, uhlové rezacie systémy Mayer sú navrhnuté na bezšvíkovú integráciu do existujúcich ERP a výrobných systémov a podporujú digitálne spracovanie zákaziek a automatickú optimalizáciu rezov.',
      ...
      },
      {
        question: {
          ...
          sk: 'Ako môžem dopytovať uhlový rezací systém u Asamer?',
        ...
        answer: {
          ...
          sk: 'Kontaktujte Asamer pre nezáväznú projektovú konzultáciu. Analyzujeme vaše potreby a nakonfigurujeme uhlový rezací systém individuálne prispôsobený vašim výrobným požiadavkám.',
...
export const MAYER_CATEGORY_SEO: Record<MayerCategory, CategorySeoContent> = {
  ...
  kappa: {
    introExpanded: {
      ...
      sk: 'Rad Mayer kappa zahŕňa horizontálne formátovacie píly špeciálne vyvinuté na rezanie drevených materiálov. Od kompaktnej kappa automatic 80 ako vstupného modelu po vlajkovú loď kappa automatic 140 s dĺžkou rezu 4 300 mm a priemyselným výkonom ponúka rad riešenia pre každú veľkosť podniku a požiadavku na priechodnosť. Všetky stroje kappa sa vyznačujú ťažkou oceľovou konštrukciou, ktorá zaisťuje prácu s minimálnymi vibráciami a najvyššiu opakovateľnú presnosť. Automatický prítlačný trám a posuv materiálu z ocele umožňujú obsluhu jedným operátorom a znižujú personálne náklady. Plynule regulovateľná rýchlosť posuvu od 5 do 100 m/min patrí k najvyšším na trhu a zaisťuje rýchle cyklové časy v sériovej výrobe. Všetky modely sú kompatibilné so softvérom Ardis na optimalizáciu rezov pre automatický výpočet rezov, minimalizáciu odpadu a digitálne spracovanie zákaziek. Rad kappa spracúva drevotriesky, MDF, HDF, preglejky, multiplex, stolárske dosky a masívne drevo. Typické oblasti použitia zahŕňajú stolárske dielne, výrobcov nábytku, interiérové firmy, obchod s drevom a priemyselné výrobné prevádzky. Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko a ponúka pre celý rad kappa poradenstvo, predvedenie, dodanie, uvedenie do prevádzky a popredajný servis. Kontaktujte nás pre osobné poradenstvo a individuálnu ponuku.',
    ...
    sections: [
      {
        heading: {
          ...
          sk: 'Technológia formátovacích píl kappa',
        ...
        body: {
          ...
          sk: 'Všetky modely kappa zdieľajú rovnakú základnú technológiu: ťažká oceľová konštrukcia, nový pílový vozík so smerom rezu proti dorazu, dvojitý merací systém pre maximálnu opakovateľnú presnosť a ergonomický 24-palcový ovládací panel so softvérom na báze Windows. Rýchlosť posuvu od 5 do 100 m/min je plynule regulovateľná a umožňuje prispôsobenie rôznym dreveným materiálom.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Porovnanie modelov: kappa 80 až kappa 140',
        ...
        body: {
          ...
          sk: 'kappa automatic 80 ponúka 80 mm výšku rezu a 3 200 mm dĺžku rezu ako vstupný model. kappa automatic 100 rozširuje na 100 mm s modulárnym optimalizátorom rezov. kappa automatic 120 dodáva 120 mm a 3 800 mm dĺžku rezu. kappa automatic 140 je vlajková loď so 140 mm výškou rezu a 4 300 mm dĺžkou rezu pre priemyselnú sériovú výrobu.',
      ...
      },
      {
        ...
        body: {
          ...
          sk: 'Rad kappa podporuje softvér Ardis na optimalizáciu rezov, ktorý automaticky vypočítava najefektívnejšie rezné plány, minimalizuje odpad a umožňuje bezšvíkové digitálne spracovanie zákaziek od kancelárie po stroj. To je zásadný stavebný kameň digitalizácie v drevospracujúcich prevádzkach.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Ktorá formátovacia píla Mayer kappa je pre mňa tá pravá?',
        ...
        answer: {
          ...
          sk: 'Voľba závisí od vašej požadovanej výšky rezu, dĺžky rezu a objemu výroby. kappa 80 sa hodí na vstup, kappa 100 a 120 na stredné požiadavky a kappa 140 na priemyselnú sériovú výrobu. Asamer vám rád osobne poradí.',
      ...
      },
      {
        question: {
          ...
          sk: 'Môžem si kappa formátovaciu pílu kúpiť u Asamer?',
        ...
        answer: {
          ...
          sk: 'Áno, Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko. Ponúkame kompletný rad kappa s poradenstvom, dodaním, uvedením do prevádzky a servisom.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aké drevené materiály môže rad kappa spracúvať?',
        ...
        answer: {
          ...
          sk: 'Rad kappa spracúva drevotriesky, MDF, HDF, preglejky, multiplex, stolárske dosky, masívne drevo a ďalšie drevené materiály.',
  ...
  advanced: {
    introExpanded: {
      ...
      sk: 'Mayer Advanced Line je rad horizontálnych formátovacích píl špeciálne vyvinutých na spracovanie hliníka, neželezných kovov, plastov a kompozitov. Rad siaha od osvedčenej advanced line 100 s motorom 18/24 kW po najsilnejšiu formátovaciu pílu vo svojej triede, advanced line 250 s motorom 55/75 kW a pílovým kotúčom 860 mm. Každý model bol optimalizovaný na rezy bez vibrácií a bez otrepov v náročných materiáloch. Nízke rýchlosti posuvu od 0,2 m/min sú kľúčové pre čisté rezné hrany v hliníku a citlivých plastoch, zatiaľ čo rýchlosti do 60 m/min umožňujú rýchle prechody pri mäkších materiáloch. Všetky modely Advanced Line disponujú systémom Dual Servo Drive s dvoma nezávislými servomotormi pre absolútnu presnosť polohovania. Vyššie modely ponúkajú PC riadenie cez dotykový displej, programovateľné korekčné krivky a patentovaný lamelový screen pre optimálne odsávanie. advanced line 160 turn rozširuje možnosti o automatickú 90° otočnú jednotku na obojstranné spracovanie v jednom prechode. Typické oblasti použitia zahŕňajú stavbu fasád, reklamnú techniku, spracovanie plastov, hliníkové sklady, dopravný priemysel a priemyselnú výrobu. Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko a ponúka celý rad Advanced Line s komplexným poradenstvom, projektovým plánovaním, inštaláciou, školením a popredajným servisom.',
    ...
    sections: [
      {
        heading: {
          ...
          sk: 'Pre aké materiály je Advanced Line vhodná?',
        ...
        body: {
          ...
          sk: 'Advanced Line spracúva hliník vo všetkých zliatinách a formách (plný materiál, kompozitné dosky, profily), neželezné kovy ako mosadz a meď a všetky bežné plasty od akrylátového skla cez PVC po technické vysokovýkonné plasty ako PTFE a PEEK. Presne reže aj kompozity vystužené sklenenými a uhlíkovými vláknami.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Prehľad modelov Advanced Line',
        ...
        body: {
          ...
          sk: 'advanced line 100 (18/24 kW, 100 mm) je klasika. advanced line 130 (24 kW, 130 mm) ponúka integrované odsávanie a Dual Servo Drive. advanced line 160 (35 kW, 160 mm) je ocenená verzia s PC riadením. advanced line 160 turn pridáva 90° otočnú jednotku. advanced line 200 (43 kW, 200 mm) je určená pre veľké formáty do 5 600 mm. advanced line 250 (55/75 kW, 250 mm) je najsilnejšia vo svojej triede.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Dual Servo Drive a precízna technológia',
        ...
        body: {
          ...
          sk: 'Systém Dual Servo Drive je srdcom Advanced Line a používa dva nezávislé servomotory pre absolútnu presnosť polohovania. Programovateľné korekčné krivky umožňujú automatickú kompenzáciu odchýlok spôsobených materiálom. V kombinácii s dvojitým prítlačným trámom a laserovým meraním dosahujú píly Advanced Line presnosť rezu, ktorá nemá v odbore obdobu.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Ktorá Advanced Line je vhodná pre hliníkové kompozitné dosky?',
        ...
        answer: {
          ...
          sk: 'Pre hliníkové kompozitné dosky sú vhodné všetky modely Advanced Line. advanced line 100 je ideálna ako vstup, zatiaľ čo 130 a 160 s integrovaným odsávaním a vyšším výkonom motora sú vhodnejšie pre väčšie objemy.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aký je rozdiel medzi kappa a Advanced Line?',
        ...
        answer: {
          ...
          sk: 'Rad kappa je optimalizovaný na drevené materiály a ponúka vysoké rýchlosti posuvu do 100 m/min. Advanced Line je navrhnutá pre hliník, neželezné kovy a plasty a ponúka nižšie rýchlosti posuvu od 0,2 m/min pre rezy bez otrepov v kove.',
      ...
      },
      {
        question: {
          ...
          sk: 'Ponúka Asamer servis pre Advanced Line?',
        ...
        answer: {
          ...
          sk: 'Áno, Asamer je autorizovaný predajca Mayer a ponúka pre celý rad Advanced Line poradenstvo, projektové plánovanie, dodanie, uvedenie do prevádzky, školenie a popredajný servis v Českej republike, na Slovensku a v Maďarsku.',
  ...
  industrial: {
    introExpanded: {
      ...
      sk: 'Priemyselné riešenia Mayer idú nad rámec jednotlivých formátovacích píl a zahŕňajú zákazkové uhlové rezacie systémy pre plne automatizované výrobné linky. Tieto systémy sa individuálne konfigurujú podľa požiadaviek zákazníka a integrujú kapacity na pozdĺžne a priečne rezanie v súvislom systéme s automatickým materiálovým tokom. Dosky sa privádzajú, pozdĺžne režú, automaticky otáčajú o 90° a potom priečne režú bez akéhokoľvek manuálneho zásahu. Možnosti použitia pokrývajú všetky materiály spracúvané aj jednotlivými strojmi radov kappa a Advanced Line: drevené materiály, hliník, neželezné kovy, plasty a kompozity. Priemyselné riešenia sú navrhnuté na integráciu do existujúcich ERP a výrobných systémov a podporujú digitálne spracovanie zákaziek, automatickú optimalizáciu rezov a koncepty Priemyslu 4.0. Návratnosť investície do uhlového rezacieho systému vyplýva z dramaticky zvýšenej produktivity, zníženého odpadu materiálu vďaka optimalizovaným rezným plánom, znížených personálnych nákladov vďaka automatizácii a trvale vysokej kvality rezu aj vo viaczmennej prevádzke. Uhlové rezacie systémy Mayer sa celosvetovo používajú v nábytkárskom priemysle, stavbe fasád, spracovaní hliníka a plastov a v automobilovom priemysle. Asamer je autorizovaný predajca Mayer pre Českú republiku, Slovensko a Maďarsko a váš kontakt pre plánovanie, konfiguráciu, inštaláciu a prevádzku vášho individuálneho priemyselného riešenia. Analyzujeme váš výrobný proces, vypracujeme koncept na mieru a sprevádzame vás od projektového plánovania cez uvedenie do prevádzky a ďalej.',
    ...
    sections: [
      {
        ...
        body: {
          ...
          sk: 'Uhlové rezacie systémy Mayer sú plne automatizované rezacie inštalácie, ktoré kombinujú pozdĺžne a priečne rezy v integrovanom systéme. Dosky sa automaticky privádzajú, režú, otáčajú o 90° a opäť režú. Konfigurácia je individuálna podľa materiálových potrieb, formátu a priechodnosti.',
      ...
      },
      {
        ...
        body: {
          ...
          sk: 'Plná automatizácia uhlového rezacieho systému dramaticky zvyšuje priechodnosť, znižuje potrebu personálu na minimum, eliminuje chyby obsluhy a znižuje odpad materiálu vďaka automatickej optimalizácii rezov. Trvale vysoká kvalita rezu nezávislá od obsluhy a možnosť viaczmennej prevádzky sú ďalšie rozhodujúce výhody.',
      ...
      },
      {
        heading: {
          ...
          sk: 'Priemysel 4.0 a digitalizácia',
        ...
        body: {
          ...
          sk: 'Uhlové rezacie systémy Mayer sú pripravené na koncepty Priemyslu 4.0. Bezšvíková integrácia do ERP, digitálne spracovanie zákaziek a automatická optimalizácia rezov tvoria základ pre prepojenú, transparentnú a efektívnu výrobu. Výrobné dáta sa zachytávajú a vyhodnocujú v reálnom čase.',
    ...
    faq: [
      {
        question: {
          ...
          sk: 'Ako dlho trvá plánovanie a inštalácia uhlového rezacieho systému?',
        ...
        answer: {
          ...
          sk: 'Časový rámec projektu závisí od zložitosti inštalácie. Typicky plánovanie trvá 2 až 4 mesiace a inštalácia 2 až 6 týždňov. Asamer sprevádza celým procesom od analýzy potrieb po uvedenie do prevádzky.',
      ...
      },
      {
        question: {
          ...
          sk: 'Aké odvetvia používajú uhlové rezacie systémy Mayer?',
        ...
        answer: {
          ...
          sk: 'Uhlové rezacie systémy Mayer sa používajú v nábytkárskom priemysle, stavbe fasád, spracovaní hliníka a plastov, dopravnom priemysle a automobilovom priemysle.',
      ...
      },
      {
        question: {
          ...
          sk: 'Môže Asamer naplánovať uhlový rezací systém priamo na mieste?',
        ...
        answer: {
          ...
          sk: 'Áno, Asamer ponúka konzultácie a analýzu potrieb priamo na mieste. Zameriame váš výrobný priestor, analyzujeme materiálový tok a vypracujeme koncept uhlového rezacieho systému na mieru.',
