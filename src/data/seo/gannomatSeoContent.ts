...
export const GANNOMAT_CATEGORY_SEO: Record<GannomatCategory, CategorySeoContent> = {
  ...
  boring: {
    ...
    sections: [
      {
        heading: { de: 'Kolkovaci-Bohrmaschine vs. CNC-Maschine', en: 'Dowel drilling machine vs. CNC machine', cz: 'Kolíkovací vrtací stroj vs. CNC stroj', hu: 'Csapfúró gép vs. CNC gép' },
        body: {
