...
export const GANNOMAT_PRODUCT_SEO: Record<string, ProductSeoContent> = {
  ...
  'selekta': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Serien-Korpusfertigung', en: 'For series carcass production', cz: 'Pro sériovou výrobu korpusu', sk: 'Pre sériovú výrobu korpusu', hu: 'Sorozatgyártású korpuszgyártáshoz' },
        body: {
          ...
          sk: 'V sériovej výrobe kuchýň alebo kancelárskeho nábytku dodáva Selekta reprodukovateľnú kvalitu pri vysokej priechodnosti. CNC riadenie umožňuje rýchlu zmenu programu medzi rôznymi typmi korpusu, takže aj variantne bohatá výroba beží bez dlhých prestavovacích časov.',
      ...
      {
        heading: { de: 'Für Zulieferbetriebe mit Losgröße-1', en: 'For supplier operations with batch-size-1', cz: 'Pro dodavatelské provozy s dávkou 1', sk: 'Pre dodávateľské prevádzky s dávkou 1', hu: '1-es tételszámú beszállító üzemekhez' },
        body: {
          ...
          sk: 'Priamym napojením na ERP systémy môže Selekta aj pri výrobe dávky 1 ísť individuálny vŕtací a kolíkovací vzor pre každý obrobok. Ideálne pre dodávateľské prevádzky vyrábajúce pre rôznych výrobcov nábytku.',
    ...
    buyingAdvice: {
      ...
      sk: 'Selekta je správnou voľbou pre stredných až veľkých výrobcov korpusu s požiadavkami na automatizáciu a variabilnú výrobu. Pre menšie prevádzky s prehľadným počtom variantov je ekonomickejšia Elite, pre najvyššie priemyselné nároky Spectrum.',
    ...
    faq: [
      {
        question: { de: 'Welche Dübeldurchmesser verarbeitet die Selekta?', en: 'What dowel diameters does the Selekta process?', cz: 'Jaké průměry kolíků Selekta zpracovává?', sk: 'Aké priemery kolíkov Selekta spracúva?', hu: 'Milyen csapátmérőket dolgoz fel a Selekta?' },
        answer: {
          ...
          sk: 'Štandardné kolíky s priemerom 6 až 10 mm. Špeciálne rozmery na požiadanie.',
          hu: 'Szabványos csapok 6-tól 10 mm átmérőig. Egyedi méretek kérésre.',
        },
      },
      {
        question: { de: 'Wie schnell ist der Formatwechsel?', en: 'How fast is format changeover?', cz: 'Jak rychlá je změna formátu?', sk: 'Aká rýchla je zmena formátu?', hu: 'Milyen gyors a formátumváltás?' },
        answer: {
          ...
          sk: 'Cez výber CNC programu počas niekoľkých minút. Mechanické prestavenie nutné len pri veľmi odlišných obrobkoch.',
          hu: 'CNC-programválasztással néhány perc alatt. Mechanikus átállás csak nagyon eltérő munkadaraboknál szükséges.',
        },
      },
      {
        question: { de: 'Gibt es ERP-Anbindung?', en: 'Is there ERP connection?', cz: 'Existuje napojení na ERP?', sk: 'Existuje napojenie na ERP?', hu: 'Van ERP-kapcsolat?' },
        answer: {
          ...
          sk: 'Áno — cez OPC-UA alebo individuálne rozhranie. Softvérový tím Asamer programuje integráciu so SAP, Navision alebo odborovými riešeniami.',
  ...
  'elite': {
    longDescription: {
      ...
      sk: 'Gannomat Elite je kompaktný poloautomatický vŕtací, lepiaci a kolíkovací stroj pre stredné stolárske dielne a výrobcov korpusu. Ponúka tri centrálne procesné kroky — vŕtanie, lepenie, zarážanie kolíkov — v jedinom stroji a je výrazne ekonomickejší než plne automatická Selekta pri porovnateľnej kvalite. Elite je obzvlášť vhodná pre prevádzky so stredným denným prietokom niekoľko sto obrobkov, ktoré chcú vystúpiť z ručnej výroby korpusu. Prestavba a obsluha sú dostatočne jednoduché na použitie s bežne kvalifikovaným personálom. Asamer dodáva Elite ako autorizovaný predajca Gannomat pre CZ, SK a HU vrátane školenia a servisu náhradných dielov.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für mittlere Tischlereien', en: 'For mid-sized joinery shops', cz: 'Pro střední truhlárny', sk: 'Pre stredné stolárske dielne', hu: 'Közepes asztalosüzemek számára' },
        body: {
          ...
          sk: 'Elite prináša stolárskym dielňam s 5–20 pracovníkmi priemyselný kvalitatívny štandard pri prehľadnej investícii. Priechodnosť a používateľský komfort sú výrazne nad ručnou výrobou korpusu bez toho, aby ste museli investovať do plne automatizovanej linky.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte Elite pri stredných počtoch kusov a obmedzenej variabilite. Pre vysokú variabilitu a výrobu dávky 1 je lepšia Selekta s CNC flexibilitou; pre vysoko priemyselné nároky Spectrum.',
    ...
    faq: [
      {
        question: { de: 'Wie groß ist der Schulungsaufwand?', en: 'How much training is needed?', cz: 'Jaká je potřeba školení?', sk: 'Aká je potreba školenia?', hu: 'Mekkora a képzési igény?' },
        answer: {
          ...
          sk: '2–3 dni na solídnu základnú obsluhu. Asamer školí na mieste po sprevádzkovaní.',
          hu: '2–3 nap a szilárd alapkezeléshez. Az Asamer az üzembe helyezés után helyszíni képzést tart.',
        },
      },
      {
        question: { de: 'Kann ich die Elite später auf die Selekta aufrüsten?', en: 'Can I upgrade the Elite to a Selekta later?', cz: 'Mohu Elite později upgradovat na Selekta?', sk: 'Môžem Elite neskôr upgradovať na Selekta?', hu: 'Fejleszthető az Elite később Selektára?' },
        answer: {
          ...
          sk: 'Výmena je možná, upgrade technicky obmedzený. Pri istej expanzii odporúčame rovno zvoliť Selekta.',
      ...
      {
        question: { de: 'Wie ist der Service?', en: 'How is the service?', cz: 'Jaký je servis?', sk: 'Aký je servis?', hu: 'Milyen a szerviz?' },
        answer: {
          ...
          sk: 'Asamer ponúka ročnú údržbu, vzdialenú podporu a garantované reakčné časy pre CZ, SK a HU.',
  ...
  'index-reihe-cnc': {
    longDescription: {
      ...
      sk: 'Gannomat Index Reihe CNC je vysoko flexibilný CNC riadený vŕtací stroj na vsádzanie kovania, ktorý automaticky vŕta a vsádza kolíky, kovanie a spojovacie prvky. Je špeciálne navrhnutý pre vysoko variabilné dávky a spracúva každý obrobok podľa individuálneho CNC programu. Voľnou programovateľnosťou osí pokrýva Index Reihe CNC aj zložité vŕtacie obrazce a zmiešané vsádzanie kovania — ideálne pre výrobu ready-to-assemble nábytku, kde každý korpus potrebuje iné kovanie. Asamer dodáva Index Reihe CNC vrátane programovacieho školenia a integruje ho podľa potreby do výrobných liniek s dopravníkmi alebo pufrovacími stanicami.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für Ready-to-Assemble-Fertigung', en: 'For ready-to-assemble production', cz: 'Pro výrobu ready-to-assemble', sk: 'Pre výrobu ready-to-assemble', hu: 'Laposcsomagolt bútor gyártásához' },
        body: {
          ...
          sk: 'Pri RTA nábytku dostáva každý korpus okrem kolíkov rad kovaní: excentrické kovania, skrutky, puzdrá. Index Reihe CNC vsádza všetky tieto prvky v jednom prechode — obrovský skok v efektivite oproti oddelenému spracovaniu.',
    ...
    buyingAdvice: {
      ...
      sk: 'Index Reihe CNC je správnou voľbou pre priemyselných výrobcov RTA nábytku alebo nábytkových stavebníc s vysokým počtom variantov a rozmanitosťou kovania. Pre štandardnú výrobu korpusu stačí Selekta.',
    ...
    faq: [
      {
        question: { de: 'Welche Beschläge werden unterstützt?', en: 'Which fittings are supported?', cz: 'Jaká kování jsou podporována?', sk: 'Aké kovania sú podporované?', hu: 'Milyen szerelvények támogatottak?' },
        answer: {
          ...
          sk: 'Všetky bežné kovania: excentre (Hettich, Blum, Grass), skrutky, puzdrá, kolíky, univerzálne spojovacie prvky.',
          hu: 'Minden szokásos szerelvény: excenterek (Hettich, Blum, Grass), csavarok, hüvelyek, csapok, univerzális összekötők.',
        },
      },
      {
        question: { de: 'Gibt es Programmiersoftware?', en: 'Is there programming software?', cz: 'Existuje programovací software?', sk: 'Existuje programovací softvér?', hu: 'Van programozószoftver?' },
        answer: {
          ...
          sk: 'Áno — Gannomat ponúka grafický programovací softvér s importom CAD. Asamer školí váš tím.',
          hu: 'Igen — a Gannomat grafikus programozószoftvert kínál CAD-importtal. Az Asamer betanítja a csapatát.',
        },
      },
      {
        question: { de: 'Ist die Maschine linienfähig?', en: 'Is the machine line-capable?', cz: 'Je stroj způsobilý pro linku?', sk: 'Je stroj spôsobilý pre linku?', hu: 'Gyártósorba integrálható a gép?' },
        answer: {
          ...
          sk: 'Áno — Index Reihe CNC možno kombinovať s dopravníkmi, puframi a návratovými systémami do priebežnej výrobnej linky.',
  ...
  'express-s5': {
    longDescription: {
      ...
      sk: 'Gannomat Express S5 je vrcholný model radu Express — poloautomatický stroj na vsádzanie kolíkov s piatimi vretenami, navrhnutý pre vysoké denné prietoky. Vsádzanie piatich kolíkov súčasne znamená kratšie časy taktu a nižšiu manipulačnú náročnosť na obrobok. Pre výrobcov korpusu so sériovou výrobou, ale bez požiadavky na dávku 1, je Express S5 ekonomickou alternatívou k CNC riadenej Spectrum alebo Selekta. Stroj pracuje s pneumatickým podávaním kolíkov a osvedčenými vŕtacími agregátmi Gannomat. Asamer dodáva a servisuje rad Express pre CZ, SK a HU vrátane školenia a servisu náhradných dielov.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle Serienproduktion', en: 'For industrial series production', cz: 'Pro průmyslovou sériovou výrobu', sk: 'Pre priemyselnú sériovú výrobu', hu: 'Ipari sorozatgyártáshoz' },
        body: {
          ...
          sk: 'S piatimi paralelne vsádzajúcimi vretenami dosahuje Express S5 priechodnosť blížiacu sa plne automatickým strojom — pri výrazne nižšej investícii. Ideálne pre výrobu korpusu s obmedzenou variabilitou.',
    ...
    buyingAdvice: {
      ...
      sk: 'Express S1–S5 sa líšia počtom vretien: S1 pre nízky prietok, S5 pre najvyšší. Zvoľte počet vretien podľa denného výstupu. Pre variantne bohatú výrobu je lepšou voľbou CNC model.',
    ...
    faq: [
      {
        question: { de: 'Welche Dübelabstände sind möglich?', en: 'What dowel spacings are possible?', cz: 'Jaké rozteče kolíků jsou možné?', sk: 'Aké rozstupy kolíkov sú možné?', hu: 'Milyen csaptávolságok lehetségesek?' },
        answer: {
          ...
          sk: 'Express S5 pracuje so štandardizovanými rozstupmi otvorov (zvyčajne 32 mm raster). Špeciálne rozstupy vyžadujú mechanické prestavenie.',
      ...
      {
        question: { de: 'Benötigt die Maschine einen Bediener?', en: 'Does the machine need an operator?', cz: 'Potřebuje stroj obsluhu?', sk: 'Potrebuje stroj obsluhu?', hu: 'Szükséges a gépnek kezelő?' },
        answer: {
          ...
          sk: 'Áno — Express je poloautomatický a potrebuje obsluhu na polohovanie obrobku. Obsluha môže paralelne zvládať aj iné úlohy.',
      ...
      {
        question: { de: 'Welche Dübelgrößen werden verarbeitet?', en: 'What dowel sizes are processed?', cz: 'Jaké velikosti kolíků se zpracovávají?', sk: 'Aké veľkosti kolíkov sa spracúvajú?', hu: 'Milyen csapméretek dolgozhatók fel?' },
        answer: {
          ...
          sk: '6 mm, 8 mm a 10 mm štandard — ďalšie veľkosti na požiadanie.',
  ...
  'concept-primus': {
    longDescription: {
      ...
      sk: 'Gannomat Concept Primus je korpusový lis na priemyselné lepenie a stabilizáciu korpusu počas schnutia kolíkov. Po vŕtaní a lepení musia byť korpusové diely fixované pod tlakom, aby lepidlo vytvrdlo a vznikla tvarovo stabilná jednotka. Concept Primus vykonáva tento krok plne automaticky: korpus sa zavedie, zovrie sa pod kontrolovaným tlakom a po definovanom čase sa uvoľní. Výsledok: geometricky presné korpusy bez ručnej dorobky. Asamer dodáva rad Concept výrobcom nábytku v CZ, SK a HU vrátane integrácie do existujúcich výrobných liniek.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für durchgängige Korpusfertigungslinie', en: 'For continuous carcass production line', cz: 'Pro průběžnou linku výroby korpusu', sk: 'Pre priebežnú linku výroby korpusu', hu: 'Folyamatos korpuszgyártó sorhoz' },
        body: {
          ...
          sk: 'Concept Primus tvorí spolu so Selekta (vsádzanie kolíkov), dopravou a balením priebežnú výrobnú linku. V tejto linke putuje korpus automaticky zo stanice na stanicu — pri časoch taktu orientovaných na priemyselné výstupné požiadavky.',
    ...
    buyingAdvice: {
      ...
      sk: 'Rad Concept má niekoľko variantov: Concept Easy ako vstup, Concept Eco pre stredný prietok, Concept Primus pre priemyselnú nepretržitú prevádzku, montážna linka korpusov ako kompletný systém. Vyberte podľa denného výstupu a variability.',
    ...
    faq: [
      {
        question: { de: 'Welche Korpusgrößen werden gepresst?', en: 'What carcass sizes are pressed?', cz: 'Jaké velikosti korpusu se lisují?', sk: 'Aké veľkosti korpusu sa lisujú?', hu: 'Milyen korpuszméreteket présel?' },
        answer: {
          ...
          sk: 'Štandardné korpusy od cca 300 × 300 × 300 mm do cca 1.200 × 800 × 600 mm. Špeciálne rozmery na požiadanie.',
          hu: 'Szabványos korpuszok kb. 300 × 300 × 300 mm-től 1200 × 800 × 600 mm-ig. Egyedi méretek kérésre.',
        },
      },
      {
        question: { de: 'Wie lange ist der Pressvorgang?', en: 'How long is the pressing cycle?', cz: 'Jak dlouhý je lisovací cyklus?', sk: 'Aký dlhý je lisovací cyklus?', hu: 'Mennyi ideig tart a présciklus?' },
        answer: {
          ...
          sk: 'Podľa lepidla 30–90 sekúnd. Presný čas je uložený v riadiacom systéme.',
          hu: 'Ragasztótól függően 30–90 másodperc. A pontos idő a vezérlésben van eltárolva.',
        },
      },
      {
        question: { de: 'Kann die Presse in eine Linie integriert werden?', en: 'Can the press be integrated into a line?', cz: 'Lze lis integrovat do linky?', sk: 'Dá sa lis integrovať do linky?', hu: 'Integrálható a prés gyártósorba?' },
        answer: {
          ...
          sk: 'Áno — vstupné a výstupné dopravníky aj napojenie na ERP sú štandardné voľby. Asamer plánuje linku individuálne.',
  ...
  'protec-profit': {
    longDescription: {
      ...
      sk: 'Gannomat ProTec Profit je CNC obrábacie centrum pre diely nábytku, ktoré vykonáva frézovanie, vŕtanie a kolíkovanie v jedinom upnutí. Obrobok sa upne raz — všetky obrábacie kroky prebiehajú v jednom prechode. To šetrí nastavovacie časy, minimalizuje chyby polohovania medzi jednotlivými operáciami a zvyšuje celkovú kvalitu. ProTec Profit je určený výrobcom nábytku, ktorí chcú vyrábať zložité obrobky (s výrezmi, slepými otvormi pre kovanie, frézovanými profilmi) v jednom stroji. Asamer integruje ProTec Profit do výrobných liniek pre CZ, SK a HU — od programovacieho školenia po napojenie na ERP.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für komplexe Werkstücke mit Fräs- und Bohrbearbeitung', en: 'For complex workpieces with milling and drilling', cz: 'Pro složité obrobky s frézováním a vrtáním', sk: 'Pre zložité obrobky s frézovaním a vŕtaním', hu: 'Összetett munkadarabokhoz marással és fúrással' },
        body: {
          ...
          sk: 'Pri obrobkoch kombinujúcich výrezy, vŕtací vzor a vsádzanie kovania sa pri ProTec Profit vyhnete viacnásobnému presádzaniu. Výsledkom je vyššia rozmerová presnosť a nižšie riziko chýb — pri zároveň kratšej priebežnej dobe.',
    ...
    buyingAdvice: {
      ...
      sk: 'ProTec Profit je ekonomický od stredných počtov kusov so zložitým spracovaním. Pre čisté vŕtanie a kolíkovanie je ekonomickejšia Selekta; čisté frézovanie lacnejšie zvládajú nesting CNC.',
    ...
    faq: [
      {
        question: { de: 'Welche Fräswerkzeuge werden unterstützt?', en: 'What milling tools are supported?', cz: 'Jaké frézovací nástroje jsou podporovány?', sk: 'Aké frézovacie nástroje sú podporované?', hu: 'Milyen maró szerszámok támogatottak?' },
        answer: {
          ...
          sk: 'Nástrojové upínanie HSK pre všetky bežné frézy. Automatická výmena nástrojov je voliteľná.',
          hu: 'HSK szerszámbefogók minden szokásos maróhoz. Az automatikus szerszámcsere opcionális.',
        },
      },
      {
        question: { de: 'CAD-Import möglich?', en: 'CAD import possible?', cz: 'Lze importovat CAD?', sk: 'Dá sa importovať CAD?', hu: 'Lehetséges CAD-import?' },
        answer: {
          ...
          sk: 'Áno — štandardný import DXF/DWG/STEP. Postprocesor sa prispôsobí vášmu konštrukčnému softvéru.',
          hu: 'Igen — szabványos DXF/DWG/STEP import. A posztprocesszor a tervezőszoftveréhez igazodik.',
        },
      },
      {
        question: { de: 'Ist die Maschine staubfreundlich?', en: 'Is the machine dust-friendly?', cz: 'Je stroj prachově přívětivý?', sk: 'Je stroj prachovo prívetivý?', hu: 'Porbarát a gép?' },
        answer: {
          ...
          sk: 'Odsávanie je štandard — kompatibilné so všetkými bežnými odsávacími zariadeniami.',
  ...
  'db-21-27-35': {
    longDescription: {
      ...
      cz: `Gannomat DB 21-27-35 je klasický kolíkovací vrtací stroj pro boky korpusu, záda a další díly nábytku se standardizovanými vzory otvorů. Označení 21-27-35 odkazuje na počet vřeten ve třech variantách modelu. Čím více vřeten, tím více otvorů se vrtá v jednom zdvihu — a tím rychlejší je doba taktu. Řada DB je mnoha truhlárnami a nábytkářskými provozy používána desetiletí díky své vysoké spolehlivosti, dobré servisovatelnosti a jednoduché obsluze. Asamer dodává řadu DB pro CZ, SK a HU včetně seřízení na vaše rozteče otvorů a školení obsluhy.`,
      sk: 'Gannomat DB 21-27-35 je klasický kolíkovací vŕtací stroj pre boky korpusu, chrbty a ďalšie diely nábytku so štandardizovanými vzormi otvorov. Označenie 21-27-35 odkazuje na počet vretien v troch variantoch modelu. Čím viac vretien, tým viac otvorov sa vŕta v jednom zdvihu — a tým rýchlejší je čas taktu. Rad DB používajú mnohé stolárstva a nábytkárske prevádzky desaťročia vďaka jeho vysokej spoľahlivosti, dobrej servisovateľnosti a jednoduchej obsluhe. Asamer dodáva rad DB pre CZ, SK a HU vrátane nastavenia na vaše rozstupy otvorov a školenia obsluhy.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für Standard-Korpusfertigung', en: 'For standard carcass production', cz: 'Pro standardní výrobu korpusu', sk: 'Pre štandardnú výrobu korpusu', hu: 'Szabványos korpuszgyártáshoz' },
        body: {
          ...
          sk: 'V štandardnej výrobe kuchýň alebo kancelárskeho nábytku je 32 mm raster otvorov priemyselným štandardom. Rad DB je optimalizovaný na tento raster a dodáva potrebné otvory v krátkom čase taktu. Pri väčších počtoch kusov má zmysel krok k variantu WA (s podávaním obrobku).',
    ...
    buyingAdvice: {
      ...
      sk: 'DB 21-27-35 je správnou voľbou pre strednú výrobu so štandardnými vzormi otvorov. Pre vyšší prietok sa oplatí variant WA s automatickým podávaním obrobku; pri vysokom počte variantov CNC model.',
    ...
    faq: [
      {
        question: { de: 'Welche Lochabstände sind möglich?', en: 'What hole spacings are possible?', cz: 'Jaké rozteče otvorů jsou možné?', sk: 'Aké rozstupy otvorov sú možné?', hu: 'Milyen lyuktávolságok lehetségesek?' },
        answer: {
          ...
          sk: '32 mm raster štandard, špeciálne rozstupy po prestavení.',
          hu: '32 mm-es raszter szabvány, különleges távolságok átállás után.',
        },
      },
      {
        question: { de: 'Bohrtiefen verstellbar?', en: 'Drilling depths adjustable?', cz: 'Lze nastavit hloubku vrtání?', sk: 'Dá sa nastaviť hĺbka vŕtania?', hu: 'Állítható a fúrásmélység?' },
        answer: {
          ...
          sk: 'Áno — mechanické hĺbkové dorazy na vreteno. Zvyčajne 10–40 mm.',
          hu: 'Igen — mechanikus mélységütközők orsónként. Jellemzően 10–40 mm.',
        },
      },
      {
        question: { de: 'Einzelspindel-Zuschaltung möglich?', en: 'Individual spindle switching possible?', cz: 'Lze zapínat jednotlivá vřetena?', sk: 'Dajú sa zapínať jednotlivé vretená?', hu: 'Lehetséges egyedi orsókapcsolás?' },
        answer: {
          ...
          sk: 'Áno — nepotrebné vretená sa dajú jednotlivo deaktivovať.',
  ...
  'vantage': {
    longDescription: {
      ...
      sk: 'Gannomat Vantage 76-152 je radový vŕtací stroj so 76 až 152 vretenami pre vysokovýkonné sériové vŕtanie v priemyselnej výrobe nábytku. S takýmto počtom vretien sa celé vŕtacie vzory — napríklad celá bočnica skrine — vŕtajú v jedinom zdvihu. Je to najrýchlejší spôsob spracovania štandardných korpusových dielov s 32 mm rastrom otvorov. Vantage je vhodný pre výrobcov s vysokým dopytom po objeme a nízkou variabilitou; výroba dávky 1 nie je jeho odborom. Asamer dodáva Vantage ako autorizovaný predajca Gannomat pre CZ, SK a HU vrátane nastavenia a servisnej zmluvy.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle Großserienfertigung', en: 'For industrial large-series production', cz: 'Pro průmyslovou velkosériovou výrobu', sk: 'Pre priemyselnú veľkosériovú výrobu', hu: 'Ipari nagysorozatú gyártáshoz' },
        body: {
          ...
          sk: 'Vo veľkosériovej výrobe štandardného nábytku (skrine, police, kuchynské skrinky) je čas taktu rozhodujúcim faktorom. Vantage redukuje vŕtaciu operáciu na samotný zdvih bez prestavovacích časov — za sekundy namiesto minút na obrobok.',
    ...
    buyingAdvice: {
      ...
      sk: 'Vantage sa oplatí až od veľmi vysokých denných počtov (500+ korpusov). Pre menšie množstvá alebo variantne bohatšiu výrobu sú ekonomickejšie DB alebo CNC modely.',
    ...
    faq: [
      {
        question: { de: 'Wie lange dauert die Umrüstung?', en: 'How long does changeover take?', cz: 'Jak dlouho trvá přestavení?', sk: 'Ako dlho trvá prestavenie?', hu: 'Mennyi ideig tart az átállás?' },
        answer: {
          ...
          sk: 'Mechanické prestavenie na iné vzory otvorov 1–4 hodiny. Preto je Vantage ekonomický len pri stabilných výrobných programoch.',
          hu: 'Mechanikus átállás más lyukmintákra 1–4 óra. Ezért a Vantage csak stabil gyártási programoknál gazdaságos.',
        },
      },
      {
        question: { de: 'Wie viele Spindeln sind sinnvoll?', en: 'How many spindles make sense?', cz: 'Kolik vřeten má smysl?', sk: 'Koľko vretien má zmysel?', hu: 'Hány orsónak van értelme?' },
        answer: {
          ...
          sk: '76 pre stredné obrobky, 152 pre maximálnu flexibilitu pri rôznych dĺžkach.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'Voliteľne — kombinácia s dopravníkom a návratovým systémom pre plne automatickú prevádzku je možná.',
  ...
  'expert': {
    longDescription: {
      ...
      sk: 'Gannomat Expert je vŕtací stroj na závesy pre profesionálne spracovanie nábytkových frontov a dverí. Vytvára presné otvory pre miskové závesy všetkých bežných výrobcov (Blum, Hettich, Grass) vrátane otvorov pre skrutky v jednom pracovnom prechode. Pre výrobcov kuchýň, výrobu dverí a nábytkárske stolárstva je Expert osvedčeným štandardným nástrojom — rýchlejším a presnejším než ručné označovanie a jednotlivé vŕtanie. Nastavenie na rôzne typy závesov sa vykoná za niekoľko minút. Asamer dodáva Expert pre CZ, SK a HU vrátane poradenstva pri výbere závesov a nastavenia na vaše štandardné typy.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für Küchenfertigung', en: 'For kitchen production', cz: 'Pro výrobu kuchyní', sk: 'Pre výrobu kuchýň', hu: 'Konyhagyártáshoz' },
        body: {
          ...
          sk: 'Vo výrobe kuchýň sa vyskytuje mnoho dverí s miskovými závesmi. Expert vŕta všetky tri otvory (misku plus dve skrutky) súčasne v presnej pozícii — následná montáž závesu je otázkou sekúnd.',
    ...
    buyingAdvice: {
      ...
      sk: 'Expert je správnou voľbou pre prevádzky s pravidelnou výrobou dverí alebo frontov. Pre veľmi variabilnú alebo zákazkovú výrobu je ekonomickejší Twin (s dvoma pracovnými stanicami).',
    ...
    faq: [
      {
        ...
        answer: {
          ...
          sk: 'Všetky bežné: Blum Clip top, Hettich Sensys, Grass Nexis, Salice atď.',
          hu: 'Minden szokásos: Blum Clip top, Hettich Sensys, Grass Nexis, Salice stb.',
        },
      },
      {
        question: { de: 'Topfgrößen?', en: 'Cup sizes?', cz: 'Velikosti misek?', sk: 'Veľkosti misiek?', hu: 'Tányérméretek?' },
        answer: {
          de: '26 mm und 35 mm Standard.',
          en: '26 mm and 35 mm standard.',
          cz: '26 mm a 35 mm standard.',
          sk: '26 mm a 35 mm štandard.',
          hu: '26 mm és 35 mm szabvány.',
        },
      },
      {
        question: { de: 'Ist die Maschine CNC-gesteuert?', en: 'Is the machine CNC-controlled?', cz: 'Je stroj řízen CNC?', sk: 'Je stroj riadený CNC?', hu: 'CNC-vezérelt a gép?' },
        answer: {
          ...
          sk: 'Expert sa ovláda ručne; pre CNC riadenie existujú špeciálne modely.',
  ...
  'leimfix': {
    longDescription: {
      ...
      sk: 'Gannomat Leimfix je automatický lepiaci systém pre kolíky a spojovacie prvky, ktorý automatizuje presné nanášanie lepidla pred montážou kolíka. Stroj pracuje s dávkovaným prívodom lepidla na kolík alebo priamo do vŕtania a zaisťuje konzistentné množstvo lepidla nezávisle od obsluhy. To zaručuje spoľahlivé spoje a zabraňuje nedostatku aj prebytku lepidla so zvyškami na výstupe. Asamer dodáva Leimfix vrátane integrácie do existujúcich vŕtacích zariadení a školenia optimálneho dávkovacieho nastavenia — pre stolárstva a nábytkárske prevádzky v CZ, SK a HU.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für konsistente Leimfugen', en: 'For consistent glue joints', cz: 'Pro konzistentní lepené spoje', sk: 'Pre konzistentné lepené spoje', hu: 'Egyenletes ragasztott kötésekhez' },
        body: {
          ...
          sk: 'Ručné dávkovanie lepidla vedie k výkyvom medzi rôznymi obsluhami. Leimfix tento faktor eliminuje — každý spoj dostáva presne rovnaké množstvo lepidla nezávisle od denného stavu alebo skúseností pracovníka.',
    ...
    buyingAdvice: {
      ...
      sk: 'Leimfix sa oplatí od stredných denných množstiev kolíkov. Pri veľmi malej výrobe je ručné dávkovanie ešte prijateľné; od niekoľkých tisíc kolíkov denne má automatizácia ekonomický zmysel.',
    ...
    faq: [
      {
        question: { de: 'Welche Klebstoffe werden verarbeitet?', en: 'What adhesives are processed?', cz: 'Jaká lepidla se zpracovávají?', sk: 'Aké lepidlá sa spracúvajú?', hu: 'Milyen ragasztók dolgozhatók fel?' },
        answer: {
          ...
          sk: 'Štandardné D3 biele lepidlo a PUR lepidlá. Ostatné na vyžiadanie.',
          hu: 'Szabványos D3 fehér ragasztó és PUR ragasztók. Egyéb kérésre.',
        },
      },
      {
        question: { de: 'Dosiermenge einstellbar?', en: 'Is metering adjustable?', cz: 'Lze nastavit dávkování?', sk: 'Dá sa nastaviť dávkovanie?', hu: 'Állítható az adagolási mennyiség?' },
        answer: {
          ...
          sk: 'Áno — elektronicky cez riadenie, aj podľa priemeru kolíka.',
          hu: 'Igen — elektronikusan a vezérlésen keresztül, csapátmérő szerint is.',
        },
      },
      {
        question: { de: 'Reinigungsaufwand?', en: 'Cleaning effort?', cz: 'Nároky na čištění?', sk: 'Nároky na čistenie?', hu: 'Tisztítási igény?' },
        answer: {
          ...
          sk: 'Denne krátke čistenie trysky — pár minút. Týždenne dôkladné prepláchnutie.',
  ...
  'master-325': {
    longDescription: {
      ...
      sk: 'Gannomat Master 325 je rámový vŕtací stroj pre nábytkové rámy, okenné a dverové rámy s presným vŕtaním na všetkých stranách rámu. Pracuje s viacerými vŕtacími hlavami v rôznych pozíciách, takže kompletné rámové vŕtacie vzory sa vytvárajú v jednom prechode. Typické aplikácie: otvory pre rámové spojovacie prvky, otvory pre kolíky pri rohových spojoch alebo vsadenie kovania pri dverových rámoch. Master 325 je dostatočne presný pre nosné rámové konštrukcie a v európskych nábytkárskych a dverových závodoch sa používa desaťročia. Asamer ho dodáva pre CZ, SK a HU vrátane nastavenia na vaše typy rámov.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für Türrahmen- und Fensterrahmenfertigung', en: 'For door and window frame production', cz: 'Pro výrobu dveřních a okenních rámů', sk: 'Pre výrobu dverových a okenných rámov', hu: 'Ajtó- és ablakkeret gyártáshoz' },
        body: {
          ...
          sk: 'Dverové a okenné rámy vyžadujú presné otvory pre závesy, zámky a spoje. Master 325 vŕta všetky tieto otvory v presnej pozícii vzhľadom na profil rámu — bez nutnosti vopred označovať alebo nastavovať.',
    ...
    buyingAdvice: {
      ...
      sk: 'Rad Master pokrýva väčšinu aplikácií rámového vŕtania. Pre jednoduchšie požiadavky je lacnejší Junior 323; pre zložité vŕtacie vzory v špeciálnych rámoch sa odporúča Mod 160.',
    ...
    faq: [
      {
        question: { de: 'Welche Rahmengrößen sind möglich?', en: 'What frame sizes are possible?', cz: 'Jaké velikosti rámů jsou možné?', sk: 'Aké veľkosti rámov sú možné?', hu: 'Milyen keretméretek lehetségesek?' },
        answer: {
          ...
          sk: 'Zvyčajne od cca 300 × 300 mm do 2.500 × 1.200 mm. Nadmerné formáty po dohode.',
          hu: 'Jellemzően kb. 300 × 300 mm-től 2500 × 1200 mm-ig. Túlméretes formátumok egyeztetés szerint.',
        },
      },
      {
        question: { de: 'Massive oder beschichtete Rahmen?', en: 'Solid or coated frames?', cz: 'Masivní nebo povrstvené rámy?', sk: 'Masívne alebo povrstvené rámy?', hu: 'Tömör vagy bevonatos keretek?' },
        answer: {
          ...
          sk: 'Oboje — masívne drevo, MDF, povrstvená drevotrieska. Nástroje sú štandardne navrhnuté pre všetky materiály.',
          hu: 'Mindkettő — tömör fa, MDF, bevonatos forgácslap. A szerszámok szabványosan minden anyaghoz készültek.',
        },
      },
      {
        question: { de: 'Bohrstellen frei programmierbar?', en: 'Drilling positions freely programmable?', cz: 'Jsou pozice vrtání volně programovatelné?', sk: 'Sú pozície vŕtania voľne programovateľné?', hu: 'Szabadon programozhatók a fúráshelyek?' },
        answer: {
          ...
          sk: 'Mechanicky cez dorazy, špeciálne nastavenia za príplatok. CNC riadenie pri špeciálnych modeloch.',
  ...
  'basica': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für kleine Tischlereien und Einzelanfertigung', en: 'For small joinery shops and custom work', cz: 'Pro malé truhlárny a zakázkovou výrobu', sk: 'Pre malé stolárstva a zákazkovú výrobu', hu: 'Kis asztalosüzemekhez és egyedi gyártáshoz' },
        body: {
          ...
          sk: 'Pri výrobe jednotlivých kusov a malých sérií — napríklad pri vstavanom nábytku alebo špeciálnych korpusoch — sa veľké CNC zariadenie neoplatí. Basica tu tvorí most medzi ručným kladivom a priemyselným strojom: spoľahlivé, reprodukovateľné vsádzanie kolíkov pri minimálnej investícii.',
      ...
      {
        heading: { de: 'Für den Einstieg in mechanisierte Korpusfertigung', en: 'For entry into mechanised carcass production', cz: 'Pro vstup do mechanizované výroby korpusu', sk: 'Pre vstup do mechanizovanej výroby korpusu', hu: 'Belépés a gépesített korpuszgyártásba' },
        body: {
          ...
          sk: 'Kto dnes kolíkuje ručne a chce urobiť ďalší krok smerom k automatizácii, nájde v Basice mierny vstup. Žiadny nový personál obsluhy, žiadne náročné programovanie — stroj zapadá do existujúcich dielenských procesov.',
    ...
    faq: [
      {
        question: { de: 'Wie viel Stellfläche braucht die Basica?', en: 'How much floor space does the Basica need?', cz: 'Kolik místa Basica potřebuje?', sk: 'Koľko miesta Basica potrebuje?', hu: 'Mennyi helyet igényel a Basica?' },
        answer: {
      ...
      {
        question: { de: 'Benötige ich Druckluft?', en: 'Do I need compressed air?', cz: 'Potřebuji stlačený vzduch?', sk: 'Potrebujem stlačený vzduch?', hu: 'Szükséges sűrített levegő?' },
        answer: {
      ...
      {
        question: { de: 'Wie lange dauert die Einschulung?', en: 'How long is operator training?', cz: 'Jak dlouho trvá školení obsluhy?', sk: 'Ako dlho trvá školenie obsluhy?', hu: 'Meddig tart a kezelő képzése?' },
        answer: {
  ...
  'variabel': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für variantenreiche Kleinserienfertigung', en: 'For variant-rich small-series production', cz: 'Pro variantně bohatou malosériovou výrobu', sk: 'Pre variantne bohatú malosériovú výrobu', hu: 'Változatos kissorozatú gyártáshoz' },
        body: {
          ...
          sk: 'Kto dnes vyrába obývačkové korpusy, zajtra kuchynské spodné skrinky a pozajtra kancelárske regály, potrebuje stroj, ktorý s touto zmenou ide. Variabel umožňuje prepínať medzi rôznymi typmi obrobkov bez dlhých prestavovacích časov.',
      ...
      {
        heading: { de: 'Als Brücke zwischen Einstieg und Serienmaschine', en: 'As bridge between entry and series machine', cz: 'Jako most mezi vstupní a sériovou mašinou', sk: 'Ako most medzi vstupným a sériovým strojom', hu: 'Híd a belépő és a sorozatgép között' },
        body: {
          ...
          sk: 'Pre prevádzky, ktorým je Basica príliš jednoduchá a Express S3 príliš špecializovaný, zapĺňa Variabel presne túto medzeru. Spája mechanickú robustnosť s konfiguračnou variabilitou, ktorú širšia produktová paleta vyžaduje.',
    ...
    faq: [
      {
        question: { de: 'Wie viele Konfigurationen sind möglich?', en: 'How many configurations are possible?', cz: 'Kolik konfigurací je možných?', sk: 'Koľko konfigurácií je možných?', hu: 'Hány konfiguráció lehetséges?' },
        answer: {
      ...
      {
        question: { de: 'Wie lange dauert eine Umrüstung?', en: 'How long does a changeover take?', cz: 'Jak dlouho trvá přestavba?', sk: 'Ako dlho trvá prestavba?', hu: 'Mennyi ideig tart egy átállítás?' },
        answer: {
      ...
      {
        question: { de: 'Ist die Variabel pneumatisch oder hydraulisch?', en: 'Is the Variabel pneumatic or hydraulic?', cz: 'Je Variabel pneumatický nebo hydraulický?', sk: 'Je Variabel pneumatický alebo hydraulický?', hu: 'A Variabel pneumatikus vagy hidraulikus?' },
        answer: {
  ...
  'red-baron-p': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für den robusten Werkstattalltag', en: 'For robust everyday workshop use', cz: 'Pro robustní dílenský provoz', sk: 'Pre robustnú dielenskú prevádzku', hu: 'Robusztus műhelyi mindennapokhoz' },
        body: {
          ...
          sk: 'V dielňach s dvoma až tromi zmenami, striedajúcim sa personálom a intenzívnou nepretržitou prevádzkou je Red Baron P ťažným koňom. Pneumatické komponenty odpúšťajú prach, teplotné výkyvy a občasné chyby obsluhy — ideálne tam, kde je dôležitejšia dostupnosť než špičkový prietok.',
      ...
      {
        heading: { de: 'Als Ersatz für ältere Dübelmaschinen', en: 'As replacement for older dowel machines', cz: 'Jako náhrada za starší kolíkovací stroje', sk: 'Ako náhrada za staršie kolíkovacie stroje', hu: 'Régebbi csapgépek cseréjeként' },
        body: {
          ...
          sk: 'Mnohé stolárstva nahrádzajú Red Baronom P existujúci, rokmi opotrebovaný kolíkovací stroj. Rozvrhnutie, prípojky a filozofia obsluhy zostávajú známe — skok v produktivite vzniká vďaka rýchlejším časom taktu a vyššej spoľahlivosti.',
    ...
    faq: [
      {
        question: { de: 'Warum pneumatisch statt hydraulisch?', en: 'Why pneumatic instead of hydraulic?', cz: 'Proč pneumaticky místo hydraulicky?', sk: 'Prečo pneumaticky namiesto hydraulicky?', hu: 'Miért pneumatikus és nem hidraulikus?' },
        answer: {
      ...
      {
        question: { de: 'Welcher Tagesdurchsatz ist realistisch?', en: 'What daily throughput is realistic?', cz: 'Jaký denní průtok je reálný?', sk: 'Aký denný prietok je reálny?', hu: 'Milyen napi áteresztőképesség reális?' },
        answer: {
      ...
      {
        question: { de: 'Wie hoch ist der Luftverbrauch?', en: 'What is the air consumption?', cz: 'Jaká je spotřeba vzduchu?', sk: 'Aká je spotreba vzduchu?', hu: 'Mekkora a levegőfogyasztás?' },
        answer: {
  ...
  'express-s1': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für den Einstieg in die Express-Welt', en: 'For entry into the Express world', cz: 'Pro vstup do světa Express', sk: 'Pre vstup do sveta Express', hu: 'Belépés az Express világba' },
        body: {
          ...
          sk: 'Kto sa chce zoznámiť s technikou Express bez toho, aby hneď investoval do viacvretenového modelu, nájde v S1 prirodzený vstup. Obsluha a údržba sú identické s väčšími sestrami — neskoršie preškolenie na S2/S3 do veľkej miery odpadá.',
      ...
      {
        heading: { de: 'Für kleine bis mittlere Tischlereien', en: 'For small to medium joinery shops', cz: 'Pro malé až střední truhlárny', sk: 'Pre malé až stredné stolárstva', hu: 'Kis és közepes asztalosüzemekhez' },
        body: {
          ...
          sk: 'Pri denných prietokoch do približne 50 korpusov nie je investícia do viacerých vretien ekonomicky ospravedlniteľná. S1 vsádza kolíky v reprodukovateľnej kvalite bez toho, aby sa viazal kapitál v predimenzovanej technike.',
    ...
    faq: [
      {
        question: { de: 'Wann lohnt der Umstieg auf S2?', en: 'When is stepping up to S2 worthwhile?', cz: 'Kdy se vyplatí přechod na S2?', sk: 'Kedy sa oplatí prechod na S2?', hu: 'Mikor éri meg az S2-re váltás?' },
        answer: {
      ...
      {
        question: { de: 'Lassen sich verschiedene Dübeldurchmesser setzen?', en: 'Can different dowel diameters be set?', cz: 'Lze vsazovat různé průměry kolíků?', sk: 'Dajú sa vsádzať rôzne priemery kolíkov?', hu: 'Beültethetők különböző csapátmérők?' },
        answer: {
      ...
      {
        question: { de: 'Wie präzise ist die Setzung?', en: 'How precise is the insertion?', cz: 'Jak přesné je vsazení?', sk: 'Aké presné je vsadenie?', hu: 'Mennyire pontos a beültetés?' },
        answer: {
  ...
  'express-s2': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für regelmäßige Korpusfertigung', en: 'For regular carcass production', cz: 'Pro pravidelnou výrobu korpusu', sk: 'Pre pravidelnú výrobu korpusu', hu: 'Rendszeres korpuszgyártáshoz' },
        body: {
          ...
          sk: 'Kto týždeň čo týždeň vyrába niekoľko desiatok korpusov, získava so S2 oproti S1 výrazne čas — dva kolíky v jednom zdvihu znamenajú menej obslužných úkonov na obrobok a vyššiu účinnosť pracoviska.',
      ...
      {
        heading: { de: 'Für Küchen- und Büromöbelhersteller', en: 'For kitchen and office furniture manufacturers', cz: 'Pro výrobce kuchyní a kancelářského nábytku', sk: 'Pre výrobcov kuchýň a kancelárskeho nábytku', hu: 'Konyha- és irodabútor-gyártóknak' },
        body: {
          ...
          sk: 'Výrobcovia kuchýň a kancelárskeho nábytku so štandardizovanými rozmermi korpusu profitujú dvakrát: vsádzanie dvoch kolíkov presne zodpovedá mnohým schémam korpusového spojenia — S2 je tak pre tento účel takmer šitá na mieru.',
    ...
    faq: [
      {
        question: { de: 'Wie groß ist die Taktzeit-Ersparnis gegenüber S1?', en: 'How large is the cycle time saving versus S1?', cz: 'Jak velká je úspora doby taktu oproti S1?', sk: 'Aká veľká je úspora času taktu oproti S1?', hu: 'Mekkora a ciklusidő-megtakarítás az S1-hez képest?' },
        answer: {
      ...
      {
        question: { de: 'Sind beide Spindeln unabhängig einstellbar?', en: 'Are both spindles independently adjustable?', cz: 'Jsou obě vřetena nastavitelná nezávisle?', sk: 'Sú obe vretená nastaviteľné nezávisle?', hu: 'Mindkét orsó függetlenül állítható?' },
        answer: {
      ...
      {
        question: { de: 'Eignet sich die S2 für RTA-Möbel?', en: 'Is the S2 suitable for RTA furniture?', cz: 'Hodí se S2 pro RTA nábytek?', sk: 'Hodí sa S2 pre RTA nábytok?', hu: 'Alkalmas az S2 RTA-bútorokhoz?' },
        answer: {
  ...
  'express-s3': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für mittlere Serienproduktion', en: 'For medium series production', cz: 'Pro střední sériovou výrobu', sk: 'Pre strednú sériovú výrobu', hu: 'Közepes sorozatgyártáshoz' },
        body: {
          ...
          sk: 'Pri sériách niekoľkých stoviek korpusov za deň sa tretie vreteno výrazne oplatí. S3 ponúka citeľne vyšší prietok než S2 bez toho, aby prechádzal do investičnej a priestorovej dimenzie priemyselnej S4/S5.',
      ...
      {
        heading: { de: 'Für Drei-Punkt-Dübelverbindungen', en: 'For three-point dowel joints', cz: 'Pro trojbodové kolíkové spoje', sk: 'Pre trojbodové kolíkové spoje', hu: 'Három csatlakozású csapkötésekhez' },
        body: {
          ...
          sk: 'Mnohé korpusové spoje štandardne používajú tri kolíky na stranu. So S3 tak jedna pracovná operácia znamená kompletný spojovací bod — počet manipulácií s obrobkom klesá a geometria zostáva konštantná.',
    ...
    faq: [
      {
        question: { de: 'Welche Stückzahlen sind realistisch?', en: 'What quantities are realistic?', cz: 'Jaké počty kusů jsou reálné?', sk: 'Aké počty kusov sú reálne?', hu: 'Milyen darabszámok reálisak?' },
        answer: {
      ...
      {
        question: { de: 'Lässt sich der Abstand der Spindeln ändern?', en: 'Can the spindle spacing be changed?', cz: 'Lze změnit rozteč vřeten?', sk: 'Dá sa zmeniť rozstup vretien?', hu: 'Változtatható az orsók távolsága?' },
        answer: {
      ...
      {
        question: { de: 'Ist ein Upgrade von S2 möglich?', en: 'Is an upgrade from S2 possible?', cz: 'Je možný upgrade z S2?', sk: 'Je možný upgrade z S2?', hu: 'Lehetséges S2-ről frissítés?' },
        answer: {
  ...
  'express-s4': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Serienhersteller mit hohem Volumen', en: 'For series producers with high volume', cz: 'Pro sériové výrobce s vysokým objemem', sk: 'Pre sériových výrobcov s vysokým objemom', hu: 'Nagyvolumenű sorozatgyártóknak' },
        body: {
          ...
          sk: 'Pri denných výstupoch okolo 500 korpusov je Express S4 optimálne umiestnený — pod plne automatickými systémami, ale jasne nad strednou triedou. Štyri súčasne vsádzajúce vretená významne znižujú čas obsluhy na obrobok.',
      ...
      {
        heading: { de: 'Als Basis für eine produktive Vormontagelinie', en: 'As base for a productive pre-assembly line', cz: 'Jako základ produktivní předmontážní linky', sk: 'Ako základ produktívnej predmontážnej linky', hu: 'Termelékeny előszerelő sor alapjaként' },
        body: {
          ...
          sk: 'S podávaním, výstupom a nadväzujúcim korpusovým lisom tvorí S4 chrbticu produktívnej predmontážnej linky. Obsluha sa sústredí na manipuláciu s obrobkom, stroj preberá časť vsádzania kolíkov pri vysokej taktovacej frekvencii.',
    ...
    faq: [
      {
        question: { de: 'Wie groß ist der Unterschied zur S3?', en: 'How big is the difference to the S3?', cz: 'Jak velký je rozdíl oproti S3?', sk: 'Aký veľký je rozdiel oproti S3?', hu: 'Mekkora a különbség az S3-hoz képest?' },
        answer: {
      ...
      {
        question: { de: 'Braucht die S4 spezielle Bediener?', en: 'Does the S4 need special operators?', cz: 'Potřebuje S4 speciální obsluhu?', sk: 'Potrebuje S4 špeciálnu obsluhu?', hu: 'Speciális kezelőket igényel az S4?' },
        answer: {
      ...
      {
        question: { de: 'Passt die S4 in eine bestehende Linie?', en: 'Does the S4 fit into an existing line?', cz: 'Vejde se S4 do stávající linky?', sk: 'Zmestí sa S4 do existujúcej linky?', hu: 'Beleillik az S4 egy meglévő sorba?' },
        answer: {
  ...
  'express-s1-rta': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Hersteller von Bausatzmöbeln', en: 'For flat-pack furniture manufacturers', cz: 'Pro výrobce stavebnicového nábytku', sk: 'Pre výrobcov stavebnicového nábytku', hu: 'Csomagbútort gyártóknak' },
        body: {
          ...
          sk: 'RTA nábytok žije z toho, že ho koncový zákazník zvládne zmontovať niekoľkými pohybmi. To vyžaduje, aby excentrické kovania a kolíky boli už z výroby perfektne umiestnené. Presne to S1 RTA poskytuje — presne a reprodukovateľne.',
      ...
      {
        heading: { de: 'Als Einstieg in die Beschlagsetzung', en: 'As entry into fitting insertion', cz: 'Jako vstup do vsazování kování', sk: 'Ako vstup do vsádzania kovania', hu: 'Belépés a szerelvénybeültetésbe' },
        body: {
          ...
          sk: 'Kto doteraz vsádzal len kolíky a chce začať s prvou RTA linkou, nájde v S1 RTA prehľadnú investíciu. Jedno vreteno, obe funkcie — jasný krok do nového produktového segmentu.',
    ...
    faq: [
      {
        question: { de: 'Welche Beschlagsysteme werden unterstützt?', en: 'What fitting systems are supported?', cz: 'Jaké systémy kování jsou podporovány?', sk: 'Aké systémy kovania sú podporované?', hu: 'Milyen szerelvényrendszerek támogatottak?' },
        answer: {
      ...
      {
        question: { de: 'Wird zwischen Dübel und Beschlag umgerüstet?', en: 'Is changeover needed between dowel and fitting?', cz: 'Přestavuje se mezi kolíkem a kováním?', sk: 'Prestavuje sa medzi kolíkom a kovaním?', hu: 'Át kell állítani csap és szerelvény között?' },
        answer: {
      ...
      {
        question: { de: 'Eignet sich die S1 RTA für OEM-Aufträge?', en: 'Is the S1 RTA suitable for OEM orders?', cz: 'Hodí se S1 RTA pro OEM zakázky?', sk: 'Hodí sa S1 RTA pre OEM zákazky?', hu: 'Alkalmas az S1 RTA OEM-rendelésekhez?' },
        answer: {
  ...
  'express-s2-rta': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für E-Commerce-Möbelanbieter', en: 'For e-commerce furniture providers', cz: 'Pro e-commerce nabízející nábytek', sk: 'Pre e-commerce ponúkajúce nábytok', hu: 'E-kereskedelmi bútorforgalmazóknak' },
        body: {
          ...
          sk: 'Kto predáva nábytok ako stavebnicu na internete, je pod trvalým objemovým tlakom. S2 RTA poskytuje dostatočný prietok pre e-commerce počty — pri zároveň konštantnej kvalite, ktorá minimalizuje reklamácie.',
      ...
      {
        heading: { de: 'Für Küchen- und Schrankbausätze', en: 'For kitchen and cabinet kits', cz: 'Pro kuchyňské a skříňové stavebnice', sk: 'Pre kuchynské a skriňové stavebnice', hu: 'Konyha- és szekrénycsomagokhoz' },
        body: {
          ...
          sk: 'Kuchynské a skriňové stavebnice majú typicky dve polohy spojenia na stranu korpusu. Dve vretená S2 RTA pokrývajú presne túto schému a skracujú čas spracovania oproti jednovretenovým riešeniam na polovicu.',
    ...
    faq: [
      {
        question: { de: 'Wie groß ist der Durchsatzvorteil gegenüber S1 RTA?', en: 'How big is the throughput advantage over S1 RTA?', cz: 'Jak velká je výhoda průtoku oproti S1 RTA?', sk: 'Aká veľká je výhoda prietoku oproti S1 RTA?', hu: 'Mekkora az áteresztőképesség-előny az S1 RTA-val szemben?' },
        answer: {
      ...
      {
        question: { de: 'Können Dübel und Beschlag in einem Werkstück kombiniert werden?', en: 'Can dowels and fittings be combined in one workpiece?', cz: 'Lze kombinovat kolíky a kování v jednom obrobku?', sk: 'Dajú sa kombinovať kolíky a kovania v jednom obrobku?', hu: 'Kombinálhatók csapok és szerelvények egy munkadarabban?' },
        answer: {
      ...
      {
        question: { de: 'Gibt es Erfahrungen mit großen RTA-Herstellern?', en: 'Is there experience with large RTA manufacturers?', cz: 'Existují zkušenosti s velkými výrobci RTA?', sk: 'Existujú skúsenosti s veľkými výrobcami RTA?', hu: 'Van tapasztalat nagy RTA-gyártókkal?' },
        answer: {
  ...
  'express-s1-cnc': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für variantenreiche Tischlereien', en: 'For variant-rich joinery shops', cz: 'Pro variantně bohaté truhlárny', sk: 'Pre variantne bohaté stolárstva', hu: 'Változatos asztalosüzemekhez' },
        body: {
          ...
          sk: 'Keď je dnes kuchyňa, zajtra kancelársky regál a pozajtra vstavaná skriňa, sú mechanické prestavby limitujúcim faktorom. CNC riadenie S1 CNC tento problém rieši — vŕtací vzor sa mení voľbou programu v priebehu niekoľkých sekúnd.',
      ...
      {
        heading: { de: 'Für Betriebe mit digitaler Fertigungskette', en: 'For operations with digital production chain', cz: 'Pro provozy s digitálním výrobním řetězcem', sk: 'Pre prevádzky s digitálnym výrobným reťazcom', hu: 'Digitális gyártási lánccal rendelkező üzemekhez' },
        body: {
          ...
          sk: 'Kto používa CAD/CAM a digitálnu správu zákaziek, môže prenášať vŕtacie programy priamo z konštrukčného systému do S1 CNC. Softvérový tím Asamer podporuje integráciu s bežnými nábytkárskymi CAD systémami.',
    ...
    faq: [
      {
        question: { de: 'Welche Programmzahl kann gespeichert werden?', en: 'How many programs can be stored?', cz: 'Kolik programů lze uložit?', sk: 'Koľko programov sa dá uložiť?', hu: 'Hány program tárolható?' },
        answer: {
      ...
      {
        question: { de: 'Wie anspruchsvoll ist die Bedienerschulung?', en: 'How demanding is operator training?', cz: 'Jak náročné je školení obsluhy?', sk: 'Aké náročné je školenie obsluhy?', hu: 'Mennyire igényes a kezelői képzés?' },
        answer: {
      ...
      {
        question: { de: 'Ist die S1 CNC für RTA-Produktion geeignet?', en: 'Is the S1 CNC suitable for RTA production?', cz: 'Hodí se S1 CNC pro RTA výrobu?', sk: 'Hodí sa S1 CNC pre RTA výrobu?', hu: 'Alkalmas az S1 CNC RTA-gyártáshoz?' },
        answer: {
  ...
  'express-807': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für spezialisierte Möbelfertigung', en: 'For specialised furniture production', cz: 'Pro specializovanou výrobu nábytku', sk: 'Pre špecializovanú výrobu nábytku', hu: 'Specializált bútorgyártáshoz' },
        body: {
          ...
          sk: 'Pri obrobkoch s obzvlášť hustým alebo neobvykle rozloženým vsádzaním kolíkov štandardné stroje zlyhávajú pre geometriu. Express 807 prináša požadovaný počet vretien už z výroby — bez kompromisu v čase taktu alebo obsluhe.',
      ...
      {
        heading: { de: 'Als Ergänzung zu einer bestehenden Express-Linie', en: 'As complement to an existing Express line', cz: 'Jako doplnění ke stávající lince Express', sk: 'Ako doplnenie k existujúcej linke Express', hu: 'Kiegészítésként meglévő Express-sorhoz' },
        body: {
          ...
          sk: 'Prevádzky s už nainštalovaným Express S2 alebo S3 často dopĺňajú 807 pre špeciálne úlohy. Spoločná platforma znamená: rovnaké obsluhy, rovnaká údržba, rovnaké skladovanie náhradných dielov — uvedenie do prevádzky je podstatne jednoduchšie než pri cudzej značke.',
    ...
    faq: [
      {
        question: { de: 'Ist die 807 frei konfigurierbar?', en: 'Is the 807 freely configurable?', cz: 'Je 807 volně konfigurovatelný?', sk: 'Je 807 voľne konfigurovateľný?', hu: 'Szabadon konfigurálható a 807?' },
        answer: {
      ...
      {
        question: { de: 'Wie verfügbar sind Ersatzteile?', en: 'How available are spare parts?', cz: 'Jak jsou dostupné náhradní díly?', sk: 'Ako sú dostupné náhradné diely?', hu: 'Mennyire elérhetők az alkatrészek?' },
        answer: {
      ...
      {
        question: { de: 'Braucht die 807 einen separaten Aufstellplatz?', en: 'Does the 807 need a separate floor space?', cz: 'Potřebuje 807 samostatné místo?', sk: 'Potrebuje 807 samostatné miesto?', hu: 'Szüksége van a 807-nek külön helyre?' },
        answer: {
  ...
  'vector-cnc': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für variantenreiche Industrieproduktion', en: 'For variant-rich industrial production', cz: 'Pro variantně bohatou průmyslovou výrobu', sk: 'Pre variantne bohatú priemyselnú výrobu', hu: 'Változatos ipari gyártáshoz' },
        body: {
          ...
          sk: 'Prevádzky, ktoré dnes vyrábajú kuchyňu, zajtra skriňu, pozajtra komodu — a to v priemyselnom počte — potrebujú stroj, ktorý bez prestavby prepína medzi programami. Vector CNC to robí s plne automatickým vedením obrobku.',
      ...
      {
        heading: { de: 'Als Herzstück einer automatisierten Fertigungszelle', en: 'As heart of an automated manufacturing cell', cz: 'Jako srdce automatizované výrobní buňky', sk: 'Ako srdce automatizovanej výrobnej bunky', hu: 'Automatizált gyártócella szíveként' },
        body: {
          ...
          sk: 'V prepojení s podávacou robotikou, korpusovým lisom a nadväzujúcim balením vzniká okolo Vector CNC prevažne bezobslužná výrobná bunka. Tým sa dajú variantné programy prevádzkovať ekonomicky aj vo viaczmennej prevádzke.',
    ...
    faq: [
      {
        question: { de: 'Ist eine ERP-Anbindung vorgesehen?', en: 'Is ERP connection provided?', cz: 'Je plánováno napojení na ERP?', sk: 'Je plánované napojenie na ERP?', hu: 'Tervezve van ERP-kapcsolat?' },
        answer: {
      ...
      {
        question: { de: 'Wie groß ist die Bedienmannschaft?', en: 'How large is the operating team?', cz: 'Jak velká je obsluha?', sk: 'Aká veľká je obsluha?', hu: 'Mekkora a kezelő csapat?' },
        answer: {
      ...
      {
        question: { de: 'Eignet sich die Vector CNC für Losgröße 1?', en: 'Is the Vector CNC suitable for batch-size 1?', cz: 'Hodí se Vector CNC pro dávku 1?', sk: 'Hodí sa Vector CNC pre dávku 1?', hu: 'Alkalmas a Vector CNC 1-es tételszámhoz?' },
        answer: {
  ...
  'spectrum': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle RTA-Möbelproduktion', en: 'For industrial RTA furniture production', cz: 'Pro průmyslovou výrobu RTA nábytku', sk: 'Pre priemyselnú výrobu RTA nábytku', hu: 'Ipari RTA-bútorgyártáshoz' },
        body: {
          ...
          sk: 'Spectrum je prvou voľbou pre priemyselných RTA zákazníkov s päťmiestnymi dennými počtami kusov. Kolíky a excentrické kovania sa vsádzajú v jednej linke — ušetrí celú obrábaciu stanicu oproti oddelenému strojovému parku.',
      ...
      {
        heading: { de: 'Als Premium-Ergänzung zur Selekta-Linie', en: 'As premium complement to the Selekta line', cz: 'Jako prémiové doplnění k lince Selekta', sk: 'Ako prémiové doplnenie k linke Selekta', hu: 'A Selekta-sor prémium kiegészítéseként' },
        body: {
          ...
          sk: 'Prevádzky, ktoré už nasadili Selektu, často rozširujú Spectrum o druhú výrobnú vetvu pre programy s intenzívnym vsádzaním kovania. Podobnosť platforiem uľahčuje školenie a zásobovanie náhradnými dielmi.',
    ...
    faq: [
      {
        question: { de: 'Welche Beschlag- und Dübelgrößen werden verarbeitet?', en: 'What fitting and dowel sizes are processed?', cz: 'Jaké velikosti kování a kolíků se zpracovávají?', sk: 'Aké veľkosti kovania a kolíkov sa spracúvajú?', hu: 'Milyen szerelvény- és csapméreteket dolgoz fel?' },
        answer: {
      ...
      {
        question: { de: 'Ist eine Losgröße-1-Produktion möglich?', en: 'Is batch-size-1 production possible?', cz: 'Je možná výroba dávky 1?', sk: 'Je možná výroba dávky 1?', hu: 'Lehetséges 1-es tételszámú gyártás?' },
        answer: {
      ...
      {
        question: { de: 'Wie hoch ist der Platzbedarf?', en: 'How large is the space requirement?', cz: 'Jaká je plošná náročnost?', sk: 'Aká je plošná náročnosť?', hu: 'Mekkora a helyigény?' },
        answer: {
  ...
  'injecta': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für tragende Holzkonstruktionen', en: 'For load-bearing wood constructions', cz: 'Pro nosné dřevěné konstrukce', sk: 'Pre nosné drevené konštrukcie', hu: 'Teherhordó faszerkezetekhez' },
        body: {
          ...
          sk: 'Pri nosných nábytkových, regálových alebo interiérových štruktúrach musí kolíkový spoj prenášať vyššie sily. Injektáž lepidla Injecta vytvára plošne zmáčanú lepenú plochu, ktorá v dosiahnuteľnej pevnosti často prevyšuje klasické aplikačné postupy.',
      ...
      {
        heading: { de: 'Für spezielle Feuchteschutz- oder Lastanforderungen', en: 'For special moisture protection or load requirements', cz: 'Pro speciální požadavky na ochranu proti vlhkosti nebo zatížení', sk: 'Pre špeciálne požiadavky na ochranu proti vlhkosti alebo zaťaženiu', hu: 'Különleges nedvességvédelmi vagy terhelési követelményekhez' },
        body: {
          ...
          sk: 'Vo vlhkých alebo premenlivo klimatických oblastiach použitia — kuchynský nábytok, sanitárny nábytok, vonkajšie vybavenie — je dutý kolíkový spoj náchylný. Injecta dutinu úplne uzatvára a tým citeľne zvyšuje životnosť spoja.',
    ...
    faq: [
      {
        question: { de: 'Welche Klebstoffe sind geeignet?', en: 'Which adhesives are suitable?', cz: 'Jaká lepidla jsou vhodná?', sk: 'Aké lepidlá sú vhodné?', hu: 'Milyen ragasztók alkalmasak?' },
        answer: {
      ...
      {
        question: { de: 'Lässt sich die Injecta in bestehende Linien integrieren?', en: 'Can the Injecta be integrated into existing lines?', cz: 'Lze Injecta integrovat do stávajících linek?', sk: 'Dá sa Injecta integrovať do existujúcich liniek?', hu: 'Integrálható az Injecta meglévő sorokba?' },
        answer: {
      ...
      {
        question: { de: 'Wie hoch ist der Wartungsaufwand?', en: 'What is the maintenance effort?', cz: 'Jaká je náročnost údržby?', sk: 'Aká je náročnosť údržby?', hu: 'Mekkora a karbantartási ráfordítás?' },
        answer: {
...
export const GANNOMAT_CATEGORY_SEO: Record<GannomatCategory, CategorySeoContent> = {
  insertion: {
    introExpanded: {
      ...
      sk: 'Gannomat stroje na vŕtanie, lepenie a zarážanie kolíkov sú srdcom každej priemyselnej výroby korpusu. Spájajú tri kritické procesné kroky — vŕtanie kolíkových otvorov, nanášanie lepidla a zarážanie kolíkov — do jediného stroja a do jediného upnutia. Výsledok: kratšie časy taktu, vyššia procesná spoľahlivosť a reprodukovateľná kvalita. Rad Gannomat siaha od Elite ako poloautomatického vstupného modelu cez Selekta ako priemyselný štandard až po Spectrum a Index Reihe CNC pre vysoko variabilnú výrobu dávky 1. Pre výrobcov nábytku v Českej republike, na Slovensku a v Maďarsku je Gannomat osvedčeným rakúskym dodávateľom, ktorého Asamer exkluzívne zastupuje. Rakúsky pôvod zaručuje vysokú kvalitu strojov; miestna podpora od Asamer zaisťuje rýchle reakčné časy pri servise a náhradných dieloch.',
    ...
    sections: [
      {
        heading: { de: 'Halbautomatisch vs. vollautomatisch', en: 'Semi-automatic vs. fully automatic', cz: 'Poloautomatické vs. plně automatické', sk: 'Poloautomatické vs. plne automatické', hu: 'Félautomatikus vs. teljesen automatikus' },
        body: {
          ...
          sk: 'Poloautomatické stroje (Elite, Express) potrebujú obsluhu na polohovanie obrobku a sú ekonomické pri strednom prietoku. Plne automatické stroje (Selekta, Spectrum, Index Reihe CNC) pracujú s automatickým podávaním obrobku a CNC programovým riadením — ideálne pre vysoký prietok alebo zložitú variantnú výrobu.',
      ...
      {
        heading: { de: 'Beschlagsetzen zusätzlich zu Dübeln', en: 'Fitting insertion in addition to dowels', cz: 'Vsazování kování dodatečně ke kolíkům', sk: 'Vsádzanie kovania dodatočne ku kolíkom', hu: 'Szerelvény beültetés a csapokon túl' },
        body: {
          ...
          sk: 'Index Reihe CNC a Spectrum vsádzajú okrem kolíkov aj kovania (excentre, skrutky, puzdrá) — nepostrádateľné pre výrobu RTA nábytku. Selekta sa sústredí na čisté vŕtanie, lepenie a kolíkovanie; vsádzanie kovania prebieha na oddelených strojoch.',
    ...
    faq: [
      {
        question: { de: 'Welche Maschine passt zu welchem Betrieb?', en: 'Which machine fits which operation?', cz: 'Který stroj se hodí pro jaký provoz?', sk: 'Ktorý stroj sa hodí pre akú prevádzku?', hu: 'Melyik gép illik melyik üzemhez?' },
        answer: {
          ...
          sk: 'Stolárstvo do 20 pracovníkov: Elite. Stredne veľké 20–80 pracovníkov: Selekta. Priemyselné: Spectrum alebo Index Reihe CNC. Asamer poradí na základe konkrétnych výrobných dát.',
      ...
      {
        question: { de: 'Gibt es Finanzierungsmöglichkeiten?', en: 'Are there financing options?', cz: 'Existují možnosti financování?', sk: 'Existujú možnosti financovania?', hu: 'Vannak finanszírozási lehetőségek?' },
        answer: {
          ...
          sk: 'Áno — Asamer spolupracuje s lízingovými bankami pre splátkový predaj a lízing. Podmienky si prosím vyžiadajte priamo.',
          hu: 'Igen — az Asamer lízingbankokkal működik együtt bérlet-vétel és lízing terén. A feltételeket kérjük, közvetlenül kérje.',
        },
      },
      {
        question: { de: 'Welche Lieferzeit ist typisch?', en: 'What is the typical delivery time?', cz: 'Jaká je typická dodací lhůta?', sk: 'Aká je typická dodacia lehota?', hu: 'Mi a jellemző szállítási idő?' },
        answer: {
          ...
          sk: 'Skladové stroje 2–4 týždne, špeciálne vyhotovenia 8–16 týždňov. Asamer drží bežné modely skladom.',
  ...
  insertion_door: {
    introExpanded: {
      ...
      sk: 'Gannomat stroje na zarážanie kolíkov pre dvere a okná (Selekta HD, Injecta HD, Index DW Reihe CNC) sú prispôsobené špecifickým požiadavkám výroby dverí a okien. Dverové a okenné profily majú na rozdiel od bočníc korpusu iné vŕtacie vzory, hustotu materiálu a tolerancie — HD varianty sú na to optimalizované. Stroje spracúvajú drevené, hliníkové a plastové rámy s vysokou presnosťou a dajú sa integrovať do výrobných liniek s rámovými lismi a zasklievacími stanicami. Asamer dodáva rad Gannomat HD výrobcom dverí a okenným továrňam v CZ, SK a HU vrátane prispôsobenia vašim typom rámov.',
    ...
    sections: [
      {
        heading: { de: 'Holz, Aluminium, Kunststoff', en: 'Wood, aluminium, plastic', cz: 'Dřevo, hliník, plast', sk: 'Drevo, hliník, plast', hu: 'Fa, alumínium, műanyag' },
        body: {
          ...
          sk: 'HD modely spracúvajú všetky bežné rámové materiály. Nástroje sa vyberajú podľa materiálu, vŕtacie parametre sú uložené v CNC riadení.',
    ...
    faq: [
      {
        question: { de: 'Passen die HD-Maschinen zu österreichischen und deutschen Rahmenstandards?', en: 'Do HD machines fit Austrian and German frame standards?', cz: 'Odpovídají HD stroje rakouským a německým rámovým standardům?', sk: 'Zodpovedajú HD stroje rakúskym a nemeckým rámovým štandardom?', hu: 'Megfelelnek a HD-gépek az osztrák és német keret-szabványoknak?' },
        answer: {
          ...
          sk: 'Áno — rad HD je navrhnutý pre európske štandardy (Eurodrážka, Eurokoľajnica).',
          hu: 'Igen — a HD sorozat európai szabványokra (Eurohoronyra, Eurosínre) készült.',
        },
      },
      {
        question: { de: 'Kann die Selekta HD in eine Fertigungslinie eingebunden werden?', en: 'Can the Selekta HD be integrated into a production line?', cz: 'Lze Selekta HD zapojit do výrobní linky?', sk: 'Dá sa Selekta HD zapojiť do výrobnej linky?', hu: 'Integrálható a Selekta HD gyártósorba?' },
        answer: {
          ...
          sk: 'Áno — so vstupným, výstupným dopravníkom a pufrom. Asamer linku projektuje.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'Interval údržby 6 mesiacov, ročná hlavná kontrola. Servisná zmluva odporúčaná.',
  ...
  machining: {
    introExpanded: {
      ...
      sk: 'Gannomat CNC obrábacie centrá — predovšetkým ProTec Profit — spájajú frézovanie, vŕtanie a zarážanie kolíkov v jednom stroji s jediným upnutím. Je to kľúč k zložitým dielom nábytku ako čelným plochám s výrezmi a vŕtaním pre kovania alebo korpusovým dielom s frézovanými profilmi. Namiesto presúvania obrobku medzi viacerými strojmi — každý s vlastnými chybami premiestnenia — vzniká hotový diel v jednom prechode. Pre výrobcov nábytku so zmesou vŕtania a frézovania sú obrábacie centrá Gannomat často najlepším riešením. Asamer ich dodáva pre CZ, SK a HU vrátane programovania, úpravy postprocesora a integrácie s ERP.',
    ...
    sections: [
      {
        heading: { de: 'CNC-Bearbeitungszentrum vs. Einzelmaschinen', en: 'CNC machining centre vs. individual machines', cz: 'CNC obráběcí centrum vs. jednotlivé stroje', sk: 'CNC obrábacie centrum vs. jednotlivé stroje', hu: 'CNC megmunkáló központ vs. egyedi gépek' },
        body: {
          ...
          sk: 'Jednotlivé stroje sú často rýchlejšie pri veľmi vysokých počtoch kusov s málo variantmi; CNC obrábacie centrá víťazia pri zložitých obrobkoch a dávke 1. Rozhodnutie závisí od vášho mixu produktov.',
    ...
    faq: [
      {
        question: { de: 'Wie gestaltet sich die Programmierung?', en: 'How is programming handled?', cz: 'Jak probíhá programování?', sk: 'Ako prebieha programovanie?', hu: 'Hogyan történik a programozás?' },
        answer: {
          ...
          sk: 'Cez grafický CAD softvér so štandardnými importnými formátmi (DXF, DWG, STEP). Asamer školí váš tím.',
          hu: 'Grafikus CAD-szoftveren keresztül szabványos importformátumokkal (DXF, DWG, STEP). Az Asamer betanítja a csapatát.',
        },
      },
      {
        question: { de: 'Werkzeugmanagement?', en: 'Tool management?', cz: 'Správa nástrojů?', sk: 'Správa nástrojov?', hu: 'Szerszámkezelés?' },
        answer: {
          ...
          sk: 'Automatický menič nástrojov až s 30 miestami, automatické meranie nástrojov.',
          hu: 'Automatikus szerszámcserélő akár 30 hellyel, automatikus szerszámmérés.',
        },
      },
      {
        question: { de: 'Staubabsaugung integriert?', en: 'Dust extraction integrated?', cz: 'Je odsávání prachu integrováno?', sk: 'Je odsávanie prachu integrované?', hu: 'Integrált porelszívás?' },
        answer: {
          ...
          sk: 'Áno — napojenie na existujúce odsávacie zariadenie štandard.',
  ...
  fitting: {
    introExpanded: {
      ...
      sk: 'Gannomat stroje na vsádzanie kolíkov (rad Express S1 až S5, Basica, Variabel, Red Baron, Vector CNC) pokrývajú široké spektrum korpusového spracovania kolíkov. Od kompaktného vstupného stroja Basica po CNC riadený Vector sú k dispozícii vhodné riešenia pre každú veľkosť prevádzky. Express S1–S5 sa líšia počtom vretien: viac vretien znamená viac kolíkov na zdvih a kratšie časy taktu. Vector CNC a Express CNC ponúkajú voľnú programovateľnosť pre variabilné vŕtacie vzory. Varianty RTA (Ready-to-Assemble) navyše ku kolíkom vsádzajú aj kovania. Asamer poradí pri výbere modelu podľa vašich počtov kusov a produktových variantov pre CZ, SK a HU.',
    ...
    sections: [
      {
        heading: { de: 'Welche Spindelzahl ist richtig?', en: 'Which spindle count is right?', cz: 'Který počet vřeten je správný?', sk: 'Ktorý počet vretien je správny?', hu: 'Melyik orsószám a megfelelő?' },
        body: {
          ...
          sk: 'Hrubá orientácia: S1 do 50 obrobkov/deň, S2 do 150, S3 do 300, S4 do 500, S5 nad 500. Viac vretien znamená lepší výkon pri konštantných obrobkoch; pri vysokej variabilite často stačí menej vretien.',
      ...
      {
        heading: { de: 'RTA vs. Standard-Dübelsetzmaschine', en: 'RTA vs. standard dowel insertion machine', cz: 'RTA vs. standardní stroj pro vsazování kolíků', sk: 'RTA vs. štandardný stroj na vsádzanie kolíkov', hu: 'RTA vs. szabványos csapbeültető gép' },
        body: {
          ...
          sk: 'RTA varianty vsádzajú ku kolíkom aj kovania. Nepostrádateľné pre výrobcov nábytkových stavebníc alebo RTA nábytku. Pre nábytok montovaný na pracovnom stole stačí štandardné kolíkovanie.',
    ...
    faq: [
      {
        question: { de: 'Welche Dübelgrößen?', en: 'Which dowel sizes?', cz: 'Jaké velikosti kolíků?', sk: 'Aké veľkosti kolíkov?', hu: 'Milyen csapméretek?' },
        answer: {
          ...
          sk: '6, 8 a 10 mm štandard. Špeciálne rozmery možné.',
          hu: '6, 8 és 10 mm szabvány. Egyedi méretek lehetségesek.',
        },
      },
      {
        question: { de: 'Pneumatikbedarf?', en: 'Pneumatic requirements?', cz: 'Požadavky na pneumatiku?', sk: 'Požiadavky na pneumatiku?', hu: 'Pneumatikai igény?' },
        answer: {
          ...
          sk: 'Štandardný dielenský stlačený vzduch (6–8 bar) postačuje.',
          hu: 'Szabványos műhelyi sűrített levegő (6–8 bar) elegendő.',
        },
      },
      {
        question: { de: 'Wie schnell ist der Modellwechsel?', en: 'How fast is model changeover?', cz: 'Jak rychlá je změna modelu?', sk: 'Aká rýchla je zmena modelu?', hu: 'Milyen gyors a modellváltás?' },
        answer: {
          ...
          sk: 'Pri S modeloch mechanicky 30–60 min, pri CNC modeloch výber programu za sekundy.',
  ...
  carcass: {
    introExpanded: {
      ...
      cz: `Gannomat korpusové lisy (Concept Easy, Eco, Primus, Korpus-Montagelinie, Lift, Lift Jumper) zajišťují tvarově stabilní lepení korpusu po vsazení kolíků. Lepidlo potřebuje tlak během vytvrzování — teprve tím vzniká pravoúhlý, zatížitelný nábytkový korpus. Řada Concept pokrývá všechny velikosti provozu: Concept Easy pro truhlárny, Concept Eco pro střední výrobu, Concept Primus pro průmysl, Korpus-Montagelinie jako kompletní řešení. Lift a Lift Jumper jsou zdvihací technikou pro vkládání velkých korpusů. Asamer dodává korpusové lisy Gannomat pro CZ, SK a HU včetně poradenství při integraci linky.`,
      sk: 'Gannomat korpusové lisy (Concept Easy, Eco, Primus, Korpus-Montagelinie, Lift, Lift Jumper) zaisťujú tvarovo stabilné lepenie korpusu po vsadení kolíkov. Lepidlo potrebuje tlak počas vytvrdzovania — až tým vzniká pravouhlý, zaťažiteľný nábytkový korpus. Rad Concept pokrýva všetky veľkosti prevádzky: Concept Easy pre stolárstva, Concept Eco pre strednú výrobu, Concept Primus pre priemysel, Korpus-Montagelinie ako kompletné riešenie. Lift a Lift Jumper sú zdvíhacou technikou na vkladanie veľkých korpusov. Asamer dodáva korpusové lisy Gannomat pre CZ, SK a HU vrátane poradenstva pri integrácii linky.',
    ...
    sections: [
      {
        heading: { de: 'Concept Easy / Eco / Primus — Auswahlhilfe', en: 'Concept Easy / Eco / Primus — selection guide', cz: 'Concept Easy / Eco / Primus — pomůcka při výběru', sk: 'Concept Easy / Eco / Primus — pomôcka pri výbere', hu: 'Concept Easy / Eco / Primus — választási segédlet' },
        body: {
          ...
          sk: 'Concept Easy: stolárstvo, vstup, ručné zakladanie. Concept Eco: stredná výroba, poloautomatický. Concept Primus: priemysel, plne automatický. Korpus-Montagelinie: priebežná výrobná linka so Selekta.',
    ...
    faq: [
      {
        question: { de: 'Welche Korpusgrößen?', en: 'What carcass sizes?', cz: 'Jaké velikosti korpusu?', sk: 'Aké veľkosti korpusu?', hu: 'Milyen korpuszméretek?' },
        answer: {
          ...
          sk: 'Zvyčajne 300 × 300 × 300 až 1.200 × 800 × 600 mm. Nadmerné formáty na vyžiadanie.',
          hu: 'Jellemzően 300 × 300 × 300-tól 1200 × 800 × 600 mm-ig. Túlméretes formátumok kérésre.',
        },
      },
      {
        question: { de: 'Presszeit?', en: 'Pressing time?', cz: 'Doba lisování?', sk: 'Čas lisovania?', hu: 'Présidő?' },
        answer: {
          ...
          sk: '30–120 sekúnd podľa lepidla a veľkosti korpusu.',
          hu: '30–120 másodperc a ragasztótól és a korpuszmérettől függően.',
        },
      },
      {
        question: { de: 'Linienintegration?', en: 'Line integration?', cz: 'Integrace do linky?', sk: 'Integrácia do linky?', hu: 'Gyártósor-integráció?' },
        answer: {
          ...
          sk: 'Áno — so Selekta, dopravníkom a vybaľovačom ako kompletná linka.',
  ...
  boring: {
    introExpanded: {
      ...
      cz: `Gannomat kolíkovací vrtací stroje (DB 21-27-35 a DB 21-27-35 WA) jsou klasické vícevřetenové vrtací stroje pro bočnice korpusu, záda a díly nábytku se standardními vzory otvorů. Čísla 21-27-35 označují tři varianty modelu s odpovídajícím počtem vřeten. Varianta WA má automatické podávání obrobku pro vyšší průtok. Pro truhlárny a středně velké výrobce nábytku jsou tyto stroje desetiletí průmyslovým standardem — vysoká spolehlivost, jednoduchá obsluha, dobrá servisovatelnost. Asamer dodává řadu DB pro CZ, SK a HU včetně seřízení na vaše rozteče otvorů.`,
      sk: 'Gannomat kolíkovacie vŕtacie stroje (DB 21-27-35 a DB 21-27-35 WA) sú klasické viacvretenové vŕtacie stroje pre bočnice korpusu, chrbty a diely nábytku so štandardnými vzormi otvorov. Čísla 21-27-35 označujú tri varianty modelu so zodpovedajúcim počtom vretien. Variant WA má automatické podávanie obrobku pre vyšší prietok. Pre stolárstva a stredne veľkých výrobcov nábytku sú tieto stroje desaťročia priemyselným štandardom — vysoká spoľahlivosť, jednoduchá obsluha, dobrá servisovateľnosť. Asamer dodáva rad DB pre CZ, SK a HU vrátane nastavenia na vaše rozstupy otvorov.',
    ...
    sections: [
      {
        heading: { de: 'Kolkovaci-Bohrmaschine vs. CNC-Maschine', en: 'Dowel drilling machine vs. CNC machine', cz: 'Kolíkovací vrtací stroj vs. CNC stroj', sk: 'Kolíkovací vŕtací stroj vs. CNC stroj', hu: 'Csapfúró gép vs. CNC gép' },
        body: {
          ...
          cz: 'Kolíkovací vrtací stroje jsou optimalizovány pro standardní vzory otvorů — rychlejší a levnější než CNC stroje. Při vysokém počtu variant nebo neobvyklých vrtacích vzorech je CNC lepší volbou.',
          sk: 'Kolíkovacie vŕtacie stroje sú optimalizované pre štandardné vzory otvorov — rýchlejšie a lacnejšie než CNC stroje. Pri vysokom počte variantov alebo neobvyklých vŕtacích vzoroch je CNC lepšou voľbou.',
    ...
    faq: [
      {
        question: { de: 'Was heißt WA?', en: 'What does WA mean?', cz: 'Co znamená WA?', sk: 'Čo znamená WA?', hu: 'Mit jelent a WA?' },
        answer: {
          ...
          sk: 'Automatika obrobku — podávanie a odber prebiehajú automaticky dopravníkom.',
          hu: 'Munkadarab-automatika — az adagolás és az elszállítás automatikusan szállítószalagon történik.',
        },
      },
      {
        question: { de: 'Bohrtiefenanschläge?', en: 'Depth stops?', cz: 'Hloubkové dorazy?', sk: 'Hĺbkové dorazy?', hu: 'Mélységütközők?' },
        answer: {
          ...
          sk: 'Nastaviteľné na vreteno. Štandardne 10–40 mm.',
          hu: 'Orsónként állítható. Szabvány 10–40 mm.',
        },
      },
      {
        question: { de: 'Werkzeugwechsel?', en: 'Tool change?', cz: 'Výměna nástrojů?', sk: 'Výmena nástrojov?', hu: 'Szerszámcsere?' },
        answer: {
          de: 'Manuell, wenige Minuten pro Spindel.',
          en: 'Manual, few minutes per spindle.',
          cz: 'Ručně, několik minut na vřeteno.',
          sk: 'Ručne, niekoľko minút na vreteno.',
  ...
  rowboring: {
    introExpanded: {
      ...
      sk: 'Gannomat radové vŕtacie stroje (ProLine 50, Vantage 76-152) sú vysokovýkonné vŕtacie stroje s 50 až 152 vretenami pre veľkosériovú výrobu. Jediný stroj vŕta celé vŕtacie vzory — napríklad celú bočnicu skrine — v jedinom zdvihu. Je to najrýchlejšia cesta k štandardným korpusovým dielom s 32 mm rastrom. Radové vŕtacie stroje sú vhodné výlučne pre veľkosériovú výrobu s nízkou variabilitou; dávka 1 nie je ich odborom. Pre výrobcov nábytku so stabilnými výrobnými programami sú neprekonateľne ekonomické. Asamer ich dodáva pre CZ, SK a HU vrátane integrácie do linky.',
    ...
    sections: [
      {
        heading: { de: 'Wann lohnt sich eine Reihenbohrmaschine?', en: 'When does a row drilling machine pay off?', cz: 'Kdy se vyplatí řadový vrtací stroj?', sk: 'Kedy sa oplatí radový vŕtací stroj?', hu: 'Mikor éri meg a soros fúrógép?' },
        body: {
          ...
          sk: 'Od cca 500 obrobkov denne pri stabilnom výrobnom programe. Prestavenie na iné vŕtacie vzory je mechanicky náročné — preto má zmysel len pri niekoľkých štandardných typoch.',
    ...
    faq: [
      {
        question: { de: 'Umrüstzeit?', en: 'Changeover time?', cz: 'Doba přestavení?', sk: 'Čas prestavenia?', hu: 'Átállási idő?' },
        answer: {
          de: '1–4 Stunden je nach Komplexität.',
          en: '1–4 hours depending on complexity.',
          cz: '1–4 hodiny podle složitosti.',
          sk: '1–4 hodiny podľa zložitosti.',
          hu: '1–4 óra a komplexitástól függően.',
        },
      },
      {
        question: { de: 'Welche Spindelzahl für meinen Betrieb?', en: 'Which spindle count for my operation?', cz: 'Jaký počet vřeten pro můj provoz?', sk: 'Aký počet vretien pre moju prevádzku?', hu: 'Milyen orsószám az üzememhez?' },
        answer: {
          ...
          sk: '76 pre stredné obrobky, 152 pre maximálnu flexibilitu.',
          hu: '76 közepes munkadarabokhoz, 152 maximális rugalmassághoz.',
        },
      },
      {
        question: { de: 'Automatische Werkstückzuführung?', en: 'Automatic workpiece feeding?', cz: 'Automatické podávání obrobku?', sk: 'Automatické podávanie obrobku?', hu: 'Automatikus munkadarab-adagolás?' },
        answer: {
          ...
          sk: 'Voliteľne, odporúčané pre plne automatickú prevádzku.',
  ...
  gluing: {
    introExpanded: {
      ...
      sk: 'Gannomat lepiace systémy (Leimfix, Injecta) automatizujú presné nanášanie lepidla na kolíky alebo priamo do vŕtania — kritický procesný krok pre spoľahlivé spoje nábytku. Ručné dávkovanie lepidla kolíše medzi obsluhami a vedie k rozdielom v kvalite; automatické systémy ako Leimfix a Injecta zaručujú konštantné množstvo lepidla. Leimfix je štandardný model na lepenie kolíkov, Injecta na špeciálne injekčné postupy. Pre výrobcov nábytku s väčším denným výstupom má automatizácia nanášania lepidla ekonomický zmysel. Asamer dodáva lepiace systémy Gannomat pre CZ, SK a HU vrátane integrácie do existujúcich vŕtacích strojov.',
    ...
    sections: [
      {
        heading: { de: 'Leimfix vs. Injecta', en: 'Leimfix vs. Injecta', cz: 'Leimfix vs. Injecta', sk: 'Leimfix vs. Injecta', hu: 'Leimfix vs. Injecta' },
        body: {
          ...
          sk: 'Leimfix: dávkovanie na kolík pred vsadením — štandardný prípad. Injecta: vstrekovanie priamo do otvoru po vsadení kolíka — pre špeciálne aplikácie s vyššími nárokmi na pevnosť.',
    ...
    faq: [
      {
        question: { de: 'Welche Klebstoffe sind kompatibel?', en: 'Which adhesives are compatible?', cz: 'Jaká lepidla jsou kompatibilní?', sk: 'Aké lepidlá sú kompatibilné?', hu: 'Mely ragasztók kompatibilisek?' },
        answer: {
          ...
          sk: 'D3 biele lepidlo a PUR lepidlá sú štandard.',
          hu: 'A D3 fehér ragasztó és a PUR ragasztók szabványosak.',
        },
      },
      {
        question: { de: 'Nachrüstung an bestehenden Maschinen?', en: 'Retrofit to existing machines?', cz: 'Dovybavení stávajících strojů?', sk: 'Dovybavenie existujúcich strojov?', hu: 'Utólagos felszerelés meglévő gépekre?' },
        answer: {
          ...
          sk: 'Áno — na stroje Gannomat bezprostredne, na cudzie stroje podľa projektu.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'Denne 2–5 minút. Týždenne dôkladné prepláchnutie.',
  ...
  frame: {
    introExpanded: {
      ...
      sk: 'Gannomat rámové vŕtacie stroje (Junior 323, Master 325, Mod 160) sú špecializované na spracovanie nábytkových, dverových a okenných rámov. Na rozdiel od bočnicových vŕtacích strojov pracujú s rôznymi vŕtacími hlavami na všetkých stranách rámu — pre rámové spojovacie prvky, kolíky pri rohových spojoch alebo vsádzanie kovania. Junior 323 je vstupný model pre menšie stolárstva, Master 325 osvedčený štandard pre stredne veľké prevádzky, Mod 160 najflexibilnejší variant pre špeciálne rámy. Asamer dodáva rámové vŕtacie stroje pre CZ, SK a HU vrátane nastavenia na vaše typy rámov.',
    ...
    sections: [
      {
        heading: { de: 'Junior 323 vs. Master 325 vs. Mod 160', en: 'Junior 323 vs. Master 325 vs. Mod 160', cz: 'Junior 323 vs. Master 325 vs. Mod 160', sk: 'Junior 323 vs. Master 325 vs. Mod 160', hu: 'Junior 323 vs. Master 325 vs. Mod 160' },
        body: {
          ...
          sk: 'Junior 323: vstup, jednoduché rámy. Master 325: štandard pre nábytkové, dverové, okenné rámy. Mod 160: špeciálne rámy so zložitými vŕtacími vzormi.',
    ...
    faq: [
      {
        question: { de: 'Welche Rahmenmaterialien?', en: 'Which frame materials?', cz: 'Jaké materiály rámů?', sk: 'Aké materiály rámov?', hu: 'Milyen keretanyagok?' },
        answer: {
          ...
          sk: 'Masívne drevo, MDF, povrstvená drevotrieska, čiastočne hliník (so špeciálnymi nástrojmi).',
          hu: 'Tömör fa, MDF, bevonatos forgácslap, részben alumínium (speciális szerszámokkal).',
        },
      },
      {
        question: { de: 'Werkstückgrößen?', en: 'Workpiece sizes?', cz: 'Velikosti obrobků?', sk: 'Veľkosti obrobkov?', hu: 'Munkadarabméretek?' },
        answer: {
          de: 'Typisch 300 × 300 bis 2.500 × 1.200 mm.',
          en: 'Typically 300 × 300 to 2,500 × 1,200 mm.',
          cz: 'Obvykle 300 × 300 až 2.500 × 1.200 mm.',
          sk: 'Zvyčajne 300 × 300 až 2.500 × 1.200 mm.',
          hu: 'Jellemzően 300 × 300-tól 2500 × 1200 mm-ig.',
        },
      },
      {
        question: { de: 'CNC-Steuerung verfügbar?', en: 'CNC control available?', cz: 'Je k dispozici CNC řízení?', sk: 'Je k dispozícii CNC riadenie?', hu: 'Elérhető CNC-vezérlés?' },
        answer: {
          de: 'Bei Mod 160 und Sondermodellen.',
          en: 'On Mod 160 and special models.',
          cz: 'U Mod 160 a speciálních modelů.',
          sk: 'Pri Mod 160 a špeciálnych modeloch.',
  ...
  cornerhinge: {
    introExpanded: {
      ...
      sk: 'Gannomat vŕtacie stroje na závesy (Expert, Twin) vytvárajú presné otvory pre nábytkové závesy všetkých bežných výrobcov (Blum, Hettich, Grass, Salice). Vŕtajú misku, otvory pre skrutky a značky v jedinej vŕtacej operácii — rýchlejšie a presnejšie než ručné označovanie a jednotlivé vŕtanie. Expert je štandardný model pre stolárstva a stredné prevádzky, Twin ponúka dve pracovné stanice pre vyšší prietok. Pre výrobcov kuchýň, výrobu dverí a nábytkárske prevádzky s pravidelnou výrobou frontov sú tieto stroje nepostrádateľné. Asamer dodáva vŕtacie stroje na závesy pre CZ, SK a HU vrátane poradenstva k typom závesov.',
    ...
    sections: [
      {
        heading: { de: 'Expert vs. Twin', en: 'Expert vs. Twin', cz: 'Expert vs. Twin', sk: 'Expert vs. Twin', hu: 'Expert vs. Twin' },
        body: {
          ...
          sk: 'Expert: jedna pracovná stanica, ideálna pre stolárstvo a stredný prietok. Twin: dve pracovné stanice paralelne, dvojnásobný prietok — pre priemyselnú výrobu frontov.',
    ...
    faq: [
      {
        question: { de: 'Welche Scharniertypen?', en: 'Which hinge types?', cz: 'Jaké typy závěsů?', sk: 'Aké typy závesov?', hu: 'Milyen pánttípusok?' },
        answer: {
          ...
          sk: 'Blum, Hettich, Grass, Salice, GTV, Häfele — všetky bežné.',
          hu: 'Blum, Hettich, Grass, Salice, GTV, Häfele — minden szokásos.',
        },
      },
      {
        question: { de: 'Topfdurchmesser?', en: 'Cup diameters?', cz: 'Průměry misek?', sk: 'Priemery misiek?', hu: 'Tányérátmérők?' },
        answer: {
          ...
          sk: '26 mm a 35 mm štandard, iné na vyžiadanie.',
          hu: '26 mm és 35 mm szabvány, egyéb kérésre.',
        },
      },
      {
        question: { de: 'Automatische Positionierung?', en: 'Automatic positioning?', cz: 'Automatické polohování?', sk: 'Automatické polohovanie?', hu: 'Automatikus pozicionálás?' },
        answer: {
          ...
          sk: 'Mechanické dorazy, CNC pri špeciálnych modeloch.',
