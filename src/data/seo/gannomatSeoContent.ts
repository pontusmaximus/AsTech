    ...
    applicationSections: [
      {
        ...
        body: {
          ...
          sk: 'Výrobcovia s denným výstupom od 500 korpusov ťažia z plne automatickej priebežnej koncepcie. Linka beží v trojzmennej prevádzke, zatiaľ čo jednotlivé stanice sa prestavujú na stlačenie tlačidla. Napojenie na ERP dodáva výrobné zákazky v reálnom čase.',
...
export const GANNOMAT_CATEGORY_SEO: Record<GannomatCategory, CategorySeoContent> = {
  ...
  boring: {
    ...
    sections: [
      {
        heading: { de: 'Dübelbohrmaschine vs. CNC-Maschine', en: 'Dowel drilling machine vs. CNC machine', cz: 'Kolkovací vrtací stroj vs. CNC stroj', hu: 'Csapfúró gép vs. CNC gép' },
        body: {
          de: 'Dübelbohrmaschinen sind für Standardlochmuster optimiert — schneller und günstiger als CNC-Maschinen. Bei hoher Variantenzahl oder ungewöhnlichen Bohrbildern ist CNC die bessere Wahl.',
