...
export const GANNOMAT_PRODUCT_SEO: Record<string, ProductSeoContent> = {
  ...
  'selekta': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Serien-Korpusfertigung', en: 'For series carcass production', cz: 'Pro sériovou výrobu korpusu' },
        body: {
      ...
      {
        heading: { de: 'Für Zulieferbetriebe mit Losgröße-1', en: 'For supplier operations with batch-size-1', cz: 'Pro dodavatelské provozy s dávkou 1' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Dübeldurchmesser verarbeitet die Selekta?', en: 'What dowel diameters does the Selekta process?', cz: 'Jaké průměry kolíků Selekta zpracovává?' },
        answer: {
      ...
      {
        question: { de: 'Wie schnell ist der Formatwechsel?', en: 'How fast is format changeover?', cz: 'Jak rychlá je změna formátu?' },
        answer: {
      ...
      {
        question: { de: 'Gibt es ERP-Anbindung?', en: 'Is there ERP connection?', cz: 'Existuje napojení na ERP?' },
        answer: {
  ...
  'elite': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für mittlere Tischlereien', en: 'For mid-sized joinery shops', cz: 'Pro střední truhlárny' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Wie groß ist der Schulungsaufwand?', en: 'How much training is needed?', cz: 'Jaká je potřeba školení?' },
        answer: {
      ...
      {
        question: { de: 'Kann ich die Elite später auf die Selekta aufrüsten?', en: 'Can I upgrade the Elite to a Selekta later?', cz: 'Mohu Elite později upgradovat na Selekta?' },
        answer: {
      ...
      {
        question: { de: 'Wie ist der Service?', en: 'How is the service?', cz: 'Jaký je servis?' },
        answer: {
  ...
  'index-reihe-cnc': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Ready-to-Assemble-Fertigung', en: 'For ready-to-assemble production', cz: 'Pro výrobu ready-to-assemble' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Beschläge werden unterstützt?', en: 'Which fittings are supported?', cz: 'Jaká kování jsou podporována?' },
        answer: {
      ...
      {
        question: { de: 'Gibt es Programmiersoftware?', en: 'Is there programming software?', cz: 'Existuje programovací software?' },
        answer: {
      ...
      {
        question: { de: 'Ist die Maschine linienfähig?', en: 'Is the machine line-capable?', cz: 'Je stroj způsobilý pro linku?' },
        answer: {
  ...
  'express-s5': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle Serienproduktion', en: 'For industrial series production', cz: 'Pro průmyslovou sériovou výrobu' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Dübelabstände sind möglich?', en: 'What dowel spacings are possible?', cz: 'Jaké rozteče kolíků jsou možné?' },
        answer: {
      ...
      {
        question: { de: 'Benötigt die Maschine einen Bediener?', en: 'Does the machine need an operator?', cz: 'Potřebuje stroj obsluhu?' },
        answer: {
      ...
      {
        question: { de: 'Welche Dübelgrößen werden verarbeitet?', en: 'What dowel sizes are processed?', cz: 'Jaké velikosti kolíků se zpracovávají?' },
        answer: {
  ...
  'concept-primus': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für durchgängige Korpusfertigungslinie', en: 'For continuous carcass production line', cz: 'Pro průběžnou linku výroby korpusu' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Korpusgrößen werden gepresst?', en: 'What carcass sizes are pressed?', cz: 'Jaké velikosti korpusu se lisují?' },
        answer: {
      ...
      {
        question: { de: 'Wie lange ist der Pressvorgang?', en: 'How long is the pressing cycle?', cz: 'Jak dlouhý je lisovací cyklus?' },
        answer: {
      ...
      {
        question: { de: 'Kann die Presse in eine Linie integriert werden?', en: 'Can the press be integrated into a line?', cz: 'Lze lis integrovat do linky?' },
        answer: {
  ...
  'protec-profit': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für komplexe Werkstücke mit Fräs- und Bohrbearbeitung', en: 'For complex workpieces with milling and drilling', cz: 'Pro složité obrobky s frézováním a vrtáním' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Fräswerkzeuge werden unterstützt?', en: 'What milling tools are supported?', cz: 'Jaké frézovací nástroje jsou podporovány?' },
        answer: {
      ...
      {
        question: { de: 'CAD-Import möglich?', en: 'CAD import possible?', cz: 'Lze importovat CAD?' },
        answer: {
      ...
      {
        question: { de: 'Ist die Maschine staubfreundlich?', en: 'Is the machine dust-friendly?', cz: 'Je stroj prachově přívětivý?' },
        answer: {
  ...
  'db-21-27-35': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Standard-Korpusfertigung', en: 'For standard carcass production', cz: 'Pro standardní výrobu korpusu' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Lochabstände sind möglich?', en: 'What hole spacings are possible?', cz: 'Jaké rozteče otvorů jsou možné?' },
        answer: {
      ...
      {
        question: { de: 'Bohrtiefen verstellbar?', en: 'Drilling depths adjustable?', cz: 'Lze nastavit hloubku vrtání?' },
        answer: {
      ...
      {
        question: { de: 'Einzelspindel-Zuschaltung möglich?', en: 'Individual spindle switching possible?', cz: 'Lze zapínat jednotlivá vřetena?' },
        answer: {
  ...
  'vantage': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle Großserienfertigung', en: 'For industrial large-series production', cz: 'Pro průmyslovou velkosériovou výrobu' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Wie lange dauert die Umrüstung?', en: 'How long does changeover take?', cz: 'Jak dlouho trvá přestavení?' },
        answer: {
      ...
      {
        question: { de: 'Wie viele Spindeln sind sinnvoll?', en: 'How many spindles make sense?', cz: 'Kolik vřeten má smysl?' },
        answer: {
      ...
      {
        question: { de: 'Werkstückzuführung automatisch?', en: 'Automatic workpiece feeding?', cz: 'Automatické podávání obrobku?' },
        answer: {
  ...
  'expert': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Küchenfertigung', en: 'For kitchen production', cz: 'Pro výrobu kuchyní' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Scharniertypen werden unterstützt?', en: 'Which hinge types are supported?', cz: 'Jaké typy závěsů jsou podporovány?' },
        answer: {
      ...
      {
        question: { de: 'Topfgrößen?', en: 'Cup sizes?', cz: 'Velikosti misek?' },
        answer: {
      ...
      {
        question: { de: 'Ist die Maschine CNC-gesteuert?', en: 'Is the machine CNC-controlled?', cz: 'Je stroj řízen CNC?' },
        answer: {
  ...
  'leimfix': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für konsistente Leimfugen', en: 'For consistent glue joints', cz: 'Pro konzistentní lepené spoje' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Klebstoffe werden verarbeitet?', en: 'What adhesives are processed?', cz: 'Jaká lepidla se zpracovávají?' },
        answer: {
      ...
      {
        question: { de: 'Dosiermenge einstellbar?', en: 'Is metering adjustable?', cz: 'Lze nastavit dávkování?' },
        answer: {
      ...
      {
        question: { de: 'Reinigungsaufwand?', en: 'Cleaning effort?', cz: 'Nároky na čištění?' },
        answer: {
  ...
  'master-325': {
    ...
    applicationSections: [
      {
        heading: { de: 'Für Türrahmen- und Fensterrahmenfertigung', en: 'For door and window frame production', cz: 'Pro výrobu dveřních a okenních rámů' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Rahmengrößen sind möglich?', en: 'What frame sizes are possible?', cz: 'Jaké velikosti rámů jsou možné?' },
        answer: {
      ...
      {
        question: { de: 'Massive oder beschichtete Rahmen?', en: 'Solid or coated frames?', cz: 'Masivní nebo povrstvené rámy?' },
        answer: {
      ...
      {
        question: { de: 'Bohrstellen frei programmierbar?', en: 'Drilling positions freely programmable?', cz: 'Jsou pozice vrtání volně programovatelné?' },
        answer: {
...
export const GANNOMAT_CATEGORY_SEO: Record<GannomatCategory, CategorySeoContent> = {
  insertion: {
    ...
    sections: [
      {
        heading: { de: 'Halbautomatisch vs. vollautomatisch', en: 'Semi-automatic vs. fully automatic', cz: 'Poloautomatické vs. plně automatické' },
        body: {
      ...
      {
        heading: { de: 'Beschlagsetzen zusätzlich zu Dübeln', en: 'Fitting insertion in addition to dowels', cz: 'Vsazování kování dodatečně ke kolíkům' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Maschine passt zu welchem Betrieb?', en: 'Which machine fits which operation?', cz: 'Který stroj se hodí pro jaký provoz?' },
        answer: {
      ...
      {
        question: { de: 'Gibt es Finanzierungsmöglichkeiten?', en: 'Are there financing options?', cz: 'Existují možnosti financování?' },
        answer: {
      ...
      {
        question: { de: 'Welche Lieferzeit ist typisch?', en: 'What is the typical delivery time?', cz: 'Jaká je typická dodací lhůta?' },
        answer: {
  ...
  insertion_door: {
    ...
    sections: [
      {
        heading: { de: 'Holz, Aluminium, Kunststoff', en: 'Wood, aluminium, plastic', cz: 'Dřevo, hliník, plast' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Passen die HD-Maschinen zu österreichischen und deutschen Rahmenstandards?', en: 'Do HD machines fit Austrian and German frame standards?', cz: 'Odpovídají HD stroje rakouským a německým rámovým standardům?' },
        answer: {
      ...
      {
        question: { de: 'Kann die Selekta HD in eine Fertigungslinie eingebunden werden?', en: 'Can the Selekta HD be integrated into a production line?', cz: 'Lze Selekta HD zapojit do výrobní linky?' },
        answer: {
  ...
  machining: {
    ...
    sections: [
      {
        heading: { de: 'CNC-Bearbeitungszentrum vs. Einzelmaschinen', en: 'CNC machining centre vs. individual machines', cz: 'CNC obráběcí centrum vs. jednotlivé stroje' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Wie gestaltet sich die Programmierung?', en: 'How is programming handled?', cz: 'Jak probíhá programování?' },
        answer: {
      ...
      {
        question: { de: 'Werkzeugmanagement?', en: 'Tool management?', cz: 'Správa nástrojů?' },
        answer: {
      ...
      {
        question: { de: 'Staubabsaugung integriert?', en: 'Dust extraction integrated?', cz: 'Je odsávání prachu integrováno?' },
        answer: {
  ...
  fitting: {
    ...
    sections: [
      {
        heading: { de: 'Welche Spindelzahl ist richtig?', en: 'Which spindle count is right?', cz: 'Který počet vřeten je správný?' },
        body: {
      ...
      {
        heading: { de: 'RTA vs. Standard-Dübelsetzmaschine', en: 'RTA vs. standard dowel insertion machine', cz: 'RTA vs. standardní stroj pro vsazování kolíků' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Dübelgrößen?', en: 'Which dowel sizes?', cz: 'Jaké velikosti kolíků?' },
        answer: {
      ...
      {
        question: { de: 'Pneumatikbedarf?', en: 'Pneumatic requirements?', cz: 'Požadavky na pneumatiku?' },
        answer: {
      ...
      {
        question: { de: 'Wie schnell ist der Modellwechsel?', en: 'How fast is model changeover?', cz: 'Jak rychlá je změna modelu?' },
        answer: {
  ...
  carcass: {
    ...
    sections: [
      {
        heading: { de: 'Concept Easy / Eco / Primus — Auswahlhilfe', en: 'Concept Easy / Eco / Primus — selection guide', cz: 'Concept Easy / Eco / Primus — pomůcka při výběru' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Korpusgrößen?', en: 'What carcass sizes?', cz: 'Jaké velikosti korpusu?' },
        answer: {
      ...
      {
        question: { de: 'Presszeit?', en: 'Pressing time?', cz: 'Doba lisování?' },
        answer: {
      ...
      {
        question: { de: 'Linienintegration?', en: 'Line integration?', cz: 'Integrace do linky?' },
        answer: {
  ...
  boring: {
    ...
    sections: [
      {
        heading: { de: 'Kolkovaci-Bohrmaschine vs. CNC-Maschine', en: 'Dowel drilling machine vs. CNC machine', cz: 'Kolkovací vrtací stroj vs. CNC stroj' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Was heißt WA?', en: 'What does WA mean?', cz: 'Co znamená WA?' },
        answer: {
      ...
      {
        question: { de: 'Bohrtiefenanschläge?', en: 'Depth stops?', cz: 'Hloubkové dorazy?' },
        answer: {
      ...
      {
        question: { de: 'Werkzeugwechsel?', en: 'Tool change?', cz: 'Výměna nástrojů?' },
        answer: {
  ...
  rowboring: {
    ...
    sections: [
      {
        heading: { de: 'Wann lohnt sich eine Reihenbohrmaschine?', en: 'When does a row drilling machine pay off?', cz: 'Kdy se vyplatí řadový vrtací stroj?' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Umrüstzeit?', en: 'Changeover time?', cz: 'Doba přestavení?' },
        answer: {
      ...
      {
        question: { de: 'Welche Spindelzahl für meinen Betrieb?', en: 'Which spindle count for my operation?', cz: 'Jaký počet vřeten pro můj provoz?' },
        answer: {
      ...
      {
        question: { de: 'Automatische Werkstückzuführung?', en: 'Automatic workpiece feeding?', cz: 'Automatické podávání obrobku?' },
        answer: {
  ...
  gluing: {
    ...
    sections: [
      {
        heading: { de: 'Leimfix vs. Injecta', en: 'Leimfix vs. Injecta', cz: 'Leimfix vs. Injecta' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Klebstoffe sind kompatibel?', en: 'Which adhesives are compatible?', cz: 'Jaká lepidla jsou kompatibilní?' },
        answer: {
      ...
      {
        question: { de: 'Nachrüstung an bestehenden Maschinen?', en: 'Retrofit to existing machines?', cz: 'Dovybavení stávajících strojů?' },
        answer: {
  ...
  frame: {
    ...
    sections: [
      {
        heading: { de: 'Junior 323 vs. Master 325 vs. Mod 160', en: 'Junior 323 vs. Master 325 vs. Mod 160', cz: 'Junior 323 vs. Master 325 vs. Mod 160' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Rahmenmaterialien?', en: 'Which frame materials?', cz: 'Jaké materiály rámů?' },
        answer: {
      ...
      {
        question: { de: 'Werkstückgrößen?', en: 'Workpiece sizes?', cz: 'Velikosti obrobků?' },
        answer: {
      ...
      {
        question: { de: 'CNC-Steuerung verfügbar?', en: 'CNC control available?', cz: 'Je k dispozici CNC řízení?' },
        answer: {
  ...
  cornerhinge: {
    ...
    sections: [
      {
        heading: { de: 'Expert vs. Twin', en: 'Expert vs. Twin', cz: 'Expert vs. Twin' },
        body: {
    ...
    faq: [
      {
        question: { de: 'Welche Scharniertypen?', en: 'Which hinge types?', cz: 'Jaké typy závěsů?' },
        answer: {
      ...
      {
        question: { de: 'Topfdurchmesser?', en: 'Cup diameters?', cz: 'Průměry misek?' },
        answer: {
      ...
      {
        question: { de: 'Automatische Positionierung?', en: 'Automatic positioning?', cz: 'Automatické polohování?' },
        answer: {
