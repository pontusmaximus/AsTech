...
export const BARBARIC_PRODUCT_SEO: Record<string, ProductSeoContent> = {
  ...
  'csf-professional': {
    longDescription: {
      ...
      sk: 'Barbaric CSF Professional je plne automatický sklad dosiek pre stolárstvo, výrobcov nábytku a stredne veľkých spracovateľov dreva. Zabezpečuje celkové riadenie doskového materiálu: od príjmu tovaru cez triedenie alebo chaotické skladovanie až po dodávku na formátovaciu pílu alebo CNC podľa potreby. Integrovaná otočná jednotka 90° (voliteľne 180°) eliminuje náročné prekladanie, bočná vzdialenosť púhych 100 mm robí zariadenie mimoriadne úsporným na priestor. Typická návratnosť je jeden až dva roky vďaka odstráneniu manuálnej prepravy, lepšiemu prehľadu o materiáli a možnosti pracovať v pickovacom režime aj bez píly. Asamer dodáva CSF Professional ako autorizovaný predajca Barbaric pre Českú republiku, Slovensko a Maďarsko — vrátane projektovania rozvrhnutia, prepojenia s ERP, inštalácie a miestneho servisu.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für Tischlereien mit begrenzter Hallenfläche', en: 'For joinery shops with limited floor space', cz: 'Pro truhlárny s omezenou plochou haly',
        sk: 'Pre stolárske dielne s obmedzenou plochou haly', hu: 'Korlátozott csarnokterületű asztalosműhelyek számára' },
        body: {
          ...
          sk: 'Bočná vzdialenosť púhych 100 mm umožňuje umiestnenie priamo pri stenách a v úzkych halových úsekoch. Tým je CSF Professional vhodný aj pre existujúce budovy, kde rozšírenie výrobnej plochy nie je možné. Sklad možno postupne rozširovať, ako objem materiálu rastie.',
      ...
      {
        heading: { de: 'Für Pickbetrieb ohne Säge', en: 'For picking operation without saw', cz: 'Pro pickovací provoz bez pily',
        sk: 'Pre pickovaciu prevádzku bez píly', hu: 'Fűrész nélküli pick üzemmódhoz' },
        body: {
          ...
          sk: 'CSF Professional funguje ako čisto pickovací sklad aj bez napojenej formátovacej píly. Dosky sa vyberajú zo skladu a pripravujú na expedíciu — ideálne pre obchodníkov s doskami alebo dodávateľov, ktorí musia dodávať polotovary just-in-time.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte CSF Professional, ak hľadáte kompaktný a ekonomický sklad dosiek pre remeslá alebo stredne veľké prevádzky. Pre priemyselnú nepretržitú prevádzku s časom cyklu pod jednu minútu je vhodnejší CSF Industrial; pre veľmi vysoké zásoby vo viacerých úrovniach potrebujete CSF Multilevel.',
    ...
    faq: [
      {
        question: { de: 'Welche Flächen und Kapazitäten sind möglich?', en: 'What storage sizes and capacities are possible?', cz: 'Jaké plochy a kapacity jsou možné?',
        sk: 'Aké plochy a kapacity sú možné?', hu: 'Milyen területek és kapacitások lehetségesek?' },
        answer: {
          ...
          sk: 'CSF Professional je modulárne škálovateľný. Typické rozmery haly sa pohybujú od 8 × 15 m do 15 × 40 m, počet skladových miest závisí od formátu dosiek a výšky stohu. Individuálny projekt spracujeme po obhliadke vašej haly.',
      ...
      {
        question: { de: 'Wie wird das Flächenlager an unsere Säge angebunden?', en: 'How is the panel storage connected to our saw?', cz: 'Jak se sklad napojí na naši pilu?',
        sk: 'Ako sa sklad napojí na našu pílu?', hu: 'Hogyan csatlakozik a lapraktár a fűrészünkhöz?' },
        answer: {
          ...
          sk: 'Napojenie sa realizuje odovzdávacou stanicou s nájazdovými valčekmi alebo priečnym stolom. Pri pílach Mayer, Schelling alebo Holzma používame štandardizované protokoly; pri starších strojoch riešime prepojenie cez signály PLC. Programovanie zabezpečuje náš softvérový tím.',
      ...
      {
        question: { de: 'Wie schnell rechnet sich die Investition?', en: 'How quickly does the investment pay off?', cz: 'Za jak dlouho se investice vrátí?',
        sk: 'Za ako dlho sa investícia vráti?', hu: 'Milyen gyorsan térül meg a beruházás?' },
        answer: {
          ...
          sk: 'Typická návratnosť je jeden až dva roky. Hlavné úspory: odstránenie manuálnej prepravy, menej pracovníkov v sklade, menej poškodení dosiek a lepší prehľad o materiáli vďaka digitálnej evidencii. Výpočet ROI pripravíme na základe vašich súčasných výrobných čísel.',
  ...
  'csf-industrial': {
    longDescription: {
      ...
      sk: 'Barbaric CSF Industrial je vysoko priemyselný sklad dosiek pre nepretržitú prevádzku vo veľkých nábytkárskych závodoch, dodávateľských prevádzkach a u spracovateľov dosiek. Rýchlosti pojazdu do 150 m/min a časy cyklu pod jednu minútu umožňujú súvislý tok materiálu k viacerým formátovacím pílam alebo CNC centrám súčasne. Žeriavový most dosahuje rozpätie až 25 metrov, skladovacia plocha až 25 × 70 metrov — s niekoľkými tisíckami skladových miest podľa výšky stohu. Reťazové a pásové dopravníky možno priamo integrovať, rovnako ako chaotické skladovanie, viacnásobnú manipuláciu s doskami a triedenie podľa druhu. CSF Industrial nasadzujú renomované priemyselné podniky po celom svete. Asamer realizuje priemyselné projekty pre zákazníkov v CZ, SK a HU vrátane generálneho projektovania, napojenia na ERP/MES a dlhodobých servisných zmlúv.',
    ...
    applicationSections: [
      {
        heading: { de: 'Für industrielle Möbelproduktion', en: 'For industrial furniture production', cz: 'Pro průmyslovou výrobu nábytku',
        sk: 'Pre priemyselnú výrobu nábytku', hu: 'Ipari bútorgyártáshoz' },
        body: {
          ...
          cz: 'CSF Industrial zásobuje vícesměnné výrobní linky deskovým materiálem. Několik výdejních míst lze obsluhovat paralelně; priorizace probíhá podle ERP řízeného pořadí zakázek. Ideální pro výrobce kuchyní, kancelářského nábytku nebo matrací s několika tisíci pohyby desek za směnu.',
          sk: 'CSF Industrial zásobuje viaczmenné výrobné linky doskovým materiálom. Viacero výdajných miest možno obsluhovať paralelne; prioritizácia prebieha podľa ERP riadeného poradia zákaziek. Ideálne pre výrobcov kuchýň, kancelárskeho nábytku alebo matracov s niekoľkými tisíckami pohybov dosiek za zmenu.',
      ...
      {
        heading: { de: 'Für Plattenveredler und Lohnfertiger', en: 'For panel finishers and contract manufacturers', cz: 'Pro zpracovatele desek a zakázkové výrobce',
        sk: 'Pre spracovateľov dosiek a zákazkových výrobcov', hu: 'Laplemezfeldolgozók és bérgyártók számára' },
        body: {
          ...
          sk: 'Zákazkoví výrobcovia s rôznorodými doskovými položkami majú obzvlášť prospech z princípu chaotického skladovania: každá doska dostane digitálne miesto nezávislé od druhu alebo dekoru. Tým sa optimálne využije skladová plocha a vylučujú sa zámeny materiálu.',
    ...
    buyingAdvice: {
      ...
      sk: 'CSF Industrial je prvou voľbou pre priemyselné nepretržité prevádzky s vysokým obratom materiálu a ERP integráciou. Ak váš objem materiálu presahuje niekoľko tisíc pohybov dosiek týždenne, tejto systémovej triede sa prakticky nedá vyhnúť. Pre menšie prevádzky je ekonomickejší CSF Professional.',
    ...
    faq: [
      {
        ...
        sk: 'Koľko formátovacích píl môže CSF Industrial zásobovať súčasne?', hu: 'Hány lapszabászgépet tud a CSF Industrial egyszerre kiszolgálni?' },
        answer: {
          ...
          sk: 'Podľa rozvrhnutia haly a požiadaviek na čas taktu môže CSF Industrial zásobovať dve až štyri formátovacie píly paralelne. Napojenie prebieha reťazovými alebo pásovými dopravníkmi s inteligentným riadením, ktoré prideľuje priority podľa stavu zákaziek.',
      ...
      },
      {
        ...
        sk: 'Je podporované chaotické skladovanie?', hu: 'Támogatott a kaotikus tárolás?' },
        answer: {
          ...
          sk: 'Áno — chaotické skladovanie je základným princípom CSF Industrial. Každá doska sa pri zaskladnení zmeria a získa digitálne miesto bez obmedzenia druhu. Tým sa zvyšuje využitie priestoru až o 30 % oproti triedeniu podľa druhu.',
      ...
      },
      {
        ...
        sk: 'Ako sa realizuje napojenie na ERP?', hu: 'Hogyan valósul meg az ERP integráció?' },
        answer: {
          ...
          sk: 'Napojenie na SAP, Navision, Infor alebo individuálne ERP systémy sa realizuje cez štandardizované rozhrania (OPC-UA, REST API, XML výmena). Softvérový tím Asamer programuje integráciu a zabezpečuje aj údržbu pri aktualizáciách vášho ERP systému.',
  ...
  'lcv-performance': {
    longDescription: {
      ...
      sk: 'Barbaric LCV Performance je nesting picker, ktorý odoberá hotové vyrezané diely z nesting CNC, separuje ich a stohuje podľa zákaziek. Systém odstraňuje manuálny odber zo zostavy dosiek, znižuje personálne nároky pri CNC a zaisťuje bezchybný tok materiálu k olepovačke hrán alebo lakovacej linke. LCV Performance rozpoznáva diely kamerovým systémom a prenosom dát z CNC, uchopuje ich vákuovými prísavkami s milimetrovou presnosťou a ukladá ich na správnu paletu alebo nadväzujúcu dopravu. Pre nábytkárske prevádzky s nesting výrobou je LCV Performance kľúčom k priebežnej výrobe dielov bez manuálnych medzikrokov. Asamer realizuje projekty nesting automatizácie pre CZ, SK a HU vrátane koordinácie s vaším existujúcim CNC.',
    ...
    applicationSections: [
      {
        ...
        sk: 'Pre automatizované nesting bunky', hu: 'Automatizált nesting cellákhoz' },
        body: {
          ...
          sk: 'V nesting bunke sa doskový materiál reže priamo na CNC na všetky potrebné diely. LCV Performance odoberá vyrezané diely ihneď, takže CNC môže začať ďalší rezný plán. To výrazne zvyšuje čistú produkciu oproti manuálnemu odberu dielov.',
      ...
      },
      {
        ...
        sk: 'Pre výrobu dávky 1', hu: '1-es darabszámú gyártáshoz' },
        body: {
          ...
          sk: 'Pri výrobe dávky 1 (každý diel unikát) je manuálne triedenie dielov obzvlášť chybové. LCV Performance automaticky priradí každý diel správnej zákazke a stohuje podľa zákaziek — tovar prichádza predtriedený k olepovačke hrán alebo lakovacej linke.',
    ...
    buyingAdvice: {
      ...
      sk: 'LCV Performance sa vyplatí, len čo prevádzkujete nesting CNC v nepretržitom režime a musíte tam viazať aspoň jednu osobu na odber a triedenie dielov. Návratnosť typicky 18–30 mesiacov vďaka úspore personálu a vyššej priechodnosti CNC.',
    ...
    faq: [
      {
        ...
        sk: 'Aké nesting CNC LCV Performance podporuje?', hu: 'Milyen nesting CNC-ket támogat az LCV Performance?' },
        answer: {
          ...
          sk: 'LCV Performance možno prepojiť s bežnými nesting CNC od Homag, Biesse, SCM, IMA alebo Felder. Prenos dát prebieha cez XML export alebo priame PLC rozhranie. Asamer overí kompatibilitu s vaším existujúcim strojom v predbežnej konzultácii.',
      ...
      },
      {
        ...
        sk: 'Aké malé môžu byť diely?', hu: 'Milyen kicsik lehetnek a darabok?' },
        answer: {
          ...
          sk: 'Typická minimálna veľkosť na odber dielov je 80 × 80 mm. Menšie diely možno realizovať cez špeciálne aplikácie s prispôsobenými prísavkovými úchopmi — Asamer to koordinuje pri projektovaní s Barbaric.',
      ...
      },
      {
        ...
        sk: 'Koľko zákaziek môže LCV stohovať paralelne?', hu: 'Hány rendelést tud az LCV párhuzamosan kötegelni?' },
        answer: {
          ...
          sk: 'Podľa konfigurácie až 20 paralelných stohov zákaziek. Ak to nestačí, možno predradiť pufrovací dopravník, ktorý odváža hotové stohy a vytvára miesto pre ďalšie zákazky.',
  ...
  'rts-professional': {
    longDescription: {
      ...
      sk: 'Barbaric RTS Professional je návratový systém pre olepovačky hrán, ktorý automaticky vracia hotové obrobky k obsluhe stroja. Namiesto toho, aby sa diely obnášali okolo stroja, RTS preberá celú návratovú trasu — obsluha môže čas, ktorý by inak strávila chôdzou, investovať do prípravy ďalšej zákazky. RTS Professional spracúva obrobky bežných nábytkových rozmerov pri rýchlostiach posuvu zodpovedajúcich olepovačke hrán. Pre stolárstvo a stredne veľkých výrobcov nábytku, ktorí chcú vyťažiť viac z existujúcej olepovačky hrán, je RTS Professional ekonomické dovybavenie. Asamer plánuje, dodáva a montuje RTS ako autorizovaný predajca Barbaric pre CZ, SK a HU.',
    ...
    applicationSections: [
      {
        ...
        sk: 'Pre jedného pracovníka pri olepovačke', hu: 'Élzárógép egyszemélyes kezeléséhez' },
        body: {
          ...
          sk: 'Bez návratu potrebuje olepovačka hrán zvyčajne dvoch pracovníkov — jeden zakladá, druhý odoberá. S RTS Professional sa obrobok vracia automaticky, takže jeden pracovník zvládne celý proces. Uvoľnená pracovná sila môže prevziať iné úlohy.',
      ...
      },
      {
        ...
        sk: 'Pre stredné série s málo prestaveniami', hu: 'Kevés átállással dolgozó közepes sorozatokhoz' },
        body: {
          ...
          sk: 'RTS Professional je ekonomický od stredných denných prietokov niekoľko sto dielov. Pri tejto veľkosti prevádzky sa automatizácia rýchlo vyplatí vďaka odľahčeniu personálu. Pri veľmi malých kusoch alebo častom prestavovaní stačí manuálna prevádzka.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte RTS Professional pre typické požiadavky stolárstva a stredne veľkých prevádzok. Pre priemyselnú nepretržitú prevádzku s vysokými taktmi je vhodnejší RTS Industrial. Veľmi kompaktné prevádzky alebo mobilné aplikácie pokrýva RTS Compact.',
    ...
    faq: [
      {
        ...
        sk: 'Hodí sa RTS k mojej existujúcej olepovačke?', hu: 'Illik az RTS a meglévő élzárógépemhez?' },
        answer: {
          ...
          sk: 'RTS Professional sa hodí k olepovačkám hrán rôznych výrobcov (OTT, Homag, Felder, Biesse, SCM atď.). Rozhranie sa navrhuje individuálne pri projektovaní. Asamer overuje kompatibilitu vopred.',
      ...
      },
      {
        ...
        sk: 'Aké sú priestorové nároky?', hu: 'Mekkora a helyigény?' },
        answer: {
          ...
          sk: 'Typicky 2–3 m dĺžky návratu plus vlastná dĺžka olepovačky hrán. Pri usporiadaní do L alebo U možno priestorové nároky optimalizovať. Presné rozmery vyplývajú z rozvrhnutia haly.',
      ...
      },
      {
        ...
        sk: 'Vyplatí sa mi RTS?', hu: 'Megtérül-e az RTS az üzememben?' },
        answer: {
          ...
          cz: 'Při středním průtoku a dvousměnném provozu se RTS vrátí za 12–24 měsíců díky odlehčení personálu. Asamer rád spočítá ROI s vašimi výrobními čísly.',
          sk: 'Pri strednom prietoku a dvojzmennej prevádzke sa RTS vráti za 12–24 mesiacov vďaka odľahčeniu personálu. Asamer rád spočíta ROI s vašimi výrobnými číslami.',
  ...
  'uwl-3': {
    longDescription: {
      ...
      sk: 'Barbaric UWL-3 je vákuový zdvihák na ergonomickú manipuláciu s veľkými doskovými materiálmi vo výrobe dreva a nábytku. Berie dosky, dvere alebo pracovné dosky bezpečne vákuom a umožňuje milimetrovú polohovaciu presnosť — bez nutnosti, aby obsluha presúvala obrobok rukou. To chráni zamestnancov pred preťažením chrbta, znižuje počet dní práceneschopnosti a predchádza poškodeniu dosiek pádom. UWL-3 pracuje s integrovaným vákuovým čerpadlom, takže nie je potrebné externé zásobovanie stlačeným vzduchom. Pre stolárstvo, nábytkárske závody a skladovú logistiku je UWL-3 osvedčeným štandardným riešením vo vákuovej manipulácii. Asamer dodáva a servisuje Barbaric vákuové zdviháky pre CZ, SK a HU vrátane bezpečnostných kontrol podľa DGUV.',
    ...
    applicationSections: [
      {
        ...
        sk: 'Pre príjem tovaru a skladovú logistiku', hu: 'Áruátvételhez és raktárlogisztikához' },
        body: {
          ...
          sk: 'Pri vykladaní nákladných vozidiel alebo stohovaní doskového materiálu nahrádza UWL-3 manuálne zdvíhanie bezpečným, kontrolovaným vákuovým úchopom. Veľké formáty a ťažké dosky môže presúvať jedna osoba, ktorá inak vyžaduje dvoch alebo troch pracovníkov.',
      ...
      },
      {
        ...
        sk: 'Pre zakladanie formátovacej píly a CNC', hu: 'Lapszabászgép és CNC betöltéséhez' },
        body: {
          ...
          sk: 'Pri formátovacej píle alebo CNC pracovnom stole zrýchľuje UWL-3 zakladanie dosiek a zaisťuje presné polohovanie. Obrobok možno umiestniť bez manuálneho posúvania — zásadné pri veľkých formátoch alebo potiahnutých povrchoch, ktoré sa nesmú poškriabať.',
    ...
    buyingAdvice: {
      ...
      sk: 'UWL-3 je osvedčený štandardný model — vhodný pre väčšinu stolárskych a nábytkárskych prevádzok s klasickou manipuláciou s doskami. Pre obzvlášť tenké alebo porézne dosky potrebujete špeciálne prísavky (UWL-3S), pre veľmi ťažké bremená UWL-5. Pri potiahnutých doskách s olejovým finišom Asamer rieši saciu techniku individuálne.',
    ...
    faq: [
      {
        question: { de: 'Welche Lasten kann der UWL-3 heben?', en: 'What loads can the UWL-3 lift?', cz: 'Jaká břemena UWL-3 uzvedne?',
        sk: 'Aké bremená UWL-3 uzdvihne?', hu: 'Milyen terheket tud az UWL-3 emelni?' },
        answer: {
          ...
          sk: 'UWL-3 je dimenzovaný na typické zaťaženia dosiek do niekoľkých sto kilogramov. Presná nosnosť závisí od povrchu dosky a konfigurácie prísavkových úchopov. Asamer spočíta vhodnú konfiguráciu v predbežnej konzultácii.',
      ...
      },
      {
        ...
        sk: 'Aký bezpečný je UWL-3 pri výpadku prúdu?', hu: 'Mennyire biztonságos az UWL-3 áramkimaradás esetén?' },
        answer: {
          ...
          sk: 'UWL-3 drží vákuum po výpadku prúdu niekoľko minút cez pufor — dostatočne dlho na bezpečné odloženie bremena. Navyše sú k dispozícii optické a akustické upozornenia pri strate vákua.',
      ...
      },
      {
        ...
        sk: 'Je nutná bezpečnostná kontrola?', hu: 'Szükséges-e biztonsági felülvizsgálat?' },
        answer: {
          ...
          sk: 'Áno — vákuové zdviháky podliehajú v Nemecku/Rakúsku/Českej republike každoročnej bezpečnostnej kontrole podľa DGUV. Asamer ponúka túto kontrolu ako súčasť údržbového balíka.',
  ...
  'ssk-saeulenschwenkkran': {
    longDescription: {
      ...
      sk: 'Barbaric SSK stĺpový otočný žeriav je stacionárny vákuový žeriav na pravidelnú manipuláciu s ťažkými doskovými materiálmi vo výrobe dreva a nábytku. Kombinuje otočné rameno s osvedčeným vákuovým systémom Barbaric a zvyčajne pokrýva polkruh s polomerom niekoľkých metrov — ideálne na zakladanie formátovacej píly, CNC pracovného stola alebo skladovej plochy. Obsluha vedie bremeno bezkontaktne a môže presne polohovať ťažké dosky jednou rukou. Stĺpové otočné žeriavy sú cenovo dostupnou alternatívou k plne automatickým skladom dosiek, ak sú potrebné pravidelné jednotlivé pohyby namiesto súvislého zásobovania materiálom. Asamer projektuje systémy SSK pre stolárstvo v CZ, SK a HU vrátane návrhu základov a bezpečnostného schválenia.',
    ...
    applicationSections: [
      {
        ...
        sk: 'Pre stolárske dielne s rôznymi formátmi', hu: 'Változó formátumokkal dolgozó asztalosműhelyeknek' },
        body: {
          ...
          sk: 'V stolárstvach pracujúcich s rôznymi formátmi dosiek je SSK ideálnym riešením: každú dosku možno pružne odobrať zo skladu a preniesť na pracovisko. Pre pevné toky materiálu sa skôr vyplatí dopravníkový systém.',
      ...
      },
      {
        ...
        sk: 'Pre pracoviská rezania a formátovania', hu: 'Szabászati és formázó munkaállomásokhoz' },
        body: {
          ...
          sk: 'Pri formátovacej píle, CNC alebo fréze polohuje SSK aj veľké formáty s milimetrovou presnosťou na pracovnom stole. Tým odpadajú zdvíhacie operácie, ktoré pri manuálnej manipulácii pravidelne spôsobujú bolesti chrbta.',
    ...
    buyingAdvice: {
      ...
      sk: 'Zvoľte SSK, ak na pevnom pracovisku pravidelne manipulujete s veľkými alebo ťažkými doskami. Na pokrytie celých hál sú stĺpové mosty (2D/3D) alebo koľajnicové systémy (SSY) správnym riešením.',
    ...
    faq: [
      {
        ...
        sk: 'Aký polomer je možný?', hu: 'Milyen sugár lehetséges?' },
        answer: {
          ...
          sk: 'Typické otočné polomery sú medzi 3 a 6 metrami. Väčšie vyhotovenia sú k dispozícii na požiadanie, ale vyžadujú zodpovedajúco dimenzované základy.',
      ...
      },
      {
        ...
        sk: 'Potrebujeme špeciálny základ?', hu: 'Szükséges-e speciális alap?' },
        answer: {
          ...
          sk: 'Áno — stĺp žeriava potrebuje železobetónový základ zodpovedajúci nosnému a ohybovému namáhaniu. Asamer vypracuje projekt základu a koordinuje ho s vaším stavebným projektantom.',
      ...
      },
      {
        ...
        sk: 'Dá sa SSK otáčať elektricky?', hu: 'Elektromosan forgatható az SSK?' },
        answer: {
          ...
          sk: 'Štandardný SSK sa otáča ručne — bremeno je pritom odľahčené. Elektromotorické otáčanie je dostupné ako voľba a odporúča sa pri veľmi veľkých polomeroch alebo ťažkých bremenách.',
  ...
  'nst': {
    ...
    buyingAdvice: {
      ...
      cz: 'NST je ekonomickou volbou, pokud svou nesting CNC dosud vykládáte ručně a pracujete s denním výkonem pod 200 nesting cyklů. Při vyšším průtoku nebo vícesměnném provozu je LCV Performance dlouhodobě lepší investicí. Asamer vám poradí, který systém odpovídá velikosti vaší výroby.',
  ...
  'rts-compact': {
    ...
    buyingAdvice: {
      ...
      cz: 'Zvolte RTS Compact, pokud provozujete malý provoz do přibližně 200 dílů denně nebo máte velmi málo místa v hale. Pro střední průtok je správnou volbou RTS Professional; pro průmyslové olepovačky ve vícesměnném provozu RTS Industrial. Asamer vám na místě ukáže, která varianta odpovídá vašim podmínkám.',
  ...
  'rts-industrial': {
    longDescription: {
      ...
      cz: `Barbaric RTS Industrial je vysoce výkonný návratový systém pro průmyslový nepřetržitý provoz u rychlých olepovaček hran. Je navržen pro vícesměnné výroby v nábytkářských závodech, výrobě stavebních prvků nebo u velkých dodavatelů — s rychlostmi posuvu do 60 m/min a dobami cyklu schopnými držet krok s nejnáročnějšími olepovačkami. RTS Industrial nejen vrací obrobky zpět, ale volitelně je třídí podle zakázek, ukládá na pufry nebo předává přímo navazujícím strojům, jako jsou vrtací automaty nebo lakovací linky. Robustní konstrukce je navržena na roky nepřetržité výroby; intervaly údržby jsou 2000 provozních hodin. Pro průmyslové výrobce nábytku je RTS Industrial standardem; Asamer realizuje projekty v CZ, SK a HU — včetně PLC integrace, ERP propojení a servisní smlouvy s reakčními dobami pod 24 hodin.`,
    ...
    buyingAdvice: {
      ...
      cz: 'RTS Industrial je správnou volbou pro všechny provozy s vícesměnnou výrobou a rychlými olepovačkami. Pokud denně olepujete několik tisíc dílů a prostoje vás ekonomicky bolí, vyplatí se robustní průmyslové provedení oproti Professional. Pro menší provozy pod 500 dílů denně stačí RTS Professional.',
  ...
  'tmp': {
    ...
    buyingAdvice: {
      ...
      cz: 'TMP je ekonomický vždy, když jsou dva nebo více strojů propojeny a jeden stroj má pravidelně krátké zastávky (výměna nástroje, doplňování, zásah obsluhy). Při vícesměnné výrobě se TMP obvykle vrátí během jednoho roku díky vyšší dostupnosti linky. Asamer vypočítá ROI na základě vašich dat o dostupnosti.',
  ...
  'drx': {
    ...
    applicationSections: [
      {
        ...
        body: {
          ...
          cz: 'Při zakládání dveřní lakovací linky musí být každé dveřní křídlo přesně položeno na dopravníkový řetěz — bez kontaktu s již lakovanou stranou. DRX uchopí dveře vakuově zespodu a přesně je odloží, aniž by došlo k dotyku horní strany.',
      ...
      },
      {
        ...
        body: {
          ...
          cz: 'V koncové montáži dveří a na balicí stanici DRX přivádí hotová dveřní křídla bezkontaktně do správné polohy. Tím chrání citlivé povrchy (lak, fólie, HPL) před škrábanci a tlakovými otlaky, které se při manuální manipulaci často objevují.',
    ...
    faq: [
      {
        question: { de: 'Welche Türgewichte kann der DRX heben?', en: 'What door weights can the DRX lift?', cz: 'Jaké hmotnosti dveří DRX uzvedne?', sk: 'Aké hmotnosti dverí DRX zdvihne?', hu: 'Milyen ajtósúlyokat tud a DRX emelni?' },
        answer: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          ...
          cz: 'LPS je dimenzován pro vícesměnný provoz a dosahuje typické dostupnosti nad 99 %. Standardní role etiket vystačí na několik hodin, výměna probíhá bez přerušení linky. Asamer nabízí servisní smlouvy s reakční dobou od 24 h v České republice, na Slovensku a v Maďarsku.',
...
export const BARBARIC_CATEGORY_SEO: Record<BarbaricCategory, CategorySeoContent> = {
  storage: {
    introExpanded: {
      ...
      sk: 'Barbaric sklady dosiek automatizujú skladovanie dosiek v drevospracujúcom a nábytkárskom priemysle. Princíp: namiesto manuálneho stohovania, hľadania a prenášania dosiek k píle preberá na strop montovaný žeriav s vákuovými prísavkami celý tok materiálu. Dosky sa skladujú chaoticky alebo podľa druhu, digitálne sa spravujú a dodávajú just-in-time k formátovacej píle alebo CNC obrábaciemu centru. To šetrí personál, znižuje poškodenia dosiek a zvyšuje využitie materiálu. Pre stolárstvo s obmedzeným rozpočtom je CSF Professional kompaktným vstupným riešením, CSF Industrial obsluhuje vysokovýkonné prevádzky s časom cyklu pod jednu minútu, CSF Multilevel ponúka viacpodlažné kapacity. Asamer projektuje a dodáva Barbaric sklady dosiek pre Českú republiku, Slovensko a Maďarsko — od návrhu rozvrhnutia cez napojenie na ERP až po sprevádzkovanie a servisnú zmluvu. Ekonomická analýza ukazuje: pri stredných až veľkých objemoch dosiek sa systém zvyčajne vyplatí za 12 až 24 mesiacov.',
    ...
    sections: [
      {
        ...
        sk: 'Chaotické vs. triedenie podľa druhu', hu: 'Kaotikus vs. fajtatiszta tárolás' },
        body: {
          ...
          sk: 'Chaotické skladovanie využíva plochy až o 30 % lepšie než triedenie podľa druhu: každá doska dostane pri zaskladnení digitálne miesto nezávislé od dekoru alebo čísla položky. Pri výbere sa požadovaná doska cielene vyhľadá v riadiacom systéme — žiadne hľadanie ani prekladanie.',
      ...
      },
      {
        ...
        sk: 'Integrácia ERP a tok materiálu', hu: 'ERP integráció és anyagáramlás' },
        body: {
          ...
          sk: 'Barbaric sklady dosiek sa bezproblémovo integrujú so SAP, Navision, proAlpha alebo individuálnymi ERP systémami cez OPC-UA, REST API alebo XML výmenu. Poradie zákaziek z ERP automaticky riadi prípravu materiálu; píla alebo CNC dostane presne tú správnu dosku v správnom čase.',
      ...
      },
      {
        ...
        sk: 'Ktorý model CSF je vhodný?', hu: 'Melyik CSF modell illik?' },
        body: {
          ...
          sk: 'CSF Professional: kompaktný, ekonomický, pre stolárske dielne a stredne veľké prevádzky. CSF Industrial: vysokovýkonný, integrovaný s ERP, pre priemyselné nepretržité prevádzky. CSF Multilevel: viacpodlažný, pre veľmi veľké zásoby na obmedzenej ploche. Špeciálne aplikácie: individuálne riešenia pre špeciálne materiály alebo rozvrhnutia.',
    ...
    faq: [
      {
        ...
        sk: 'Koľko stojí automatický sklad dosiek?', hu: 'Mennyibe kerül egy automatikus lapraktár?' },
        answer: {
          ...
          sk: 'Cena silne závisí od rozvrhnutia, skladovej kapacity a napojenia. Typické investičné rozpätie je medzi 150.000 a 500.000 EUR pre CSF Professional, vyššie pre Industrial a Multilevel. Asamer spracuje konkrétnu ponuku po obhliadke zariadenia.',
      ...
      },
      {
        ...
        sk: 'Ako dlho trvá inštalácia?', hu: 'Mennyi ideig tart a telepítés?' },
        answer: {
          ...
          sk: 'Podľa veľkosti: CSF Professional zvyčajne 2–4 týždne, CSF Industrial 6–12 týždňov. Prestavba výroby sa vykonáva vo fázach, takže bežná prevádzka je narušená len minimálne.',
      ...
      },
      {
        ...
        sk: 'Aká je údržba?', hu: 'Milyen karbantartási igény van?' },
        answer: {
          ...
          sk: 'Barbaric sklady dosiek vyžadujú málo údržby. Typická záťaž: polročná kontrola (koľajnice, prísavky, riadenie) a ročná bezpečnostná kontrola. Asamer ponúka servisné zmluvy s garantovanými reakčnými časmi pre CZ, SK a HU.',
  ...
  feeding: {
    introExpanded: {
      ...
      sk: 'Barbaric podávacie systémy automaticky dodávajú formátovacím pílam správny doskový materiál v správnom čase. Namiesto toho, aby obsluha ručne nosila každú dosku k píle a vkladala ju, preberá túto úlohu podávací systém — zvyčajne v kombinácii so skladom dosiek a správou zákaziek riadenou ERP. To šetrí personál pri stole píly, zabraňuje zámenám materiálu a zvyšuje čistú priechodnosť píly. Pre priemyselné rezacie prevádzky, ktoré chcú maximálne využiť svoju formátovaciu pílu, sú Barbaric podávacie systémy kľúčovou technológiou. Asamer plánuje integráciu do existujúcich alebo nových zariadení pre Českú republiku, Slovensko a Maďarsko — zladené s pílami od Mayer, Holzma, Schelling alebo iných výrobcov.',
    ...
    sections: [
      {
        ...
        sk: 'Kombinácia so skladom dosiek', hu: 'Kombináció lapraktárral' },
        body: {
          ...
          sk: 'Podávacie systémy pracujú najekonomickejšie v kombinácii so skladom dosiek Barbaric (rad CSF). Sklad drží zásobu dosiek, podávací systém realizuje triedenú dodávku k píle. Pri integrácii ERP obsluha píly vykonáva len vizuálnu kontrolu a triedenie odpadu ako manuálne úlohy.',
      ...
      },
      {
        ...
        sk: 'Zvýšenie priechodnosti automatickým podávaním', hu: 'Áteresztőképesség-nyereség automatikus betáplálással' },
        body: {
          ...
          cz: 'Ruční zakládání formátovací pily trvá podle formátu desky 30–90 sekund — dobu, kdy pila stojí. S podávacím systémem se tento čas zkrátí na několik sekund, čistá průchodnost obvykle vzroste o 15–30 %. Při dvousměnném provozu se zisk průchodnosti rychle projeví ve stovkách eur denně.',
          sk: 'Ručné zakladanie formátovacej píly trvá podľa formátu dosky 30–90 sekúnd — čas, keď píla stojí. S podávacím systémom sa tento čas skráti na niekoľko sekúnd, čistá priechodnosť zvyčajne vzrastie o 15–30 %. Pri dvojzmennej prevádzke sa zisk priechodnosti rýchlo prejaví v stovkách eur denne.',
    ...
    faq: [
      {
        ...
        sk: 'Aké formátovacie píly možno pripojiť?', hu: 'Milyen lapszabászgépek csatlakoztathatók?' },
        answer: {
          ...
          sk: 'Všetci významní výrobcovia: Mayer Kappa, Holzma HPP/HPS, Schelling FM/FH, Biesse Selco, SCM Sigma. Pri existujúcich strojoch Asamer skontroluje rozhranie vopred.',
      ...
      },
      {
        ...
        sk: 'Aké formáty dosiek sú podporované?', hu: 'Milyen lapformátumok támogatottak?' },
        answer: {
          ...
          sk: 'Štandardné formáty do 2,5 × 5,6 m pokrývajú všetky podávacie systémy Barbaric. Nadmerné formáty vyžadujú špeciálne návrhy.',
      ...
      },
      {
        ...
        sk: 'Vyplatí sa podávací systém bez skladu dosiek?', hu: 'Megtérül-e a betápláló rendszer lapraktár nélkül?' },
        answer: {
          ...
          sk: 'Áno, ak máte existujúci medzisklad s dodávkou kamiónom a odberom obsluhou. Podávací systém potom zásobuje pílu z medziskladu. Ekonomické to je od stredných denných prietokov 50+ dosiek.',
  ...
  nesting: {
    introExpanded: {
      ...
      sk: 'Barbaric nesting pickery automaticky odoberajú hotové vyrezané diely z nesting CNC, triedia ich a stohujú podľa zákaziek. Tým sa nesting bunka stáva plne automatickou: CNC rozreže doskový materiál na všetky potrebné diely, nesting picker ich odoberá a priraďuje správnej zákazke. Výhoda: žiadny ručný odber dielov, žiadne chyby triedenia, kratšie prestoje CNC. LCV Performance je štandardný model Barbaric pre výrobcov nábytku; NST nesting picker je kompaktné riešenie. Asamer integruje Barbaric nesting pickery pre CZ, SK a HU do existujúcich zariadení od Homag, Biesse, SCM alebo iných výrobcov nesting strojov — vrátane softvérovej integrácie a programovania kamier.',
    ...
    sections: [
      {
        ...
        sk: 'Nesting picker vs. manuálny odber dielov', hu: 'Nesting-válogató vs. manuális darabkivétel' },
        body: {
          ...
          sk: 'Manuálny odber dielov z nesting CNC stojí 2–5 minút na cyklus dosky — plus chyby pri triedení. Nesting picker vykoná úlohu za sekundy, triedi bezchybne a uvoľní operátora na prípravné úlohy. Návratnosť je zvyčajne 1,5 až 2,5 roka.',
      ...
      },
      {
        ...
        sk: 'Kamerový systém a prenos dát CNC', hu: 'Kamerarendszer és CNC adatátvitel' },
        body: {
          ...
          sk: 'Barbaric nesting pickery rozpoznávajú diely dvoma spôsobmi: kamerovým systémom (spracovanie obrazu rozpozná obrys a polohu) alebo priamym prenosom dát z nesting CNC (čísla dielov a súradnice). Asamer koordinuje správnu metódu individuálne s vaším nesting softvérom.',
    ...
    faq: [
      {
        ...
        sk: 'Aké veľkosti dielov možno pickovať?', hu: 'Milyen darabméretek válogathatók?' },
        answer: {
          ...
          sk: 'Štandardný rozsah 80 × 80 mm až 2500 × 1500 mm. Menšie diely sú možné so špeciálnymi aplikáciami.',
      ...
      },
      {
        ...
        sk: 'Koľko zákaziek paralelne?', hu: 'Hány rendelés párhuzamosan?' },
        answer: {
          ...
          sk: 'Zvyčajne 10–20 paralelných zákaziek, s pufrom výrazne viac.',
      ...
      },
      {
        ...
        sk: 'Dá sa to dovybaviť k existujúcemu CNC?', hu: 'Utólag felszerelhető meglévő CNC-re?' },
        answer: {
          ...
          sk: 'Áno — Barbaric nesting pickery možno dovybaviť pri bežných výrobcoch CNC (Homag, Biesse, SCM, IMA). Asamer skontroluje rozhranie v predbežnom plánovaní.',
  ...
  return: {
    introExpanded: {
      ...
      sk: 'Barbaric návratové systémy (RTS) automaticky prepravujú hotové obrobky späť k obsluhe stroja. Typická aplikácia: olepovačky hrán, kde by obsluha musela po každom prechode obrobok preniesť okolo stroja. S RTS preberá túto úlohu dopravník — obsluha môže vstup a výstup obsluhovať z tej istej pozície, čo umožňuje prevádzku jedného pracovníka a uvoľňuje personálne kapacity na iné úlohy. RTS Compact je úsporné vstupné riešenie, RTS Professional osvedčený stolársky štandard, RTS Industrial vysokovýkonný variant pre nepretržitú prevádzku. Asamer plánuje, dodáva a montuje Barbaric návratové systémy pre olepovačky hrán všetkých výrobcov — OTT, Homag, Felder, Biesse, SCM — v CZ, SK a HU.',
    ...
    sections: [
      {
        ...
        sk: 'Kedy sa vyplatí RTS?', hu: 'Mikor térül meg egy RTS?' },
        body: {
          ...
          sk: 'Od stredného denného prietoku 100–200 dielov sa RTS vyplatí za 12–24 mesiacov vďaka odľahčeniu personálu. Zásadné je, aby uvoľnený pracovník prevzal produktívnu následnú úlohu, nie len stál vedľa.',
      ...
      },
      {
        ...
        sk: 'RTS Compact vs. Professional vs. Industrial', hu: 'RTS Compact vs. Professional vs. Industrial' },
        body: {
          ...
          sk: 'RTS Compact (úsporné, vstup) — RTS Professional (stredný prietok, flexibilný) — RTS Industrial (vysoký výkon, nepretržitá prevádzka). Systémy manipulácie s dielmi dopĺňajú RTS o otáčanie, preklápanie alebo stohovanie.',
    ...
    faq: [
      {
        ...
        sk: 'Hodí sa RTS k mojej olepovačke?', hu: 'Illik az RTS az élzárógépemhez?' },
        answer: {
          ...
          sk: 'Áno — systémy RTS sú kompatibilné so všetkými bežnými olepovačkami hrán. Asamer overí rozhranie vopred.',
      ...
      },
      {
        ...
        sk: 'Aký je priestorový nárok RTS?', hu: 'Mekkora az RTS helyigénye?' },
        answer: {
          ...
          sk: 'Typický priestorový nárok: 2–3 m dĺžky návratu plus dĺžka stroja. S usporiadaním do L alebo U možno stopu optimalizovať.',
      ...
      },
      {
        ...
        sk: 'Sú k dispozícii servisné zmluvy?', hu: 'Vannak karbantartási szerződések?' },
        answer: {
          ...
          sk: 'Áno — Asamer ponúka servisné zmluvy s ročnou inšpekciou a definovanými reakčnými časmi.',
  ...
  buffer: {
    introExpanded: {
      ...
      sk: 'Barbaric pufrovacie dopravníky (TMP) oddeľujú nadväzujúce spracovateľské stanice a umožňujú súvislý tok materiálu aj pri rôznych časoch taktu. Medzi formátovacou pílou a olepovačkou hrán, medzi nesting CNC a lakovacou linkou alebo medzi montážnymi bunkami zaisťuje TMP pufrovací dopravník, aby následné stanice nečakali na dodávku — a predchádzajúce stanice neboli blokované plnými pásmi. Pre výrobcov nábytku a rezacie prevádzky je TMP kľúčovou technológiou výrobnej stability. Asamer projektuje pufrovacie dopravníky pre zákazníkov v CZ, SK a HU ako neoddeliteľnú súčasť priebežných výrobných liniek.',
    ...
    sections: [
      {
        ...
        sk: 'Kedy potrebujete pufrovací dopravník?' },
        body: {
          ...
          sk: 'Len čo majú dve spracovateľské stanice rôzne časy taktu, vznikajú prestoje: rýchlejšia stanica čaká, pomalšia sa zasekáva. TMP pufruje obrobky medzi stanicami a necháva obe pracovať vlastným tempom.',
    ...
    faq: [
      {
        ...
        sk: 'Koľko obrobkov môže TMP pufrovať?' },
        answer: {
          ...
          sk: 'Podľa dĺžky 5–50 obrobkov. Návrh závisí od rozdielu času taktu a požadovanej tolerancie výpadku.',
      ...
      },
      {
        ...
        sk: 'Má zmysel TMP pri každej kombinácii strojov?' },
        answer: {
          ...
          sk: 'Pri takmer rovnakých časoch taktu skôr nie. Len čo rozdiel času taktu prekročí 20 % alebo má jedna stanica časté prestoje, má pufor ekonomický zmysel.',
      ...
      },
      {
        ...
        sk: 'Dá sa TMP kombinovať s existujúcou linkou?' },
        answer: {
          ...
          sk: 'Áno — Barbaric pufrovacie dopravníky sú modulárne a možno ich integrovať do existujúcich liniek. Asamer projektuje rozhranie.',
  ...
  door: {
    introExpanded: {
      ...
      cz: `Barbaric systémy manipulace s dveřmi (DRX, CSF Industrial pro dveře, LPS) automatizují speciální manipulaci s bytovými, pokojovými a průmyslovými dveřmi ve výrobě. Dveře jsou velké, těžké a citlivé obrobky: povrchy se nesmí poškrábat, kování musí být přesně zapuštěné, hrany musí být čistě opracované. Barbaric nabízí jak vakuovou manipulaci (DRX pro jednotlivé dveře), tak plně automatické skladovací systémy (CSF Industrial pro dveře) a etiketovací řešení (LPS). Pro výrobce dveří a nábytkářské závody vyrábějící dveře sériově jsou tyto systémy nejekonomičtějším řešením zajištění procesu. Asamer dodává zařízení pro manipulaci s dveřmi pro CZ, SK a HU včetně návrhu rozvržení.`,
      sk: 'Barbaric systémy manipulácie s dverami (DRX, CSF Industrial pre dvere, LPS) automatizujú špeciálnu manipuláciu s bytovými, izbovými a priemyselnými dverami vo výrobe. Dvere sú veľké, ťažké a citlivé obrobky: povrchy sa nesmú poškriabať, kovanie musí byť presne zapustené, hrany musia byť čisto opracované. Barbaric ponúka vákuovú manipuláciu (DRX pre jednotlivé dvere), plne automatické skladovacie systémy (CSF Industrial pre dvere) aj etiketovacie riešenia (LPS). Pre výrobcov dverí a nábytkárske závody vyrábajúce dvere sériovo sú tieto systémy najekonomickejším riešením zaistenia procesu. Asamer dodáva zariadenia na manipuláciu s dverami pre CZ, SK a HU vrátane návrhu rozvrhnutia.',
      hu: `A Barbaric ajtókezelő rendszerek (DRX, CSF Industrial Türen, LPS) automatizálják a lakás-, szoba- és ipari ajtók speciális kezelését a gyártásban. Az ajtók nagy, nehéz és érzékeny munkadarabok: a felületek nem sérülhetnek meg, a vasalatokat pontosan kell elhelyezni, az éleket tisztán kell megmunkálni. A Barbaric egyaránt kínál vákuumos kezelést (DRX egyedi ajtókhoz), teljesen automatikus raktárrendszereket (CSF Industrial Türen) és címkézési megoldásokat (LPS). Sorozatban ajtót gyártó ajtógyártók és bútorüzemek számára ezek a rendszerek a leggazdaságosabb megoldást jelentik a folyamatbiztonság szempontjából. Az Asamer ajtókezelő berendezéseket szállít Csehország, Szlovákia és Magyarország részére az elrendezéstervezéssel együtt.`,
    },
    sections: [
      {
        ...
        sk: 'Vákuová manipulácia pre jednotlivé dvere' },
        body: {
          ...
          sk: 'Vákuový zdvihák DRX bezpečne a šetrne k povrchu manipuluje s jednotlivými dverami. Ideálny pre stolárstvo alebo menších výrobcov dverí, ktorí nepotrebujú plne automatickú linku, ale chcú sa vyhnúť ručnej manipulácii.',
      ...
      },
      {
        ...
        body: {
          ...
          sk: 'CSF Industrial pre dvere je plne automatický sklad špeciálne pre dverné prvky s automatickým zaskladnením a vyskladnením, komisionovaním a integráciou ERP. Nevyhnutný pre výrobcov dverí s výrobou dávky 1.',
    ...
    faq: [
      {
        ...
        sk: 'Aké veľkosti dverí sa spracúvajú?' },
        answer: {
          ...
          sk: 'Štandardné veľkosti do 2,2 × 1,2 m. Nadmerné formáty po dohode.',
      ...
      },
      {
        ...
        sk: 'Spracúvajú sa dvere s kovaním?' },
        answer: {
          ...
          sk: 'Áno — vákuové úchopy sú navrhnuté tak, aby uchopili plochy bez kovania. Skladovanie je šetrné ku kovaniu.',
      ...
      },
      {
        ...
        sk: 'Sú k dispozícii etiketovacie riešenia?' },
        answer: {
          ...
          sk: 'Áno — LPS je automatický etiketovací systém pre dvere s čiarovým kódom alebo RFID tagom.',
  ...
  labeling: {
    introExpanded: {
      ...
      sk: 'Barbaric etiketovacie systémy (LPS) automaticky nanášajú čiarové kódy, QR kódy alebo RFID tagy na obrobky — pre neprerušenú sledovateľnosť a bezchybné priradenie zákaziek. Vo výrobe nábytku a dverí je digitálne etiketovanie kľúčom k výrobe dávky 1: každý diel dostane jedinečné ID, ktoré sa uchováva cez všetky spracovateľské stanice a je prepojené so zákazkou ERP. Asamer integruje LPS systémy do výrobných liniek pre CZ, SK a HU — ako samostatnú stanicu aj ako súčasť komplexných automatizačných projektov.',
    ...
    sections: [
      {
        ...
        sk: 'Prečo digitálne etiketovanie?' },
        body: {
          ...
          sk: 'Ručné etiketovanie je časovo náročné a chybové. Pri výrobe dávky 1 s mnohými rôznymi dielmi sú zámeny prakticky nevyhnutné. Automatické etiketovanie tento chybový faktor úplne odstraňuje.',
    ...
    faq: [
      {
        ...
        answer: {
          ...
          sk: 'Čiarový kód je lacnejší a stačí pre väčšinu aplikácií. RFID sa vyplatí, keď musia byť etikety chránené cez mnohé povrchové úpravy (lakovanie, olepovanie hrán).',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'LPS sa prepája so SAP, Navision alebo individuálnymi ERP systémami. ID každého dielu sa tam generuje a prepája s dátami zákaziek.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'Až 1.000 etikiet za hodinu v závislosti od výmeny obrobku a formátu etikety.',
  ...
  'vacuum-lifters': {
    introExpanded: {
      ...
      sk: 'Barbaric vákuové zdviháky (rad UWL) umožňujú ergonomickú, bezpečnú a presnú manipuláciu s veľkými a ťažkými doskami, dverami alebo pracovnými doskami. Namiesto ručného zdvíhania — ktoré môže spôsobiť bolesti chrbta, poškodenie dosiek a škrabance na potiahnutých povrchoch — sa obrobok bezkontaktne zdvíha vákuom, polohuje v zavesenej polohe a kontrolovane odkladá. Rad UWL pokrýva všetky typické aplikácie: UWL-3 ako štandard, UWL-3S pre tenšie dosky, UWL-3J pre rýchlejšie cykly, UWL-1 ako vstup, UWL-5 pre ťažké bremená. Asamer dodáva, servisuje a certifikuje Barbaric vákuové zdviháky pre CZ, SK a HU — vrátane ročnej bezpečnostnej kontroly.',
    ...
    sections: [
      {
        ...
        sk: 'Ergonómia a bezpečnosť práce' },
        body: {
          ...
          sk: 'Zaťaženie chrbta opakovaným zdvíhaním je jedným z najčastejších dôvodov práceneschopnosti v drevárskom priemysle. Vákuové zdviháky tento rizikový faktor úplne odstraňujú a sprístupňujú prácu aj starším pracovníkom alebo ženám.',
      ...
      },
      {
        ...
        body: {
          ...
          sk: 'UWL-1: vstup, menšie zaťaženia. UWL-3: štandardný model pre väčšinu aplikácií s drevom. UWL-3S: špeciálne vyhotovenie pre tenké alebo porézne dosky. UWL-3J: rýchlejšie časy cyklu. UWL-5: variant pre ťažké bremená až po veľké dvere a dosky.',
    ...
    faq: [
      {
        ...
        sk: 'Dajú sa zdvíhať aj zakrivené povrchy?' },
        answer: {
          ...
          sk: 'Štandardné prísavky sú navrhnuté pre rovné plochy. Pre zakrivené povrchy sú k dispozícii špeciálne vyhotovenia s prispôsobenými prísavkami.',
      ...
      },
      {
        ...
        sk: 'Potrebujeme stlačený vzduch?' },
        answer: {
          ...
          sk: 'Väčšina UWL pracuje s integrovaným vákuovým čerpadlom — žiadny externý stlačený vzduch nie je potrebný. Špeciálne vyhotovenia s externým čerpadlom sú k dispozícii pre špecifické aplikácie.',
      ...
      },
      {
        ...
        sk: 'Ako často sa musí kontrolovať?' },
        answer: {
          ...
          sk: 'Ročná bezpečnostná kontrola podľa DGUV je povinná. Asamer ponúka túto kontrolu v servisnom balíku.',
  ...
  'vacuum-special': {
    introExpanded: {
      ...
      sk: 'Barbaric špeciálne vákuové zdviháky (rad SWL, NGR) sa nasadzujú tam, kde štandardné prísavky nestačia: pre fošne (Plank-Lifter), citlivé povrchy (ihlový úchop), dlhé profily alebo nerovné obrobky existujú špecializované úchopové techniky. SWL Grip-Lifter kombinujú vákuum s mechanickým úchopom pre ťažké geometrie; NGR ihlové úchopy prenikajú poréznymi materiálmi ako izolačné dosky; RWL Rack-Lifter zdvíhajú diely z regálov. Pre nábytkárske závody, spracovateľov dosiek a špeciálne výroby sú tieto špeciálne nástroje jedinou možnosťou, ako automatizovať určité manipulačné úlohy. Asamer projektuje špeciálnu vákuovú techniku pre CZ, SK a HU individuálne.',
    ...
    sections: [
      {
        ...
        sk: 'Kedy sa vyplatí špeciálna vákuová technika?' },
        body: {
          ...
          sk: 'Len čo štandardná vákuová technika zlyháva pre geometriu obrobku alebo povrch — napríklad pri zakrivených plochách, extrémne tenkých doskách, poréznom materiáli alebo zložitých tvaroch — sú špeciálne vákuové zdviháky riešením. Asamer objasní uskutočniteľnosť v predbežnom plánovaní.',
    ...
    faq: [
      {
        ...
        sk: 'Existuje špeciálne riešenie pre našu geometriu?' },
        answer: {
          ...
          sk: 'Asamer a Barbaric radi posúdia uskutočniteľnosť a ekonomiku. Pošlite nám fotografiu alebo nákres vášho obrobku.',
      ...
      },
      {
        ...
        sk: 'Ako dlho trvá vývoj špeciálneho riešenia?' },
        answer: {
          ...
          sk: 'Zvyčajne 8–16 týždňov od konceptu po dodanie — v závislosti od zložitosti.',
      ...
      },
      {
        ...
        sk: 'Dá sa dovybaviť štandardný vákuový zdvihák?' },
        answer: {
          ...
          sk: 'V mnohých prípadoch áno — Asamer kontroluje možnosť dovybavenia existujúcich UWL špeciálnymi prísavkami alebo ihlovými úchopmi.',
  ...
  'vacuum-traverses': {
    introExpanded: {
      ...
      sk: 'Barbaric vákuové traverzy sú dlhé úchopové systémy na manipuláciu s veľkoformátovými, dlhými alebo ľahkými obrobkami — napríklad tenkými doskami, dverami, plechom alebo plexisklom. Traverza rozmiestňuje prísavky po celej ploche obrobku a zaisťuje stabilnú manipuláciu s minimálnym deformovaním aj pri ohybnom materiáli. Typické modely: traverza pre tenké dosky (drevotrieska alebo MDF), dverná traverza pre dverné prvky a traverza plech-plexisklo pre kovové alebo plastové dosky. Pre materiály, ktoré by sa pri bežnom zdvíhaní prehýbali alebo praskali, sú traverzy nepostrádateľné. Asamer dodáva vákuové traverzy pre CZ, SK a HU vrátane bezpečnostného schválenia.',
    ...
    sections: [
      {
        ...
        sk: 'Traverza pre tenké dosky vs. štandardný zdvihák' },
        body: {
          ...
          sk: 'Tenké dosky (< 10 mm) sa pri klasickom zdvíhaní stredovým úchopom prehýbajú a trhajú na okrajoch. Traverza pre tenké dosky rozkladá zaťaženie po celej ploche, takže doska zostáva rovná. Nutnosť vo výrobe jemného nábytku alebo akustických dosiek.',
    ...
    faq: [
      {
        ...
        sk: 'Aké dĺžky obrobkov sú možné?' },
        answer: {
          ...
          sk: 'Štandardné traverzy do 3 m, špeciálne vyhotovenia do 6 m.',
      ...
      },
      {
        ...
        sk: 'Pre aké hrúbky dosiek je vhodná traverza pre tenké dosky?' },
        answer: {
          ...
          sk: 'Zvyčajne od 2 mm do 15 mm. Pre HPL alebo fólie sú potrebné špeciálne povrchy prísaviek.',
      ...
      },
      {
        ...
        sk: 'Existuje aj plechová traverza?' },
        answer: {
          ...
          sk: 'Áno — traverza plech-plexisklo pre kovy a ploché plastové materiály.',
  ...
  'vacuum-cranes': {
    introExpanded: {
      ...
      sk: 'Barbaric vákuové žeriavy sú stacionárne alebo plošné manipulačné systémy, ak sú potrebné pravidelné pohyby dosiek po definovaných trasách — ale bez plne automatického skladu dosiek. Siahajú od stĺpových otočných žeriavov (SSK) cez koľajnicové systémy (SSY) až po stĺpové mosty (2D a 3D) pre veľké halové plochy. Spoločný princíp: žeriav ide alebo sa otáča nad pracovnou plochou, prijíma bremená cez vákuum a presne ich odkladá — riadené obsluhou alebo automaticky cez PLC. Pre stolárstvo, skladové prevádzky a výrobné linky s ťažkými obrobkami sú vákuové žeriavy ekonomickým manipulačným riešením. Asamer projektuje vhodnú triedu žeriava podľa rozvrhnutia a prevádzkového profilu pre zákazníkov v CZ, SK a HU.',
    ...
    sections: [
      {
        ...
        body: {
          ...
          sk: 'SSK stĺpový otočný žeriav: pevná pozícia, polkruh pokrytia — ideálny pre jedno pracovisko. SSY koľajnicový systém: lineárna dráha — ideálna pre linky alebo prechodné sklady. Stĺpový most 2D: obdĺžnikové pokrytie plochy — pre stredné haly. Stĺpový most 3D: ďalšia os Z — pre viacúrovňové pohyby.',
    ...
    faq: [
      {
        ...
        sk: 'Je vákuový žeriav lacnejší než sklad dosiek?' },
        answer: {
          ...
          sk: 'Výrazne lacnejší — SSK začína na zlomku nákladov automatického skladu. Ekonomicky zmysluplné, keď sa manuálna manipulácia nahradí ovládaním žeriava, nie automatizáciou.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'SSK a stĺpový most vyžadujú základy; SSY sa montuje na existujúcu stropnú konštrukciu. Asamer koordinuje stavebné práce.',
      ...
      },
      {
        ...
        answer: {
          ...
          sk: 'Oboje možné. Menšie žeriavy sa zvyčajne ovládajú ručne, väčšie môžu jazdiť automaticky (riadenie PLC, svetelné závory, napojenie na ERP).',
